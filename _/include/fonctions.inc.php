    ...
    function url_actuelle()
{
	 ...
	 if ($url_actuelle=="http://localhost/complexe".$url.$limit)
	 {
    	 ...
    	 $html .= "<a href=".$url.$limit."><span class=\"page\">".($i + 1)."</span></a> " ;
     ...
     $precedent = "<a href=".$url.$limit."><span class=\"previews\"><<</span></a>";
     }
     }
     else {
     ...
     $limit = "$pointer,$parpage";
     $suivant = "<a class='pagination' href=".$url.$limit."><span class=\"previews\">>></span></a>";
     }
     }
     // Si pas de valeur 'limit' on affiche le lien de la deuxième page
     if (@$_GET['limit']== false) {
     $suivant = "<a href=".$url.$parpage.",".$parpage."><span class=\"previews\">>></span></a>";
     }
     }
     else {
