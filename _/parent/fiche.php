...
$code_inscription=$_SESSION['code_etudiant'];
 ...
 $sql="SELECT e.code_inscription, parentname as name, e.date_inscription, parentphone , parentemail
...
<table width="575" cellspacing="2" cellpadding="0"  border="0" style="text-align:left; margin-top:10px">
  ...
  <tr>
    ...
    <td height="15">&nbsp;<?=htmlentities($row['parentphone'])?></td>
  </tr>
   
  <tr>
    <td class="entete">&nbsp;Email : </td>
	</tr><tr>
    <td height="15">&nbsp;<?=htmlentities($row['parentemail'])?></td>
  </tr>
