<span id="titre_page">Ajouter une abscence</span>
<?php //echo isset($msg) && $msg != '' ? $msg : '' ?>
<fieldset>
	<legend></legend>
<form name="abscence" action="" method="post" enctype="multipart/form-data">
<table border="0" cellpadding="0" cellspacing="2" width="100%" style="padding-left:10px" class="cellule_table">

                <tr>

                  <td width="290">Intitule du cours : </td>

                  <td colspan="3"><select name="code_cours" id="code_cours" class="input">
                ...
                <tr>
                  ...
                  <td width="290">Nom et prenom de l etudiant : </td>
...
<?php
 ...
 //mise à jour de la fiche de présence
  ...
  @mysql_query($sql5) or die("erreur lors de l'update de la fiche de présence");
		...
		window.location.replace('professeur.php?task=add_absence');
