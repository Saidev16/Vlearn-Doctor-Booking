...
$sql1="select distinct horaire 
from $tbl_emploi_items 
where jour='$jour' 
and idCleEmploi='$idCleEmploi' 
order by horaire limit 4";
...
while ($row=mysql_fetch_assoc($req)){
    ...
    $sql2="select distinct c.titre_eng, e.horaire, e.salle, e.idEmploiItem, p.nom_prenom 
	from $tbl_cours as c, $tbl_emploi_items as e, $tbl_professeur as p
    where jour='$jour'
    and idCleEmploi='$idCleEmploi'
