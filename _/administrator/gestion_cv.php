...
<title>ADMINISTRATION --GESTION DES CV --</title>
</head>
...
<tr>
  <td valign="top" >
   <?php
    ...
    {
	include("../module/cv/modifier.php");
	}
  else  if(isset($_GET["new"]))
    {
	include("../module/cv/ajouter.php");
	}
  else  if(isset($_GET["supprimer"]))
    {
	include("../module/cv/supprimer.php");
	}
	else  if(isset($_GET["archive"]))
    {
	include("../module/cv/archive.php");
	}
    	else  if(isset($_GET["archiver"]))
    {
	include("../module/cv/archiver.php");
	}
	else  if(isset($_GET["desarchiver"]))
    {
	include("../module/cv/desarchiver.php");
	}
  else
    {	
    include("../module/cv/admin.php");
    }
  ?>
  </td>
</tr>
