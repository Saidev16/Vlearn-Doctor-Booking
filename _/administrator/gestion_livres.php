...
<title>ADMINISTRATION --GESTION DES LIVRES EMPREINTES --</title>
				...
				<tr>
				  <td valign="top" >
				   <?php
					...
					{
					include("../module/emprunts/retourne.php");
					}
				  else  if(isset($_GET["new"]))
					{
					include("../module/emprunts/ajouter.php");
					}
				  else  if(isset($_GET["archive"]))
					{
					include("../module/emprunts/archive.php");
					}
				  else
					{	
					include("../module/emprunts/admin.php");
					}
				  ?>
				  </td>
				</tr>
