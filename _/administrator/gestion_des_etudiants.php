...
<?php require_once 'includes/main_menu.php' ?>
   ...
   <?php
    if(isset($_GET["modifier"])) {
		include("../module/etudiant/modifier.php");
								 }
      else  if(isset($_GET["new"])) {
	  	include("../module/etudiant/ajouter.php");
	  								}
	      else  if(isset($_GET["detail"]))  {
		  	include("../module/etudiant/detail.php");
		  									}
											  else  if(isset($_GET["printb"]))  {
		  	include("../module/etudiant/printb.php");
		  									}
		   else  if(isset($_GET["journal"]))  {
		  	include("../module/etudiant/accesLog.php");
		  									  }
		  	else  if(isset($_GET["supprimer"]))  {
		  	include("../module/etudiant/supprimer.php");
		  									   }
			  else  if(isset($_GET["archiver"]))  {
		  	   include("../module/etudiant/archiver.php");
		  									   }
				else  if(isset($_GET["desarchiver"]))  {
		  	   include("../module/etudiant/desarchiver.php");
		  									   }
				else  if(isset($_GET["buletin"]))  {
		  			include("../module/etudiant/buletin.php");
		  									   }
 else  if(isset($_GET["buletinBachelor"]))  {
		  			include("../module/etudiant/buletinBachelor.php");
		  									   }					
					else  if(isset($_GET["buletinMaster"]))  {
		  			include("../module/etudiant/buletinMaster.php");
		  									   }
				    else  if(isset($_GET["acces"]))  {
		  			include("../module/etudiant/acces.php");
		  									   }
											    else  if(isset($_GET["archive"]))  {
		  			include("../module/etudiant/archive.php");
		  									   }
					else {                                
				  	include("../module/etudiant/admin.php");
				     }
  ?>
                 </td>
                      </tr>
