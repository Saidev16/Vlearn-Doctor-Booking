...
<tr>
  <td valign="top" >
   <?php
    ...
    {
	include("../module/notesburkina/etudiant.php");
	}
  else if(isset($_GET["modifier"]))
    {
	include("../module/notesburkina/modifier.php");
	}
  else if(isset($_GET["code_cours"]))
    {
	include("../module/notesburkina/cours.php");
	}
   else
    {	
    include("../module/notesburkina/admin.php");
    }
  ?>
  </td>
</tr>
