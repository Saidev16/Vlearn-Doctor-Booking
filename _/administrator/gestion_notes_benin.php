...
<title>ADMINISTRATION --GESTION DES notesbenin--</title>
...
<tr>
  <td valign="top" >
   <?php
    ...
    {
	include("../module/notesbenin/etudiant.php");
	}
  else if(isset($_GET["modifier"]))
    {
	include("../module/notesbenin/modifier.php");
	}
  else if(isset($_GET["code_cours"]))
    {
	include("../module/notesbenin/cours.php");
	}
   else
    {	
    include("../module/notesbenin/admin.php");
    }
  ?>
  </td>
</tr>
