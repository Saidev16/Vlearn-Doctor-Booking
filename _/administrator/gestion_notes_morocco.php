...
<tr>
  <td valign="top" >
   <?php
    ...
    {
	include("../module/notesmorocco/etudiant.php");
	}
  else if(isset($_GET["modifier"]))
    {
	include("../module/notesmorocco/modifier.php");
	}
  else if(isset($_GET["code_cours"]))
    {
	include("../module/notesmorocco/cours.php");
	}
   else
    {	
    include("../module/notesmorocco/admin.php");
    }
  ?>
  </td>
</tr>
