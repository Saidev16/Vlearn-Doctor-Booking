...
<title>ADMINISTRATION --GESTION DES notesalgeria--</title>
...
<tr>
  <td valign="top" >
   <?php
    ...
    {
	include("../module/notesmarbella/etudiant.php");
	}
  else if(isset($_GET["modifier"]))
    {
	include("../module/notesmarbella/modifier.php");
	}
  else if(isset($_GET["code_cours"]))
    {
	include("../module/notesmarbella/cours.php");
	}
   else
    {	
    include("../module/notesmarbella/admin.php");
    }
  ?>
  </td>
</tr>
