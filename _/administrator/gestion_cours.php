...
<script language="javascript1.2" src="script/cours.js"></script>
...
<tr>
  <td valign="top" >
   <?php
    if(isset($_GET["modifier"])){include("../module/cours/modifier.php");}
	      else  if(isset($_GET["new"]))  { include("../module/cours/ajouter.php");	}
           else  if(isset($_GET["archiver"])){ include("../module/cours/supprimer.php");}
                  else       {   include("../module/cours/admin.php"); }
  ?>
  </td>
</tr>
</table>
