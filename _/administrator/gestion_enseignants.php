...
<title>ADMINISTRATION --GESTION DES ENSEIGNANTS --</title>
</head>
<body>
<div id="container">
...
<tr>
  <td valign="top" >
   <?php
    ...
    {
	include("../module/enseignant/modifier.php");
	}
    else  if(isset($_GET["new"]))
    {
	include("../module/enseignant/ajouter.php");
	}
	else  if(isset($_GET["detail"]))
    {
	include("../module/enseignant/detail.php");
	}
     else  if(isset($_GET["supprimer"]))
    {
	include("../module/enseignant/supprimer.php");
	}
	else if(isset($_GET['journal'])){
	include '../module/enseignant/accesLog.php';
	}
    else
    {	
    include("../module/enseignant/admin.php");
    }
  ?>
  </td>
</tr>
