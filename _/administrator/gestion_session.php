...
<title>ADMINISTRATION --GESTION DES SESSIONS --</title>
</head>
...
<tr>
  <td valign="top" >
   <?php
    ...
    {
	include("../module/session/modifier.php");
	}
  else  if(isset($_GET["new"]))
    {
	include("../module/session/ajouter.php");
	}
  else  if(isset($_GET["archiver"]))
    {
	include("../module/session/archiver.php");
	}
	else  if(isset($_GET["archive"]))
    {
	include("../module/session/archive.php");
	}
	else  if(isset($_GET["desarchiver"]))
    {
	include("../module/session/desarchiver.php");
	}
  else
    {	
