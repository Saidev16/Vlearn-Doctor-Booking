...
<tr>
  <td valign="top" >
   <?php
    ...
    if(isset($_GET["new"]))
    {
	include("../module/inscriptions/ajouter.php");
	}
	else  if(isset($_GET["full_add"]))
    {
	include("../module/inscriptions/full_add.php");
	}
	else  if(isset($_GET["full_addc"]))
    {
	include("../module/inscriptions/full_addc.php");
	}
	else  if(isset($_GET["full_addT"]))
    {
	include("../module/inscriptions/full_addT.php");
	}
    else  if(isset($_GET["supprimer"]))
    {
	include("../module/inscriptions/supprimer.php");
	}
	else  if(isset($_GET["modifier"]))
    {
	include("../module/inscriptions/modifier.php");
	}
    else  if(isset($_GET["code_inscription"]))
    {
	include("../module/inscriptions/etudiant.php");
	}
	else  if(isset($_GET["code_cours"]))
    {
	include("../module/inscriptions/cours.php");
	}
    else
    {	
    include("../module/inscriptions/admin.php");
    }
