...
<title>ADMINISTRATION --GESTION DES FILIERES --</title>
</head>
...
<tr>
  <td valign="top" >
   <?php
    ...
    {
	include("../module/filieres/modifier.php");
	}
  else  if(isset($_GET["new"]))
    {
	include("../module/filieres/ajouter.php");
	}
  else  if(isset($_GET["archiver"]))
    {
	include("../module/filieres/archiver.php");
	}
	else  if(isset($_GET["archive"]))
    {
	include("../module/filieres/archive.php");
	}
	else  if(isset($_GET["desarchiver"]))
    {
	include("../module/filieres/desarchiver.php");
	}
  else
    {	
    include("../module/filieres/admin.php");
    }
  ?>
  </td>
</tr>
