...
<title>ADMINISTRATION --GESTION DES OFFRES D'EMPLOI--</title>
...
<tr>
  <td valign="top" >
   <?php
    ...
    {
	include("../module/offre/modifier.php");
	}
  else  if(isset($_GET["new"]))
    {
	include("../module/offre/ajouter.php");
	}
  else  if(isset($_GET["archiver"]))
    {
	include("../module/offre/supprimer.php");
	}
	 
   else
    {	
    include("../module/offre/admin.php");
    }
  ?>
  </td>
</tr>
