...
<tr>
  <td valign="top" >
   <?php
    ...
    if(isset($_GET["new"]))
    {
	include("../module/inscriptionsusa/ajouter.php");
	}
	else  if(isset($_GET["full_add"]))
    {
	include("../module/inscriptionsusa/full_add.php");
	}
	else  if(isset($_GET["full_addc"]))
    {
	include("../module/inscriptionsusa/full_addc.php");
	}
	else  if(isset($_GET["full_addT"]))
    {
	include("../module/inscriptionsusa/full_addT.php");
	}
    else  if(isset($_GET["supprimer"]))
    {
	include("../module/inscriptionsusa/supprimer.php");
	}
	else  if(isset($_GET["modifier"]))
    {
	include("../module/inscriptionsusa/modifier.php");
	}
    else  if(isset($_GET["code_inscription"]))
    {
	include("../module/inscriptionsusa/etudiant.php");
	}
	else  if(isset($_GET["code_cours"]))
    {
	include("../module/inscriptionsusa/cours.php");
	}
    else
    {	
    include("../module/inscriptionsusa/admin.php");
    }
