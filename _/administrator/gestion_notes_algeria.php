...
<tr>
  <td valign="top" >
   <?php
    ...
    {
	include("../module/notesalgeria/etudiant.php");
	}
  else if(isset($_GET["modifier"]))
    {
	include("../module/notesalgeria/modifier.php");
	}
  else if(isset($_GET["code_cours"]))
    {
	include("../module/notesalgeria/cours.php");
	}
   else
    {	
    include("../module/notesalgeria/admin.php");
    }
  ?>
  </td>
</tr>
