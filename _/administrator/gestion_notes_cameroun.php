...
<tr>
  <td valign="top" >
   <?php
    ...
    {
	include("../module/notescameroun/etudiant.php");
	}
  else if(isset($_GET["modifier"]))
    {
	include("../module/notescameroun/modifier.php");
	}
  else if(isset($_GET["code_cours"]))
    {
	include("../module/notescameroun/cours.php");
	}
   else
    {	
    include("../module/notescameroun/admin.php");
    }
  ?>
  </td>
</tr>
