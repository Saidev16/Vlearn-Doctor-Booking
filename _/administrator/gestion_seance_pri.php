...
<tr>
  <td valign="top" >
   <?php
    ...
    {
	include("../module/seance_pri/modifier.php");
	}
        else  if(isset($_GET["new"]))
    {
	include("../module/seance_pri/ajouter.php");
	}
          else  if(isset($_GET["archiver"]))
    {
	include("../module/seance_pri/archiver.php");
	}
	 else  if(isset($_GET["archive"]))
    {
	include("../module/seance_pri/archive.php");
	}
	 else  if(isset($_GET["desarchiver"]))
    {
	include("../module/seance_pri/desarchiver.php");
	}
    else  if(isset($_GET["descriptif"]))  {
      include("../module/seance_pri/descriptif.php");
      }
	  else  if(isset($_GET["syllabus"])){
	     include("../module/seance_pri/syllabus.php");
                  }
     else
    {	
    include("../module/seance_pri/admin.php");
    }
  ?>
  </td>
</tr>
