...
<title>ADMINISTRATION --GESTION DES HEURES --</title>
</head>
<body>
<div id="container">
...
<tr>
  <td valign="top" >
   <?php
	...
	{ include("../module/heures/admin.php"); 	}
       else if(isset($_GET["new"]))     
	   {	include("../module/heures/ajouter.php");}
	   else if(isset($_GET["modifier"]))     
	   {	include("../module/heures/modifier.php");}
	     else if(isset($_GET["supprimer"])) 
		 {include("../module/heures/supprimer.php"); 	}
           else                             
		    { include("../module/heures/allprof.php"); }
  ?>
  </td>
</tr>
</table>
