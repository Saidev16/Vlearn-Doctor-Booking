...
<tr>
  <td valign="top" >
   <?php
    ...
    if(isset($_GET["new"]))
    {
	include("../module/inscriptionsburkina/ajouter.php");
	}
	else  if(isset($_GET["full_add"]))
    {
	include("../module/inscriptionsburkina/full_add.php");
	}
	else  if(isset($_GET["full_addc"]))
    {
	include("../module/inscriptionsburkina/full_addc.php");
	}
	else  if(isset($_GET["full_addT"]))
    {
	include("../module/inscriptionsburkina/full_addT.php");
	}
    else  if(isset($_GET["supprimer"]))
    {
	include("../module/inscriptionsburkina/supprimer.php");
	}
	else  if(isset($_GET["modifier"]))
    {
	include("../module/inscriptionsburkina/modifier.php");
	}
    else  if(isset($_GET["code_inscription"]))
    {
	include("../module/inscriptionsburkina/etudiant.php");
	}
	else  if(isset($_GET["code_cours"]))
    {
	include("../module/inscriptionsburkina/cours.php");
	}else  if(isset($_GET["transfer_courses"]))
    {
	include("../module/inscriptionsburkina/transfer_courses.php");
	}
	else  if(isset($_GET["transfer_courses_by_student"]))
    {
	include("../module/inscriptionsburkina/transfer_courses_by_student.php");
	}else  if(isset($_GET["add_transfer_course"]))
    {
	include("../module/inscriptionsburkina/add_transfer_course.php");
	}else  if(isset($_GET["transfer_detail"]))
    {
	include("../module/inscriptionsburkina/transfer_detail.php");
	}else  if(isset($_GET["course_inscription"])){
	include("../module/inscriptionsburkina/course_inscription.php");
	}else
    {
    include("../module/inscriptionsburkina/admin.php");
    }
