...
<tr>
  <td valign="top" >
   <?php
    ...
    if(isset($_GET["new"]))
    {
	include("../module/inscriptionsrabat/ajouter.php");
	}
	else  if(isset($_GET["full_add"]))
    {
	include("../module/inscriptionsrabat/full_add.php");
	}
	else  if(isset($_GET["full_addc"]))
    {
	include("../module/inscriptionsrabat/full_addc.php");
	}
	else  if(isset($_GET["full_addT"]))
    {
	include("../module/inscriptionsrabat/full_addT.php");
	}
    else  if(isset($_GET["supprimer"]))
    {
	include("../module/inscriptionsrabat/supprimer.php");
	}
	else  if(isset($_GET["modifier"]))
    {
	include("../module/inscriptionsrabat/modifier.php");
	}
    else  if(isset($_GET["code_inscription"]))
    {
	include("../module/inscriptionsrabat/etudiant.php");
	}
	else  if(isset($_GET["code_cours"]))
    {
	include("../module/inscriptionsrabat/cours.php");
	}else  if(isset($_GET["transfer_courses"]))
    {
	include("../module/inscriptionsrabat/transfer_courses.php");
	}
	else  if(isset($_GET["transfer_courses_by_student"]))
    {
	include("../module/inscriptionsrabat/transfer_courses_by_student.php");
	}else  if(isset($_GET["add_transfer_course"]))
    {
	include("../module/inscriptionsrabat/add_transfer_course.php");
	}else  if(isset($_GET["transfer_detail"]))
    {
	include("../module/inscriptionsrabat/transfer_detail.php");
	}else  if(isset($_GET["course_inscription"])){
	include("../module/inscriptionsrabat/course_inscription.php");
	}else
    {
    include("../module/inscriptionsrabat/admin.php");
    }
