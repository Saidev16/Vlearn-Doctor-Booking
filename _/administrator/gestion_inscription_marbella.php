...
<tr>
  <td valign="top" >
   <?php
    ...
    if(isset($_GET["new"]))
    {
	include("../module/inscriptionsmarbella/ajouter.php");
	}
	else  if(isset($_GET["full_add"]))
    {
	include("../module/inscriptionsmarbella/full_add.php");
	}
	else  if(isset($_GET["full_addc"]))
    {
	include("../module/inscriptionsmarbella/full_addc.php");
	}
	else  if(isset($_GET["full_addT"]))
    {
	include("../module/inscriptionsmarbella/full_addT.php");
	}
    else  if(isset($_GET["supprimer"]))
    {
	include("../module/inscriptionsmarbella/supprimer.php");
	}
	else  if(isset($_GET["modifier"]))
    {
	include("../module/inscriptionsmarbella/modifier.php");
	}
    else  if(isset($_GET["code_inscription"]))
    {
	include("../module/inscriptionsmarbella/etudiant.php");
	}
	else  if(isset($_GET["code_cours"]))
    {
	include("../module/inscriptionsmarbella/cours.php");
	}else  if(isset($_GET["transfer_courses"]))
    {
	include("../module/inscriptionsmarbella/transfer_courses.php");
	}
	else  if(isset($_GET["transfer_courses_by_student"]))
    {
	include("../module/inscriptionsmarbella/transfer_courses_by_student.php");
	}else  if(isset($_GET["add_transfer_course"]))
    {
	include("../module/inscriptionsmarbella/add_transfer_course.php");
	}else  if(isset($_GET["transfer_detail"]))
    {
	include("../module/inscriptionsmarbella/transfer_detail.php");
	}else  if(isset($_GET["course_inscription"])){
	include("../module/inscriptionsmarbella/course_inscription.php");
	}else
    {
    include("../module/inscriptionsmarbella/admin.php");
    }
