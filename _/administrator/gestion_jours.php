...
<title>ADMINISTRATION --GESTION DES JOURS --</title>
</head>
...
<tr>
  <td valign="top" >
   <?php
    ...
    {
	include("../module/jours/modifier.php");
	}
  else  if(isset($_GET["new"]))
    {
	include("../module/jours/ajouter.php");
	}
  else  if(isset($_GET["archiver"]))
    {
	include("../module/jours/archiver.php");
	}
	else  if(isset($_GET["archive"]))
    {
	include("../module/jours/archive.php");
	}
	else  if(isset($_GET["desarchiver"]))
    {
	include("../module/jours/desarchiver.php");
	}
  else
    {	
    include("../module/jours/admin.php");
    }
  ?>
  </td>
</tr>
