...
<title>ADMINISTRATION --GESTION DES inscriptionsmorocco --</title>
...
<tr>
  <td valign="top" >
   <?php
    ...
    if(isset($_GET["new"]))
    {
	include("../module/inscriptionsmorocco/ajouter.php");
	}
	else  if(isset($_GET["full_add"]))
    {
	include("../module/inscriptionsmorocco/full_add.php");
	}
	else  if(isset($_GET["full_addc"]))
    {
	include("../module/inscriptionsmorocco/full_addc.php");
	}
	else  if(isset($_GET["full_addT"]))
    {
	include("../module/inscriptionsmorocco/full_addT.php");
	}
    else  if(isset($_GET["supprimer"]))
    {
	include("../module/inscriptionsmorocco/supprimer.php");
	}
	else  if(isset($_GET["modifier"]))
    {
	include("../module/inscriptionsmorocco/modifier.php");
	}
	else  if(isset($_GET["transfer_courses"]))
    {
	include("../module/inscriptionsmorocco/transfer_courses.php");
	}
	else  if(isset($_GET["transfer_courses_by_student"]))
    {
	include("../module/inscriptionsmorocco/transfer_courses_by_student.php");
	}else  if(isset($_GET["course_inscription"])){
	include("../module/inscriptionsmorocco/course_inscription.php");
	}else  if(isset($_GET["courses"]))
    {
	include("../module/inscriptionsmorocco/courses.php");
	}
	else  if(isset($_GET["add_transfer_course"]))
    {
	include("../module/inscriptionsmorocco/add_transfer_course.php");
	}else  if(isset($_GET["transfer_detail"]))
    {
	include("../module/inscriptionsmorocco/transfer_detail.php");
	}
    else  if(isset($_GET["code_inscription"]))
    {
	include("../module/inscriptionsmorocco/etudiant.php");
	}
	else  if(isset($_GET["code_cours"]))
    {
	include("../module/inscriptionsmorocco/cours.php");
	}
    else
    {
    include("../module/inscriptionsmorocco/admin.php");
    }
