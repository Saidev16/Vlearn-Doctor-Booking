...
<title>ADMINISTRATION --GESTION DES SALLES --</title>
</head>
...
<tr>
  <td valign="top" >
   <?php
    ...
    {
	include("../module/salles/modifier.php");
	}
  else  if(isset($_GET["new"]))
    {
	include("../module/salles/ajouter.php");
	}
  else  if(isset($_GET["archiver"]))
    {
	include("../module/salles/archiver.php");
	}
	else  if(isset($_GET["archive"]))
    {
	include("../module/salles/archive.php");
	}
	else  if(isset($_GET["desarchiver"]))
    {
	include("../module/salles/desarchiver.php");
	}
  else
    {	
    include("../module/salles/admin.php");
    }
  ?>
  </td>
</tr>
