...
<title>ADMINISTRATION --GESTION DES HORAIRES --</title>
</head>
...
<tr>
  <td valign="top" >
   <?php
    ...
    {
	include("../module/horaires/modifier.php");
	}
  else  if(isset($_GET["new"]))
    {
	include("../module/horaires/ajouter.php");
	}
  else  if(isset($_GET["archiver"]))
    {
	include("../module/horaires/archiver.php");
	}
	else  if(isset($_GET["archive"]))
    {
	include("../module/horaires/archive.php");
	}
	else  if(isset($_GET["desarchiver"]))
    {
	include("../module/horaires/desarchiver.php");
	}
  else
    {	
    include("../module/horaires/admin.php");
    }
  ?>
  </td>
</tr>
