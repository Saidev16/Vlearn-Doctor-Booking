...
<title>ADMINISTRATION --GESTION DE BIBLIOTHEQUE--</title>
...
<tr>
  ...
  if(isset($_GET["modifier"]))
    {
	include("../module/bibliotheque/modifier.php");
	}
  else  if(isset($_GET["new"]))
    {
	include("../module/bibliotheque/ajouter.php");
	}
  else  if(isset($_GET["supprimer"]))
    {
	include("../module/bibliotheque/supprimer.php");
	}
  else
    {	
    include("../module/bibliotheque/admin.php");
    }
  ?>
  </td>
</tr>
