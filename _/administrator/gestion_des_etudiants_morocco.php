...
<?php require_once 'includes/main_menu.php' ?>
   ...
   <?php
    if(isset($_GET["modifier"])) {
		include("../module/etudiantmorocco/modifier.php");
								 }
      else  if(isset($_GET["new"])) {
	  	include("../module/etudiantmorocco/ajouter.php");
	  								}
	      else  if(isset($_GET["detail"]))  {
		  	include("../module/etudiantmorocco/detail.php");
		  									}
											  else  if(isset($_GET["printb"]))  {
		  	include("../module/etudiantmorocco/printb.php");
		  									}
		  									else  if(isset($_GET["printO"]))  {
		  	include("../module/etudiantmorocco/printO.php");
		  									}
		   else  if(isset($_GET["journal"]))  {
		  	include("../module/etudiantmorocco/accesLog.php");
		  									  }
		  	else  if(isset($_GET["supprimer"]))  {
		  	include("../module/etudiantmorocco/supprimer.php");
		  									   }
			  else  if(isset($_GET["archiver"]))  {
		  	   include("../module/etudiantmorocco/archiver.php");
		  									   }
				else  if(isset($_GET["desarchiver"]))  {
		  	   include("../module/etudiantmorocco/desarchiver.php");
		  									   }
				else  if(isset($_GET["buletin"]))  {
		  			include("../module/etudiantmorocco/buletin.php");
		  									   }
 else  if(isset($_GET["buletinBachelor"]))  {
		  			include("../module/etudiantmorocco/buletinBachelor.php");
		  									   }					
					else  if(isset($_GET["buletinMaster"]))  {
		  			include("../module/etudiantmorocco/buletinMaster.php");
		  									   }
				    else  if(isset($_GET["laureat"]))  {
		  			include("../module/etudiantmorocco/laureat.php");
		  									   }
											    else  if(isset($_GET["archive"]))  {
		  			include("../module/etudiantmorocco/archive.php");
		  									
		  									    }else  if(isset($_GET["ajaxmod"])) {
	  	include("../module/etudiantmorocco/ajaxmod.php");
	}
					else {                                
				  	include("../module/etudiantmorocco/admin.php");
				     }
  ?>
                 </td>
                      </tr>
