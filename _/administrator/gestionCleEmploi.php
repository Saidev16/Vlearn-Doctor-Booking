...
<title>ADMINISTRATION --GESTION DES TITRES D'EMPLOI --</title>
</head>
...
<tr>
  <td valign="top" >
   <?php
    ...
    {
	include("../module/cleEmploi/modifier.php");
	}
  else  if(isset($_GET["new"]))
    {
	include("../module/cleEmploi/ajouter.php");
	}
  else  if(isset($_GET["archiver"]))
    {
	include("../module/cleEmploi/archiver.php");
	}
	else  if(isset($_GET["archive"]))
    {
	include("../module/cleEmploi/archive.php");
	}
	else  if(isset($_GET["desarchiver"]))
    {
	include("../module/cleEmploi/desarchiver.php");
	}
  else
    {	
    include("../module/cleEmploi/admin.php");
    }
  ?>
  </td>
</tr>
