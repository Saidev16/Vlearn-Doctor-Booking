...
<title>ADMINISTRATION --GESTION DES notesivory--</title>
...
<tr>
  <td valign="top" >
   <?php
    ...
    {
	include("../module/notesivory/etudiant.php");
	}
  else if(isset($_GET["modifier"]))
    {
	include("../module/notesivory/modifier.php");
	}
  else if(isset($_GET["code_cours"]))
    {
	include("../module/notesivory/cours.php");
	}
   else
    {	
    include("../module/notesivory/admin.php");
    }
  ?>
  </td>
</tr>
