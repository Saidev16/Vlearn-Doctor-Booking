<span id="titre_page">Fiche personnelle</span>
<?php
...
<table width="575" cellspacing="2" cellpadding="0" align="center" border="0" style="text-align:left; margin-top:10px">
  <tr> 
    <td width="420" class="entete">&nbsp;Code enseignant:</td>
	</tr>
	<tr>
    	<td>&nbsp;<?=$row['code_prof']; ?></td>
    </tr>
    ...
    <tr>
    	<td class="entete">&nbsp;Nationalité :</td>
	</tr>
	<tr>
	...
	<tr>
    	<td class="entete">&nbsp;Numéro de téléphone :</td>
	</tr>
	<tr>
