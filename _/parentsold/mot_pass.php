...
<span id="titre_page">Changer mot de passe  </span>
...
<table width="575" border="0" cellspacing="0" cellpadding="0" align="center" style="margin-top:10px; text-align:left">
  ...
  <tr>
    <td align="left" class="bold" width="150px">Identifiant :</td>
	<td>&nbsp;</td>
   ...
   <tr><td colspan="3" height="3px"></td></tr>
  <tr>
    <td align="left" class="bold">Mot de passe : </td>
    <td>&nbsp;</td>
    <td>
   ...
   <tr><td colspan="3" height="3px"></td></tr>
  <tr>
    <td align="left" class="bold">Retaper le mot de passe : </td>
    <td>&nbsp;</td>
    <td>
