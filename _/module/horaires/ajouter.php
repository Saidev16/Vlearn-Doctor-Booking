...
if ($F('nom')==""){
alert('veuillez taper le titre d\'horaire');
$('nom').focus();
return false;
}
...
$nom=addslashes($_POST['nom']);
				...
				$sql="INSERT INTO $tbl_horaire( `nom_horaire`  ) VALUES ('$nom');";

                @mysql_query($sql)or die ("erreur lors de l'ajout d'horaire ");
			?>
...
<table border="0" width="100%" cellpadding="0" cellspacing="0" align="center" class="haut_table">
  <tr>
    ...
    <td width="78%" class="titre">Ajout  d' un horaire</td>
	<td width="22%">
	  <table border="0" align="right" width="0%" cellpadding="10" cellspacing="4" id="link" >
	    <tr>
		  ...
		  <td valign="top" align="center">
		   <a href="gestion_horaires.php">  <div class="cancel"></div>Annuler</a>
		  </td>
		</tr>
	  </table>
	</td> 
 ...
 <form method="post"  action="gestion_horaires.php?new=oui" name="f_ajout" onsubmit="return valid_form();" >
