<?php
	...
	/* $sql = "SELECT distinct e.code_inscription, concat(e.nom, ' ' ,e.prenom) as name, 
			 ...
			 FROM tbl_prospect as e, $tbl_filiere as f, $tbl_groupe as g 
...
$sql = "SELECT  e.code_inscription, concat(e.nom, ' ' ,e.prenom) as name, 
	 		 e.tel, e.date_inscription, g.title, e.niveau,e.ville,e.groupe,e.observation
			 FROM tbl_prospect  as e,  $tbl_groupe as g 
			 where  e.groupe=g.id and groupe != 99 
		
			  ORDER BY e.code_inscription ";
			/* $sql=" SELECT  e.code_inscription, concat(e.nom, ' ' ,e.prenom) as name, 
	 		 e.tel, e.date_inscription,e.niveau,e.ville,e.groupe,e.observation
			 FROM tbl_prospect  as e			 		
			  ORDER BY name ";*/
?>
<table border="0" width="100%" cellpadding="0" cellspacing="0" align="center" class="haut_table">
  <tr>
    <td>&nbsp;&nbsp;<img src="images/icone/etudiants.gif" border="0"/></td>
    <td class="titre">&nbsp;&nbsp;GESTION DES PROSPECTS </td>
	<td width="150">
	  <table border="0" align="right" width="100%" cellpadding="10" cellspacing="4" id="link" >
	    <tr>
		 <td valign="top" align="center">
		   <a href="gestion_prospect.php?new=oui">
		  ...
		  <a href="#"
		     ...
		     onclick="javascript:if(document.adminMenu.boxchecked.value==0)
...

				   {
					 ...
					 chemin='gestion_prospect.php?modifier='+chemin;
		   ...
		   <a href="#"
		     ...
		     onclick="javascript:if(document.adminMenu.boxchecked.value==0)
...

				   {
					 ...
					 chemin='gestion_prospect.php?detail='+chemin;
		   ...
		   <a href="#"
		     onclick="javascript:if(document.adminMenu.boxchecked.value==0)
...

				   {
					 ...
					 chemin='gestion_prospect.php?preinscri='+chemin;

				     window.location.replace(chemin);

				   }

				   "><div class="ajouter"></div>Vers pré-inscription</a>
		  </td>
		   <td>
		<a href="http://66.84.9.12/~siteadm/massmail/massmail.php" target="_blank">MassMail Portal Contacts </a>
				   </td>
		</tr>
	  </table>
     ...
     <tr align="center">
	  ...
	  <?php
	   ...
	   <tr height="17px">
		 ...
		 <td>&nbsp;<?=ucfirst(stripslashes($ligne["observation"]))?></td>
