...
$some_coef=0;
  if(isset($_POST['transfer']) and $_POST['transfer']==1){
 	 ...
 	 $letter_grade= 'W';
		...
		// calcule final grade 
		$final_grade=(($project*$coef_project)  + ($participation*$coef_participation))/ 100;
		 }
...
<table border="0" width="100%" cellpadding="0" cellspacing="0" align="center" class="haut_table">
 ...
 <form method="post"  action="gestion_notes.php?modifiermbael=oui" name="f_ajout">
    ...
    <input type="hidden" name="idSession" value="<?=$row['idSession']?>" />
		...
		<tr>
		  ...
		  <tr><td colspan="4" height="3px"></td></tr>
		  <tr>
		  <td width="25%" class="gras"><label for="project">Project:</label></td>
		  <td width="25%">
