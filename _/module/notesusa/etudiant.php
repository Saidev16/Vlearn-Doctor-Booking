<?php
	...
	where e.code_inscription='$code_inscription' limit 1";

	$req=@mysql_query($sql1) or die("erreur lors de la sélection du nom et filière 1");
	...
	if(isset($_POST['idSession'])){
	 ...
	 $tbl_cours AS c, tbl_note_usa AS n WHERE
	 ...
	 AND n.archive=0
	 AND n.idSession='$idSession'
	 GROUP BY c.code_cours ORDER BY c.titre";
	  ...
	  <table border="0" align="right" width="20%" cellpadding="10" cellspacing="4" id="link" >
	    ...
	    <tr>
		  ...
		  <a href="#" 
		     ...
		     onclick="javascript:if(document.adminMenu.boxchecked.value==0)
			     ...
			     chemin=document.adminMenu.boxchecked.value;
					 ...
					 chemin='gestion_notes_usa.php?modifier='+chemin+'&foupasf='+xyz;
		  ...
		  <td valign="top" align="center" width="90">
		   ...
		   <a href="gestion_notes_usa.php"><div class="retour"></div>Back</a>
...
<div class="container_search">
 ...
 <?php 
	 ...
	 FROM tbl_note_usa WHERE code_inscription = '$code_inscription') 
 ...
 <input type="submit" value="Submit" class="input"  />
  ...
  <tr>
   ...
   <!--  <th width="75">Final grade</th>-->
	...
	$req12=@mysql_query($sql12) or die("erreur lors de la sélection de la note 2");
	$row1=mysql_fetch_assoc($req12);
	
	 $cr=$row1['code_cours'];

	 /*
	 $abs= "select count(*) as nbre
	...
	$reqab =mysql_query($abs) or die("erreur lors de traitement de F*");
	//$ab =mysql_result($reqab);
   ...
   <tr>
	 ...
	 <td align="left"><a href="gestion_notes_usa.php?code_cours=<?=$cc?>"><?=$cr?></a></td>
	 <td align="left">&nbsp;<?=trim($row['titre'])?></td>
	
    
   <td align="center">&nbsp;<?= $row['letter_grade']=='T'? '' : $row['final_grade']?></td>
