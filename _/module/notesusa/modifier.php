...
$aa="select code_inscription,section from tbl_note_usa where code_note='$id' ";
$reqaa=mysql_query($aa) or die ("erreur lors de la selection du section");
$aaa=mysql_fetch_assoc($reqaa);
$sect=$aaa['section'];
$code=$aaa['code_inscription'];

$b="select count(*) as nbre from tbl_note_usa where letter_grade!='' and letter_grade!='I' and section='$sect' and code_inscription='$code'";
...
$reqmba=mysql_query($mba) or die ("erreur lors de la selection du section");} } */
			...
			<!--	
				window.location.replace("gestion_notes_usa.php?code_inscription=<?=$code_inscription?>");
			//-->
			</script>
              <?php
			  }
			  ...
			  from tbl_note_usa as n, $tbl_cours as c, $tbl_session as s 
...
<table border="0" width="100%" cellpadding="0" cellspacing="0" align="center" class="haut_table">
	...
	<td width="22%">
	  <table border="0" align="right" width="0%" cellpadding="10" cellspacing="4" id="link" >
	    <tr>
 		  ...
 		  <td valign="top" align="center">
		   <a href="gestion_notes_usa.php?code_inscription=<?=$code_inscription?>">
 ...
 <form method="post"  action="gestion_notes_usa.php?modifier=oui" name="f_ajout">
