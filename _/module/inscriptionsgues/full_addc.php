...
<?php
		...
		$sql = "SELECT COUNT(*) AS nbr FROM tbl_inscription_cours_GUES WHERE code_inscription='$code_inscription' 
		...
		if ($nbr==0){
			...
			$sql = "INSERT INTO tbl_inscription_cours_GUES (`code_cours`, `code_inscription`, code_cours_testing, `date_inscription`, `idSession`)
...
<table border="0" width="100%" cellpadding="0" cellspacing="0" align="center" class="haut_table">
 ...
 <form method="post" action="gestion_inscription_gues.php?full_addc=oui" name="f_ajout">
