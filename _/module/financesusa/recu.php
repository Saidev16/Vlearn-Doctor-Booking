...
FROM tbl_finance_paiement_usa as p, tbl_finance_usa as f, tbl_etudiant_usa as e, $tbl_admin as a
WHERE p.id='$id' 
...
$sql="SELECT * FROM tbl_finance_usa WHERE code_inscription='$code_inscription' AND annee = '$annee'";
$req=mysql_query($sql);
