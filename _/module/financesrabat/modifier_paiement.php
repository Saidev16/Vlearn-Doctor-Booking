...
<?php	
	...
	if (isset($_POST['code_inscription'])){
		...
		$sql="UPDATE tbl_finance_paiement_rabat SET designation = '$designation', 
		...
		$sql="select sum(somme) as nbre from tbl_finance_paiement_rabat where code_inscription = '$code_inscription'";
	     ...
	     $payee=$ab["nbre"];
			...
			//-->
			 ...
			 $sql="SELECT e.nom, e.prenom ,e.prefixe, p.* 
						 FROM tbl_etudiant_rabat AS e, tbl_finance_paiement_rabat AS p
...
<table border="0" width="100%" cellpadding="0" cellspacing="0" align="center" class="haut_table">
	...
	<td width="22%">
	  <table border="0" align="right" width="0%" cellpadding="10" cellspacing="4" id="link" >
	    <tr>
		  ...
		  <td valign="top" align="center">
		   <a href="gestion_finance_rabat.php?detail=<?php echo $code_inscription ?>" ><div class="cancel"></div>Cancel</a>
		  </td>
		</tr>
	  </table>
	</td> 
 ...
 <form method="post" action="gestion_finance_rabat.php?modif_paiement=oui" name="f_ajout" >
