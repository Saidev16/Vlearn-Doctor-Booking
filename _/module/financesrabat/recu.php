...
FROM tbl_finance_paiement_rabat as p, tbl_finance_rabat as f, tbl_etudiant_rabat as e, $tbl_admin as a
WHERE p.id='$id' 
...
$sql="SELECT * FROM tbl_finance_rabat WHERE code_inscription='$code_inscription' AND annee = '$annee'";
$req=mysql_query($sql);
