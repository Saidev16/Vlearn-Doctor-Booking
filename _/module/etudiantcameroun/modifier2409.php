...
$attestation_eng = addslashes($_POST['attestation_eng']);
					...
					// update table etudiant
                        ...
                        $sql="UPDATE tbl_etudiant_cameroun SET `code_inscription`='$ci',
 						`nom` = '$nom',
						`prenom` = '$prenom',
			...
			<!--
				window.location.replace('gestion_des_etudiants_cameroun.php');
			//-->
			</script>
              ...
              <?php
					 ...
					 $sql="UPDATE tbl_etudiant_cameroun SET  
 						`nom` = '$nom',
						`prenom` = '$prenom',
						`date_naissance` = '$date_naissance',
						`nationalite` = '$nationalite',
         ...
         @mysql_query($sql)or die ("erreur lors de la mise à jour de cet étudiant");
          ...
          $sql2="UPDATE tbl_etudiant_all SET  
						...
						evaluator = '$evaluator'
						 ...
						 WHERE `code_inscription` ='$code_inscription' and prefixe='CAM' limit 1 "; 
//die($sql);
         @mysql_query($sql2)or die ("erreur lors de la mise à jour de cet étudiant");
			...
			//-->
			  ...
			  $sql2="select * from tbl_etudiant_cameroun
			  where code_inscription='$code_inscription' limit 1 ";
...
<table border="0" width="100%" cellpadding="0" cellspacing="0" align="center" class="haut_table">
	...
	<td width="22%">
	  <table border="0" align="right" cellpadding="10" cellspacing="4" id="link" >
	    <tr>
		  ...
		  <td valign="top" align="center">
		   <a href="gestion_des_etudiants_cameroun.php" ><div class="cancel"></div>Cancel</a>
		  </td>
		</tr>
	  </table>
	</td> 
 ...
 <form method="post" action="gestion_des_etudiants_cameroun.php?modifier=Yes" name="f_ajout" >
