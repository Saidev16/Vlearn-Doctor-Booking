...
$sqlzin="SELECT max(`code_inscription`) as max FROM tbl_etudiant_cameroun";
...
$code_inscription= $cu+1;
 ...
 $sql_insert="INSERT INTO tbl_etudiant_cameroun (`prefixe` ,code_inscription,`nom` , `prenom` , `date_naissance` , `nationalite` , `adresse` , `sexe` , `code_bac` , `serie_bac` ,
...
VALUES ('CAM','$code_inscription','$nom', '$prenom', '$date_naissance', '$nationalite', '$adresse', '$sexe', '$code_bac', '$serie_bac', '$date_insc', '$tel', '$mail', '$annee', '$semestre', '$filiere', '$lieu_naissance', '$cin', '$cinq_photo', '$original_bac', '$copie_bac', '$english_bac', '$trois_lettre', '$trois_enveloppe', '$buletin_note',  '$reglement', '$copie_cin', '$extrait', '$note_etudesoc', '$note_fr', '$note_sciences', '$note_math', '$aquise', '$nom', '$pass', 1, '$groupe', '$activite', '$annee_inscription', '$niveau', '$ville', '$elearning', '$piimt', '$aul', '$umt');"; 
	  @mysql_query($sql_insert)or die ("Error save studentPSI");
	  

            $a1 ="insert into tbl_finance_cameroun (`prefixe` ,code_inscription,frais_etude) values ('CAM','$code_inscription','1350') ";
...
<table border="0" width="100%" cellpadding="0" cellspacing="0" align="center" class="haut_table">
  ...
  <form method="post" action="gestion_des_etudiants_cameroun.php?new=oui" name="f_ajout" >
