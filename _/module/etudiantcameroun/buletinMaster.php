 ...
 <?php
	 ...
	 $sql="SELECT e.*
	 FROM tbl_etudiant_cameroun AS e WHERE code_inscription= '$code_inscription'";
	...
	<td width="90">
	  <table border="0" align="right" width="100%" cellpadding="10" cellspacing="4" id="link" >
		...
		<td valign="top" align="center" >
		  <a href="http://his.americanhigh.us/module/etudiantcameroun/printb.php?printb=<?=$code_inscription?>" target="_blank"  title="Imprimer"> 
		  <div class="imprimer"></div>Print</a>
		  </td>
		  <td valign="top" align="center" >
		  <a href="http://his.americanhigh.us/module/etudiantcameroun/printO.php?printO=<?=$code_inscription?>" target="_blank"  title="Imprimer"> 
...
<td align="right">
<a href="gestion_des_etudiants_cameroun.php"><div class="retour"></div>Back</a>
</td>
    ...
    $transfer=0;
		?>
			...
			<?php
             ...
             FROM tbl_note_cameroun AS n, tbl_cours AS c 
