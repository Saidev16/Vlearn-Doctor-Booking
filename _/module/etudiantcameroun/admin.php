	  ...
	  <table border="0" align="right" width="100%" cellpadding="10" cellspacing="4" id="link" >
	    <tr>
		 ...
		 <td valign="top" align="center">
		   <a href="gestion_des_etudiants_cameroun.php?new=oui">
		   ...
		   <a href="#"
		     onclick="javascript:if(document.adminMenu.boxchecked.value==0)
...

				   {
					 ...
					 chemin='gestion_des_etudiants_cameroun.php?buletinMaster='+chemin;
		 ...
		 <?php } ?>
		  <td valign="top" align="center" >
		  <a href="gestion_des_etudiants_cameroun.php?laureat" title="laureat">
		   ...
		   <a href="#"
		     onclick="javascript:if(document.adminMenu.boxchecked.value==0)
...

				   {
					 ...
					 chemin='gestion_des_etudiants_cameroun.php?supprimer='+chemin;
  ...
  jQuery(".valider").click(function(){
      ...
      if (ancien_value != value) {
          jQuery.ajax({
              ...
              evalscripts:true,
              type: "POST",
              url: 'gestion_des_etudiants_cameroun.php?ajaxmod',
