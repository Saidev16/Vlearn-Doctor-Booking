...
if (isset($_POST['type_cours'])){
		...
		@mysql_query($sql) or die ('Erreur de mise à jour de la fiche de paiement');
			...
			//-->
			 ...
			 $sql4 = "SELECT i.*, t.prix, e.nom, e.prenom, s.session, s.annee_academique, s.academic_year, c.titre
			  FROM $tbl_inscription_cours AS i, tbl_type_cours AS t, $tbl_etudiant AS e, $tbl_session AS s, $tbl_cours AS c
