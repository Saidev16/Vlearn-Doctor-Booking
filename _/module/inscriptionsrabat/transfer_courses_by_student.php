...
$sql5 = "SELECT code_inscription,nom,prenom FROM `tbl_etudiant_burkina` where code_inscription not in ($sql) order by nom";
...
$sql4 = "SELECT c.code_cours, c.titre ,c.nbr_credit FROM `tbl_note_burkina` as n , tbl_etudiant_burkina as e, $tbl_cours as c WHERE
...
<div class="row">
  ...
  <div class="col-md-12 step_1">
    <button type="button" class="btn btn-sm btn-success" name="button" style="margin: 12px;float: right;margin-right: 0px;" onclick="next_step(1)">Next</button>
  </div>
  <div class="col-md-12 step_2" style="display:none;">
    <button type="submit" name="button" class="btn btn-success btn-sm" style="margin: 12px;float: right;margin-right: 0px;">submit</button>
      <button type="button" class="btn btn-sm btn-success" name="button" style="margin: 12px;float: right;margin-right: 0px;" onclick="prev_step(2)">Previous</button>
      ...
      <table class="table table-bordered" id="example_1">
        <thead>
          <tr class="bg-danger">
            ...
            <th scope="col" style="background-color: #dc3545!important;color: #fff;">Students</th>
          </tr>
        </thead>
        <tbody>
          <?php
          ...
          ?>
          <tr>
            <th class="text-center"> <input class="student_check" type="checkbox" name="students[]" value="<?=$cd?>"></th>
...
<script type="text/javascript">
  ...
  function next_step(step){
    var searchIDs = []
    $.each($(".student_check[name='students[]']:checked"), function(){
