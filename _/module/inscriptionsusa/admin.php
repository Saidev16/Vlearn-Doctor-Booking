<?php
	   ...
	   <!--
	   		window.location.replace('gestion_inscription_usa.php?code_inscription=<?=$pci?>');
	   -->
	   </script>
	   	<?php																   }
 	  ...
 	  $sql="SELECT c.titre, i.code_cours, count(i.code_inscription) as inscription from 
 		tbl_cours as c, tbl_inscription_cours_usa as i, tbl_etudiant_usa as e
  ...
  <tr>
	...
	<td width="22%">
	 <table border="0" align="right" width="20%" cellpadding="10" cellspacing="4" id="link" >
	    <tr>
		<!-- <td valign="top" align="center"><a href="gestion_inscription_usa.php?full_add=oui"><div class="ajouter"></div>Ajouter Semestre</a></td>-->
		 <td valign="top" align="center"><a href="gestion_inscription_usa.php?full_addc=oui"><div class="ajouter"></div>Add Course</a></td
		>
		 <td valign="top" align="center"><a href="gestion_inscription_usa.php?full_addT=oui"><div class="ajouter"></div>Add Transfer Course</a></td
		></tr>
	</table>
    </td> 
</table>
 ...
 <?php 
  ...
  <select name="groupe" class="search" title="Recherchez par le nom du groupe du cours">
    ...
    <select name="code_inscription" class="search" onchange="javascript:document.adminMenu.submit()" title="S&eacute;l&eacute;ctionnez un &eacute;tudiant pour voir ses cours">
		...
		from tbl_etudiant_usa as e, tbl_inscription_cours_usa as i
  ...
  <tr height="16px">
	 ...
	 <td align="left"><a href="gestion_inscription_usa.php?code_cours=<?=$cc?>" title="Cliquez pour voir les &eacute;tudiants inscrits dans ce cours">&nbsp;<?=$cc?></a></td>
	...
	$inscri="select count(*) as nbre  from tbl_inscription_cours_usa as c, tbl_note_usa as n 
