...
?>
        ...
        <!--
        	window.location.replace('gestion_inscription_burkina.php?code_cours=<?=$code_cours?>&idSesion=<?=$idSession?>&type=<?=$type?>&code=<?=$code_cours?>&prix=<?=$prix?>&code_inscription=<?=$code_inscription?>');
        //-->
        </script>