		  ...
		  <a href="#" 
		     ...
		     onclick="javascript:if(document.adminMenu.boxchecked.value==0)
...

				   {
					 ...
					 chemin='gestion_inscription_usa.php?supprimer='+chemin;
...
<input type="hidden" name="boxchecked" value="0" />
  ...
  <tr>
	 ...
	 <th width="175" align="center"></th> <!--Registration Date -->
   </tr>
  ...
  <?php
   ...
   $sql="select e.code_inscription, concat(e.nom,' ', e.prenom) as name, 
	      ...
	      from tbl_inscription_cours_usa as i, tbl_etudiant_usa as e, $tbl_cours as c
		   where  
