<?php
       $where=$code_cours=$code_cour="";
 	   ...
 	   window.location.replace("gestion_notes_casa.php?code_cours=<?=$code_cours?>");
 	   </script>
 	   <?php
 	                                                                         }
 	   ...
 	   if((isset($_POST['code_cour'])) && (!empty($_POST['code_cour'])) ){
  	   ...
  	   ?>
 	   <script language="javascript1.2">
 	   window.location.replace("gestion_notes_casa.php?code_cours=<?=$code_cour?>");
 	   </script>
 	   <?php
 	                                                                     }
		  ...
		  from  tbl_note_casa as n, tbl_etudiant_casa as e 
...
<!--<select name="code_cour" class="search"  style="width:400px" >
 ...
 <?php 
	 ...
	 (select code_cours from tbl_note_casa where idSession='$idSession') ";
...
<input type="submit" value="<?php echo 'all'; ?>" name="tous" /> 
  ...
  <tr>
	  ...
	  <td align="left"><a href="gestion_notes_casa.php?code_inscription=<?=$ci?>"><?=$ci?></a></td>
