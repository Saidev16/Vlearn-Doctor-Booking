<?php
	...
	/* $sql="SELECT c.titre,c.code_cours, n.* FROM
	 $tbl_cours AS c, tbl_note_casa AS n WHERE
...
<!-- <td valign="top" align="center" >
		  ...
		  <a href="#" 
		     ...
		     onclick="javascript:if(document.adminMenu.boxchecked.value==0)
...

				   {
					 ...
					 chemin='gestion_notes_casa.php?modifierbbael='+chemin+'&foupasf='+xyz;
		  ...
		  <a href="#" 
		     ...
		     onclick="javascript:if(document.adminMenu.boxchecked.value==0)
...

				   {
				     ...
				     chemin=document.adminMenu.boxchecked.value;
				     xyz=document.adminMenu.notefoupasf.value;
					 chemin='gestion_notes_casa.php?modifiermbael='+chemin+'&foupasf='+xyz;
		  ...
		  <a href="#" 
		     ...
		     onclick="javascript:if(document.adminMenu.boxchecked.value==0)
			     ...
			     chemin=document.adminMenu.boxchecked.value;
				     xyz=document.adminMenu.notefoupasf.value;
					 chemin='gestion_notes_casa.php?modifier='+chemin+'&foupasf='+xyz;
		  ...
		  <td valign="top" align="center" width="90">
		   ...
		   <a href="gestion_notes_casa.php"><div class="retour"></div>Back</a>
...
<div class="container_search">
 ...
 <?php 
	 ...
	 FROM tbl_note_casa WHERE code_inscription = '$code_inscription') 
 ...
 <input type="submit" value="Submit" class="input"  />
  ...
  <th width="75">Final grade</th>
   ...
   <tr>
	 ...
	 <td align="left"><a href="gestion_notes_casa.php?code_cours=<?=$cc?>"><?=$cr?></a></td>
