  ...
  'GS' => '/administrator/gestion_des_etudiants_gues.php',
   'RB' => '/administrator/gestion_des_etudiants_rabat.php',
    'BEN' => '/administrator/gestion_des_etudiants_bennouna.php',
      'MARB' => '/administrator/gestion_des_etudiants_marbella.php',
...
//$code_bac=$_POST['code_bac'];
 $code_bac = mysql_real_escape_string($_POST["code_bac"]); 
$serie_bac=$_POST['serie_bac'];
...
$type = $_POST['type'];
            ...
            $sql="UPDATE $sql_table SET `code_inscription`='$ci',
 						`nom` = '$nom',
						`prenom` = '$prenom',
             ...
             @mysql_query($sql) or die ("erreur lors de la mise � jour dans la table etudiant1");
         ...
         @mysql_query($sql)or die ("SQL ERROR $sql");
          ...
          $sql2="UPDATE tbl_etudiant_all SET
				 ...
				 WHERE `code_inscription` ='$code_inscription' and prefixe= '$prefixe' limit 1 ";
						 /* WHERE `code_inscription` ='$code_inscription' and prefixe='MOR' limit 1 ";*/
        //  die('3');


         @mysql_query($sql2)or die ("erreur lors de la mise jour de cet étudiant3");
			   ...
			   && (!isset($_SESSION['filiere'])) && (!isset($_SESSION['annee'])) ){
                      ...
                      //die("/module/api_testing/edit_user.php?code_inscription=$code_inscription&prefixe=MOR&gen=$gen");
      ...
      <script type="text/javascript" language="JavaScript1.2">
          window.location.replace('/module/api_testing/edit_user.php?code_inscription=<?php echo $code_inscription; ?>&prefixe=<?php echo $prefixe; ?>&gen=<?php echo $gen; ?>');
 			</script>
    <?php } ?>
              <?php
...
<table border="0" width="100%" cellpadding="0" cellspacing="0" align="center" class="haut_table">
	...
	<td width="22%">
	  <table border="0" align="right" cellpadding="10" cellspacing="4" id="link" >
	    <tr>
		  ...
		  <td valign="top" align="center">
		   <a href="<?php echo $link; ?>" ><div class="cancel"></div>Cancel</a>
		  </td>
		</tr>
	  </table>
	</td>
 ...
 <form method="post" action="?modifier=<?php echo $code_inscription ?>&prefixe=<?php echo $prefixe; ?>&gen=<?php echo $gen; ?>" name="f_ajout" >
       ...
       <tr>
         <td valign="top" width="100%">
		  ...
		  <tr>
			   ...
			   <td><input type="text" name="nom" id="prenom" class="input" value="<?=$prenom?>" /></td>
			   <td></td>
			    <td><label for="prenom">Last Name  : </label></td>
			  <td>
				<input type="text" name="prenom" id="nom" class="input" value="<?=$nom?>" />
			  </td>
 ...
 <option value="0000">YY</option>
		  ...
		  <td><label for="archive">Status :</label> </td>
			  <td>
					...
					<option value="" <?=$archive=='' ? $selected : ''?>>Select Status</option>
