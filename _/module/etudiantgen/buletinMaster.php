 ...
 <?php
	 ...
	 $code_inscription= addslashes($_GET['buletinMaster']);
	   $prefixe= addslashes($_GET['foupasf']);
	 $gen=$_GET['gen'];
       ...
       if($prefixe=='BF')
         ...
         {    $tbl_etudiant='tbl_etudiant_cameroun';   
          $tbl_note='tbl_note_cameroun';   }
            elseif ($prefixe=='GS')
         {    $tbl_etudiant='tbl_etudiant_GUES';   
     $tbl_note='tbl_note_GUES';   }
       
        
	 $sql="SELECT e.*
	 FROM  $tbl_etudiant AS e WHERE code_inscription= '$code_inscription'";
	...
	<td width="90">
	  <table border="0" align="right" width="100%" cellpadding="10" cellspacing="4" id="link" >
		...
		<td valign="top" align="center" >
		  <a href="http://his.americanhigh.us/module/etudiantgen/printb.php?printb=<?=$code_inscription?>&prefixe=<?=$prefixe?>" target="_blank"  title="Imprimer"> 
		  <div class="imprimer"></div>Print</a>
		  </td>
		 <!--- <td valign="top" align="center" >
		  <a href="http://his.americanhigh.us/module/etudiantgen/printO.php?printO=<?=$code_inscription?>&prefixe=<?=$prefixe?>" target="_blank"  title="Imprimer"> 
		 ...
		 <td valign="top" align="center" >
		  ...
		  <div class="imprimer"></div>Imprimer</a>
		   ...
		   <td align="right">
		 <a href="gestion_des_etudiants_burkina.php"><div class="retour"></div>Back</a>
		 </td>
-->
		 ...
		 <?php if($gen == 1) { ?>
<td align="right">
<a href="gestion_des_etudiants_gen.php"><div class="retour"></div>Back</a>
</td>
<?php
}
else { ?>
