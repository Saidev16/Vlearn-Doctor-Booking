<?php
  ...
  $sql="DELETE FROM tbl_inscription_cours_morocco WHERE code_inscription = '$id' LIMIT 1";
  ...
  $sql="DELETE FROM tbl_note_morocco WHERE code_inscription = '$id' LIMIT 1";
  @mysql_query($sql)or die ("unable to archive notes");
   $sql3="DELETE FROM tbl_note_usa WHERE code_inscription = '$id' LIMIT 1";
