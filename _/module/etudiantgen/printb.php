...
connecter($serveur,$login,$mdp,$bd);
 ...
 <br /> <br /> <br /> <br /> <br /><br />  <br /> <br /> <br /><br />
   ...
   <table width="1000"  cellpadding="0" cellspacing="0" border="0" style="border:0px solid black;" align="center" class="buletin_data" >
 ...
 <table width="1000" cellspacing="0" border="1" align="center" class="buletin_data">
	...
	?>
			...
			<tr>
                ...
                <td colspan="4" width="66" align="left" ><?php echo $row['nbr_credit'];?></td>
				<td width="69" align="center" ><?php echo $row['letter_grade'];?></td>
