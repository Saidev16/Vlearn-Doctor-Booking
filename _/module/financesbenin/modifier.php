...
<?php
	...
	if (isset($_POST['code_inscription'])){
		...
		$Reinstatement=$_POST['Reinstatement'];	
	 	 ...
	 	 $sql="UPDATE tbl_finance_benin SET
		...
		@mysql_query($sql);
			...
			<!--	
					window.location.replace('gestion_finance_benin.php');
			//-->
			</script>
              <?php
						}
				 ...
				 // $annee=$_SESSION['paiement_annee'];
				   $sql="SELECT e.nom, e.prenom, f.* 
						 FROM tbl_etudiant_benin AS e, tbl_finance_benin AS f 
...
<table border="0" width="100%" cellpadding="0" cellspacing="0" align="center" class="haut_table">
	...
	<td width="22%">
	  <table border="0" align="right" width="0%" cellpadding="10" cellspacing="4" id="link" >
	    <tr>
		  ...
		  <td valign="top" align="center">
		   <a href="gestion_finance_benin.php" ><div class="cancel"></div>Cancel</a>
		  </td>
		</tr>
	  </table>
	</td> 
 ...
 <form method="post" action="gestion_finance_benin.php?modifier=oui" name="f_ajout"  >
