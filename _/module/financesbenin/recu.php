...
FROM tbl_finance_paiement_benin as p, tbl_finance_benin as f, tbl_etudiant_benin as e, $tbl_admin as a
WHERE p.id='$id' 
...
$sql="SELECT * FROM tbl_finance_benin WHERE code_inscription='$code_inscription' AND annee = '$annee'";
$req=mysql_query($sql);
