<?php
  $code_seance=(int)$_GET["desarchiver"]; 
  ...
  $sql1="update $tbl_seance set archive= 0 WHERE code_seance= '$code_seance'  limit 1";
  @mysql_query($sql1)or die ("erreur lors de l'archivage du séance  du cours");
  
  $sql2="update $tbl_syllabus set archive= 0 WHERE code_cours= '$code_cours' 
  and idSession='$idSession' limit 13";
  @mysql_query($sql2)or die ("erreur lors de l'archivage du syllabus  du cours");
  
  $sql3="update $tbl_descriptif set archive= 0 WHERE code_cours= '$code_cours'
