...
<?php
		...
		if ($nbr==0){
			...
			$sql = "INSERT INTO tbl_inscription_cours_algeria (`code_cours`, `code_inscription`, code_cours_testing, `date_inscription`, `idSession`)
...
<table border="0" width="100%" cellpadding="0" cellspacing="0" align="center" class="haut_table">
 ...
 <form method="post" action="gestion_inscription_algeria.php?full_addT=oui" name="f_ajout">
