...
<?php
	   ...
	   $sql="INSERT INTO $tbl_empreinte ( `code_livre` , `code_inscription` , `code_prof` , `date_empreint` , `code_empreinte` ) 

       VALUES ('$code_livre' , '$code_inscription', '$code_prof', '$date', NULL);";
...
<table border="0" width="100%" cellpadding="0" cellspacing="0" align="center" class="haut_table">
  ...
  <tr>
    ...
    <td width="78%" class="titre">&nbsp;GESTION DES EMPRUNTS <span style="font-size:12px">[ajouter]</span> </td>
	  ...
	  <table border="0" align="right" width="0%" cellpadding="10" cellspacing="4" >
	    ...
	    <tr>
		  ...
		  <td valign="top" align="center">
		   ...
		   <a href="gestion_livres.php" id="lien_msj" >
 ...
 <form method="post"  action="gestion_livres.php?new=oui" name="f_ajout"  >
		  ...
		  <td><select name="categorie_livre" class="input">

		  <option value="0">Sélectionner</option>

		  <?php $sql3="select distinct categorie_livre from $tbl_livre  where disponibilite = 0 order by categorie_livre";

		  $req=@mysql_query($sql3) or die ("erreur lors de la sélection des categories");

		  while($row=mysql_fetch_assoc($req)){
		  ?>

		  <option value="<?=$row['categorie_livre']?>"><?=$row['categorie_livre']?></option>
		  ...
		  <?php $sql4="select code_livre, titre_livre from $tbl_livre  where disponibilite = 0 order by titre_livre";

		  $req=@mysql_query($sql4) or die ("erreur lors de la sélection des livres");
