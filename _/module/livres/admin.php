<table border="0" width="100%" cellpadding="0" cellspacing="0" class="haut_table">
  <tr>
    <td>&nbsp;<img src="images/icone/livres.gif" border="0"/></td>
    <td width="70%"  class="titre">&nbsp;GESTION DES EMPRUNTS </td>
	<td width="30%">
	  <table border="0" align="right" width="100%" cellpadding="0" cellspacing="4" id="link" >
	    <tr>
		  ...
		  <a href="#" 
		     ...
		     onclick="javascript:if(document.adminMenu.boxchecked.value==0)
...

				   {
					 ...
					 chemin='gestion_livres.php?modifier='+chemin;
		   ...
		   <a href="#" 
		     ...
		     onclick="javascript:if(document.adminMenu.boxchecked.value==0)
...

				   {
					 ...
					 chemin='gestion_livres.php?supprimer='+chemin;
