...
$id=$_POST['id'];
											...
											`code_prof` = '$code_prof',
`retourne` = '$retourne' WHERE code_empreinte='$id' LIMIT 1 ;";
...
<table border="0" width="100%" cellpadding="0" cellspacing="0" align="center" class="haut_table">
 ...
 <form method="post" ENCTYPE="multipart/form-data" action="gestion_livres.php?new=oui" name="f_ajout">
 <input type="hidden" name="id" value="<?=$id?>" />
	   <table border="0" cellpadding="0" cellspacing="2" width="100%" style="padding-left:10px" class="cellule_table">
		  ...
		  <option value="oui"  <?php if($ex_retourne=='oui') echo "selected=\"selected\""; ?>>oui</option>
		  <option value="non" <?php if($ex_retourne=='non') echo "selected=\"selected\""; ?>>non</option>
		  </select></td>
		   <td>&nbsp;</td>
		   <td>&nbsp;</td>
		   </tr>
