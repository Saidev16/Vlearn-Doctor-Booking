...
$years = array("2014/2015","2015/2016","2016/2017","2017/2018","2018/2019","2019-2020");
//fetch data
$file = "Survey_export.xls";
$data_exported = array();
$i = 0;
...
foreach ($years as $k => $v) {
  ...
  $sql_session = "SELECT `idSession` FROM `tbl_session` WHERE `academic_year` = \"$v\" and `archive` = 0";
  //echo $sql_session;
  ...
  while ($row= mysql_fetch_assoc($ressource)){
      ...
      while ($row_prof_affectation = mysql_fetch_array($req_prof_affectation)){
        ...
        while ($row_cour_affectation = mysql_fetch_array($req_cour_affectation)){
          ...
          //Q1-->Q8
          $sql_new = "SELECT count(distinct(r.code_etudiant)) as nb ,`id_question`,r.code_etudiant, r.`id_affectation` , r.`id_reponse` , rep.`porcentage` as porcentage FROM `tbl_sondage_affectation` as a , `tbl_resultat_sondage` as r , `tbl_etudiant` as e, `tbl_reponse` as rep WHERE  a.`id` = r.`id_affectation` and r.`id_reponse` = rep.`id` and a.`id` = $id_affectation and r.`code_etudiant` = e.`code_inscription` and id_question in (1,2,3,4,5,6,7,8,15,16,23,24,25,26,27,31) group by rep.`porcentage`,`code_etudiant`,`id_question`";
          $req_new = @mysql_query($sql_new);
          $satisfaction = 0;
          $nbQ = 0;
          while ($row_new = mysql_fetch_array($req_new)) {
          ...
          //Q10
          $sql_new = "SELECT count(distinct(r.code_etudiant)) as nb ,`id_question`,r.code_etudiant, r.`id_affectation` , r.`id_reponse` , rep.`porcentage` as porcentage FROM `tbl_sondage_affectation` as a , `tbl_resultat_sondage` as r , `tbl_etudiant` as e, `tbl_reponse` as rep WHERE  a.`id` = r.`id_affectation` and r.`id_reponse` = rep.`id` and a.`id` = $id_affectation and r.`code_etudiant` = e.`code_inscription` and id_question in (10,29,28) group by rep.`porcentage`,`code_etudiant`,`id_question`";
          $req_new = @mysql_query($sql_new);
          $satisfaction = 0;
          $nbQ = 0;
          while ($row_new = mysql_fetch_array($req_new)) {
          ...
          //Q11
          $sql_new = "SELECT count(distinct(r.code_etudiant)) as nb ,`id_question`,r.code_etudiant, r.`id_affectation` , r.`id_reponse` , rep.`porcentage` as porcentage FROM `tbl_sondage_affectation` as a , `tbl_resultat_sondage` as r , `tbl_etudiant` as e, `tbl_reponse` as rep WHERE  a.`id` = r.`id_affectation` and r.`id_reponse` = rep.`id` and a.`id` = $id_affectation and r.`code_etudiant` = e.`code_inscription` and id_question in (12,14,10) group by rep.`porcentage`,`code_etudiant`,`id_question`";
          $req_new = @mysql_query($sql_new);
          $satisfaction = 0;
          $nbQ = 0;
          while ($row_new = mysql_fetch_array($req_new)) {
...
$curriculum_overall['1'] =  $curriculum;
$faculty_overall['1'] =  $faculty;
$administration_overall['1'] =  $administration;
$library_overall['1'] =  $library;
$campus_tools_overall['1'] =  $campus_tools;

// var_dump($curriculum_overall);
// var_dump($faculty_overall);
// var_dump($administration_overall);
// var_dump($library_overall);
// var_dump($campus_tools_overall);
...
">Return </a>
<a href="<?php echo $file; ?>" target="_blank" style="
  color: #fff;
  background-color: #5bc0de;
  border-color: #46b8da;
  display: inline-block;
...
<?php
//1er ligne
$data_exported[$i] = array('BBA Surveys');
 ?>
...
<table>
  <tr>
    ...
    $i++;
    $c=0;
    $data_exported[$i][$c] = "Summative Results";
  ...
  <tr>
    ...
    <?php
      $i++;
      $c=0;
      $data_exported[$i][$c] = "Satisfaction with Curriculum";
      foreach ($curriculum as $k => $v) {
        $c++;
        $data_exported[$i][$c] = round($v);
    ?>
        <th><?php
          if ($v > 100) {
            $v = 100;
  ...
  <tr>
    ...
    <?php
        $i++;
        $c=0;
        $data_exported[$i][$c] = "Satisfaction with Faculty";
  ...
  <tr>
    ...
    <?php
      $i++;
      $c=0;
      $data_exported[$i][$c] = "Satisfaction with Administration";
  ...
  <tr>
    ...
    $i++;
    $c=0;
    $data_exported[$i][$c] = "Satisfaction with Library";
  ...
  <tr>
    ...
    <?php
      $i++;
      $c=0;
      $data_exported[$i][$c] = "Satisfaction with tools";
      foreach ($campus_tools as $k => $v) {
        $c++;
        $data_exported[$i][$c] = round($v);
  ...
  <tr>
    ...
    $i++;
    $c=0;
    $data_exported[$i][$c] = "Overall Student Satisfaction";
    foreach ($overall_satisfaction as $k => $v) {
      $c++;
      $data_exported[$i][$c] = round($v);
...
$curriculum_overall['2'] =  $curriculum;
$faculty_overall['2'] =  $faculty;
$administration_overall['2'] =  $administration;
$library_overall['2'] =  $library;
$campus_tools_overall['2'] =  $campus_tools;
...
$data_exported[$i] = array("","","");
$i++;
$data_exported[$i] = array('MBA Surveys');
 ?>
...
$curriculum_overall['3'] =  $curriculum;
$faculty_overall['3'] =  $faculty;
$administration_overall['3'] =  $administration;
$library_overall['3'] =  $library;
$campus_tools_overall['3'] =  $campus_tools;
 ?>
...
$data_exported[$i] = array("","","");
$i++;
$data_exported[$i] = array('DBA Surveys');
 ?>
...
<h2>Overall Satisfaction All progrmas</h2>
<?php
//1er ligne
$i++;
$data_exported[$i] = array("","","");
...
$data_exported[$i] = array("","","");
$i++;
$data_exported[$i] = array('Overall Satisfaction');
...
// Overall satisfactions by year for all year
...
foreach ($years as $k => $y) {
    $nb = 0;
    $por = 0;
    if ($curriculum_overall['1'][$k] != false) {
      $nb++;
      $por += $curriculum_overall['1'][$k];

    }
    if ($curriculum_overall['2'][$k] != false) {
      $nb++;
      $por += $curriculum_overall['2'][$k];
    }
    if ($curriculum_overall['3'][$k] != false) {
      $nb++;
      $por += $curriculum_overall['3'][$k];
    }
    //var_dump($nb);
    //var_dump($por);
    $curriculum[$k] = $por/$nb;
    ...
    $nb = 0;
    $por = 0;
    if ($faculty_overall['1'][$k] != false) {
      $nb++;
      $por += $faculty_overall['1'][$k];
    }
    if ($faculty_overall['2'][$k] != false) {
      $nb++;
      $por += $faculty_overall['2'][$k];
    }
    if ($faculty_overall['3'][$k] != false) {
      $nb++;
      $por += $faculty_overall['3'][$k];
    }
    $faculty[$k] = $por/$nb;
    ...
    $nb = 0;
    $por = 0;
    if ($administration_overall['1'][$k] != false) {
      $nb++;
      $por += $administration_overall['1'][$k];
    }
    if ($administration_overall['2'][$k] != false) {
      $nb++;
      $por += $administration_overall['2'][$k];
    }
    if ($administration_overall['3'][$k] != false) {
      $nb++;
      $por += $administration_overall['3'][$k];
    }
    $administration[$k] = $por/$nb;

    //-----------------------
    $nb = 0;
    $por = 0;
    if ($library_overall['1'][$k] != false) {
      $nb++;
      $por += $library_overall['1'][$k];
    }
    if ($library_overall['2'][$k] != false) {
      $nb++;
      $por += $library_overall['2'][$k];
    }
    if ($library_overall['3'][$k] != false) {
      $nb++;
      $por += $library_overall['3'][$k];
    }
    $library[$k] = $por/$nb;
    ...
    $nb = 0;
    $por = 0;
    if ($campus_tools_overall['1'][$k] != false) {
      $nb++;
      $por += $campus_tools_overall['1'][$k];
    }
    if ($campus_tools_overall['2'][$k] != false) {
      $nb++;
      $por += $campus_tools_overall['2'][$k];
    }
    if ($campus_tools_overall['3'][$k] != false) {
      $nb++;
      $por += $campus_tools_overall['3'][$k];
    }
    $campus_tools[$k] = $por/$nb;
...
foreach ($years as $k => $v) {
  ...
  foreach ($id_question as $id) {
    if ($id != 6) {
      $sql_new = "SELECT count(distinct(r.`code_inscription`)) as nb ,`id_question`, r.`id_reponse` , rep.`porcentage` as porcentage FROM `resultat_alumni` as r , `tbl_reponse_alumni` as rep , `tbl_etudiant` as et WHERE
...
foreach ($years as $k => $v) {
    ...
    $sql_new = "SELECT count(distinct(r.`code_inscription`)) as nb FROM `resultat_alumni` as r , `tbl_etudiant_deac` as et WHERE
        (et.`date` BETWEEN '$annee1-09-01' AND '$annee2-09-30' or et.`datemba` BETWEEN '$annee1-09-01' AND '$annee2-09-30' or et.`datedba` BETWEEN '$annee1-09-01' AND '$annee2-09-30') and
    ...
    $sql_new = "SELECT count(distinct(et.`code_inscription`)) as nb FROM `tbl_etudiant_deac` as et WHERE et.`date` BETWEEN '$annee1-09-01' AND '$annee2-09-30' or et.`datemba` BETWEEN '$annee1-09-01' AND '$annee2-09-30' or et.`datedba` BETWEEN '$annee1-09-01' AND '$annee2-09-30'";
    //var_dump($sql_new);
    $req_new = @mysql_query($sql_new);
    $row_new = mysql_fetch_array($req_new);
...
$data_exported[$i] = array("","","");
$i++;
$data_exported[$i] = array('Alumni Surveys');
 ?>
<table>
  <tr>
    <th>Summative Results</th>
  ...
  <tr>
    ...
    <?php
    $i++;
    $data_exported[$i][$c] = "Quality of Education";

    foreach ($years as $k => $v) {
      $c++;
      $data_exported[$i][$c] = $porcentage[$v][0];
        ?>
  ...
  <tr>
    ...
    <?php
    $i++;
      $data_exported[$i][$c] = "Value Education/Tuition";

      foreach ($years as $k => $v) {
          $c++;
          $data_exported[$i][$c] = $porcentage[$v][1];
    ?>
  ...
  <tr>
    ...
    <?php
    $i++;
      $data_exported[$i][$c] = "Performance Improvement";

      foreach ($years as $k => $v) {
          $c++;
          $data_exported[$i][$c] = $porcentage[$v][2];
    ?>
  ...
  <tr>
    ...
    <?php
      $i++;
      $data_exported[$i][$c] = "Referral rate";

      foreach ($years as $k => $v) {
          $c++;
          $data_exported[$i][$c] = $porcentage[$v][3];
    ?>
  ...
  <tr>
    ...
    <?php
      $i++;
      $data_exported[$i][$c] = "Overall Satisfaction";
  ...
  <tr>
    ...
    <?php
      $i++;
      $data_exported[$i][$c] = "Placement Rate";

      foreach ($placement_rate as $k => $v) {
          $c++;
          $data_exported[$i][$c] = $v;
    ?>
        <th><?php echo $v."%"; ?></th>
