...
$idSession = $_POST['idSession'];
 ...
 $sql_insert="INSERT INTO $tbl_etudiant (`nom` , `prenom` , `date_naissance` , `nationalite` , `adresse` , `sexe` , `code_bac` , `serie_bac` ,
...
VALUES ('$nom', '$prenom', '$date_naissance', '$nationalite', '$adresse', '$sexe', '$code_bac', '$serie_bac', '$date_insc', '$tel', '$mail', '$annee', '$semestre', '$filiere', '$lieu_naissance', '$cin', '$cinq_photo', '$original_bac', '$copie_bac', '$english_bac', '$trois_lettre', '$trois_enveloppe', '$buletin_note',  '$reglement', '$copie_cin', '$extrait', '$note_etudesoc', '$note_fr', '$note_sciences', '$note_math', '$aquise', '$nom', '$pass', 1, '$groupe', '$activite', '$annee_inscription', '$niveau', '$ville', '$elearning', '$piimt', '$aul', '$umt');"; 
	  @mysql_query($sql_insert)or die ("Error save studentPSI");
	  
	$sql14 = "SELECT code_inscription FROM tbl_etudiant
	...
	if($groupe==2)
	{
		    ...
		    if ($code_cours != '' ) 
			{
				//$type_cours = str_replace('_', ' ', $_POST['special_price'.$i]);
		      	$sql = "SELECT COUNT(*) AS nbr FROM $tbl_inscription_cours 
		...
		if ($nbr==0)
		{
			...
			$sql = "INSERT INTO $tbl_inscription_cours (`code_cours`, `code_inscription`, `date_inscription`, `idSession`,`type_cours_id`, `section`)
			...
			$sql = "insert into $tbl_note(code_inscription, code_cours, idSession, archive, section,letter_grade) 
...
<table border="0" width="100%" cellpadding="0" cellspacing="0" align="center" class="haut_table">
	...
	<td width="20%">
	  <table border="0" align="right" width="0%" cellpadding="10" cellspacing="4" id="link" >
	    <tr>
		  ...
		  <td valign="top" align="center">
		   <a href="gestion_des_etudiants.php"><div class="cancel"></div>Cancel</a>
		  </td>
		</tr>
	  </table>
	</td> 
  ...
  <form method="post" action="gestion_des_etudiants.php?new=oui" name="f_ajout" >
