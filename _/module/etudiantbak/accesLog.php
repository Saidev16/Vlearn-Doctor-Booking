...
if (isset($_GET['journal'])){
	 ...
	 $code_inscription=(int)$_GET['journal'];
	 ?>
	...
	<td width="22%">
	  <table border="0" align="right" width="0%" cellpadding="10" cellspacing="4" id="link" >
		...
		<td valign="top" align="center" >
		 ...
		 <td align="right">
		 	<a href="gestion_des_etudiants.php?detail=<?php echo $code_inscription; ?>"><div class="retour"></div>retour</a>
		 </td>
		</tr>
	  </table>
	</td> 
	 ...
	 <tr>
    <th>Date et heure d'accès</th>
	<th>Adresse ip de l'&eacute;tudiant</th>
  </tr>
	 <?php
	 $sql="select date, ip from $tbl_log where id_user='$code_inscription' order by date desc";
