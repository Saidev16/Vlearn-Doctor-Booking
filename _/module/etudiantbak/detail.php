...
<table border="0" width="100%" cellpadding="0" cellspacing="0" align="center" class="haut_table">
	...
	<td width="90">
	  <table border="0" align="right" width="100%" cellpadding="10" cellspacing="4" id="link" >
	    <tr>
		  ...
		  <a href="gestion_des_etudiants.php?modifier=<?=$code_inscription?>">
		  <div class="modifier"></div>Edit</a>
		  </td>
		  <!-- <td valign="top" align="center" >
		  <a href="gestion_des_etudiants.php?journal=<?=$code_inscription?>">
		 ...
		 <td valign="top" align="center" >
		  ...
		  <div class="imprimer"></div>Print</a>
		   ...
		   <td align="right">
		 <a href="gestion_des_etudiants.php"><div class="retour"></div>Back</a>
		 </td>
		</tr>
	  </table>
	</td> 
  ...
  <tr>
   <td><span class="gras">Date of Birth </span> :&nbsp;<?=$row['date_naissance']?></td>
  ...
  <tr>
    <td><span class="gras">Adress</span> :&nbsp;<?=$row['adresse']?></td>
   ...
   <tr>
    ...
    <tr>
    <td ><span class="gras">ID,Passport or Driver's Licence</span> :&nbsp;<?=$row['cin']?></td>
	<td ><span class="gras">Registration Date</span> :&nbsp;<?=$row['date_inscription']?></td>
   ...
   <tr>
    <td><span class="gras">Name of Lasted School attented:&nbsp;</span><?=$row['lieu_naissance']?></td>
    <td><span class="gras">School Adress </span> :&nbsp;<?=$row['code_bac']?></td>
   ...
   <td><span class="gras">ASL application forms :&nbsp;</span><?=$row['trois_lettre']?></td>
    <td ><span class="gras">2 Notarized copy of Your ID:&nbsp;</span><?=($row['copie_cin']==1) ? 'Yes' : 'No'?></td>
...
<tr>
  ...
  <tr>
   ...
   <td><span class="gras">Section</span> :&nbsp;<?=$row['groupe']== '2' ?  'frensh' :  'english' ?></td>
