<?php
		$niveau=$filiere=$annee=$where=$code=$search=$sgroupe=$annee_inscription=$elearning=$search_student='';
		$groupeFilter=" ";
	 ...
	 $sql = "SELECT distinct e.code_inscription, concat(e.nom, ' ' ,e.prenom) as name, 
	 		 e.tel, f.nom_filiere, e.date_inscription, g.title, e.annee,e.acces
			 FROM $tbl_etudiant as e, $tbl_filiere as f, $tbl_groupe as g 
			 where e.filiere=f.id_filiere and e.groupe=g.id and e.archive = 1 " 
...
<table border="0" width="100%" cellpadding="0" cellspacing="0" align="center" class="haut_table">
  <tr>
    ...
    <td class="titre">&nbsp;GESTION DES ETUDIANTS <span style="font-size:11px; font-weight:bold">[archive]</span></td>
	<td width="150">
		   ...
		   <a href="#"
		     onclick="javascript:if(document.adminMenu.boxchecked.value==0)
...

				   {
					 ...
					 chemin='gestion_des_etudiants.php?desarchiver='+chemin;

				     window.location.replace(chemin);

				   }

				   "><div class="ajouter"></div>D&eacute;sarchiver</a>
		  </td>
		   <td valign="top" align="center">
		   <a href="gestion_des_etudiants.php?desarchiver=oui" >
