...
$electives = "''";
      ...
      $html .="<table style='width: 100%;
          ...
          while($row = mysql_fetch_assoc($req)){
            ...
            $html .="<tr>
              <td style='width:100px;padding:5px;border: 1px solid #dee2e6;text-align:center;' >".$row['code_cours']."</td>
              <td style='padding:5px;border: 1px solid #dee2e6;text-align:left;'  >".strtoupper($row['titre_eng'])."</td>
              <td style='width:50px;padding:5px;border: 1px solid #dee2e6;text-align:center;' >".$row['nbr_credit']."</td>
              <td style='width:50px;padding:5px;border: 1px solid #dee2e6;text-align:center;' >$letter_grade</td>
            </tr>
            ";
          }
                ...
                if ($code_cours_elective != null) {
                  ...
                  if ($code_cours_elective != "10099012" and $code_cours_elective != "100990") {
                    $electives .= ",'$code_cours_elective'";
                    $electives_select .= ",'$code_cours_elective'";
                  }
            ...
            <tr>
              ...
              $html .="<table style='width: 100%;
                ...
                if ($code_cours_elective != null) {
                  ...
                  //   <td style='padding:5px;border: 1px solid #dee2e6;text-align:left;'  >".$row['code_cours']." / ".strtoupper($row['titre_eng'])."</td>
                  //   <td style='width:50px;padding:5px;border: 1px solid #dee2e6;text-align:center;' >".$row['nbr_credit']."</td>
                  //   <td style='width:50px;padding:5px;border: 1px solid #dee2e6;text-align:center;' >".$letter_grade."</td>
                  // </tr>";
        ...
        // 12th
            ...
            <tr>
              ...
              <th style='padding:5px;border: 1px solid #dee2e6;'>Grade</th>
                ...
                if ($code_cours_language != null) {
                  ...
                  //   <td style='padding:5px;border: 1px solid #dee2e6;text-align:left;'  >
                  //     ".$row['code_cours']." / ".strtoupper($row['titre_eng'])."
                  //   </td>
                  //   <td style='width:50px;padding:5px;border: 1px solid #dee2e6;text-align:center;' >".$row['nbr_credit']."</td>
                  //   <td style='width:50px;padding:5px;border: 1px solid #dee2e6;text-align:center;' >$letter_grade</td>
                  // </tr>";
          ...
          $html .="<table style='width: 100%;
            ...
            <tr>
              ...
              <td style='width:100px;padding:5px;border: 1px solid #dee2e6;text-align:center;'  colspan='1'>
                $ttl_tr Cr
              </td>
            </tr>
            <tr>
