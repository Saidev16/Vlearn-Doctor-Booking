<?php
  ...
  $sql = "SELECT code_inscription, annee, somme  FROM tbl_finance_paiement_cameroun WHERE id='$id' LIMIT 1";  
  ...
  $row = @mysql_fetch_assoc($req);
    ...
    $sql="DELETE FROM tbl_finance_paiement_cameroun WHERE id='$id'";
