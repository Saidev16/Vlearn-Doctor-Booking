...
FROM tbl_finance_paiement_cameroun as p, tbl_finance_cameroun as f, tbl_etudiant_cameroun as e, $tbl_admin as a
WHERE p.id='$id' 
...
$sql="SELECT * FROM tbl_finance_cameroun WHERE code_inscription='$code_inscription' AND annee = '$annee'";
$req=mysql_query($sql);
