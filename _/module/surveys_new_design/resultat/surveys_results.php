	...
	<div class="col-lg-12">
		<div class="card-header" style="background-color: #fff !important;">
          ...
          <a href="?item=<?php echo $_GET['item']; ?>" style="color: #fff;text-decoration: none;" class="btn btn-success btn-xs">Return</a>
              ...
              <h3 class="text-center">BBA Survey</h3>
				</div>
			</div>
		</div>
  </div>
...
<?php if (isset($_GET['surveys_results']) && isset($_GET['id'])): ?>
            ...
            <div class="col-lg-6">
              <div class="card-header" style="background-color: #fff !important;">
                <div class="row show-grid">
                  <div class="col-md-12 mt-2">
                    <a class="text-primary card-title" style="font-size: 15px;font-weight: bold;" class="collapsed" href="?item=<?php echo $_GET['item']; ?>&surveys_results&id=<?php echo $id_sondage; ?>&affectation=<?php echo $id_affectation; ?>">
    									<?php echo $code_cour." : "; ?>
    									<?php
              ...
              <div class="card ">
                <div class="card-body">
						...
						<?php
							//Q9
							$sql_new = "SELECT count(distinct(r.code_etudiant)) as nb ,`id_question`,r.code_etudiant, r.`id_affectation` , r.`id_reponse` , rep.`porcentage` as porcentage FROM `tbl_sondage_affectation` as a , `tbl_resultat_sondage` as r , `tbl_reponse` as rep , `tbl_etudiant` as e WHERE  a.`id` = r.`id_affectation` and r.`id_reponse` = rep.`id` and a.`id` = $id_affectation and r.`id_sondage` in ($id_sondage,2,7)  and a.`campus`= 'e-learning' and r.`code_etudiant` = e.`code_inscription`  and id_question in (9,22,21,19,18,17,13) group by rep.`porcentage`,`code_etudiant`,`id_question`";
    ...
    <div class="ribbon-wrapper card">
        <div class="row">
            <div class="ribbon ribbon-danger"><?php echo $sondage_title; ?></div>
            <p class="ribbon-content text-primary mt-10 ml-20">
		...
		<?php
            ...
            <div class="col-lg-12">
              ...
              <div class="card ">
                <div class="card-body">
                <div class="col-md-12 mt-2 card-title">
                  <h4><?php echo $row_question['question_en']; ?></h4>
                </div>
      						<table class="display nowrap tablesaw  table table-hover table-striped table-bordered color-table red-table">
  									<thead>
  										<tr>
          ...
          if ($porcentage5 != 0) {
            ...
            <div class="col-lg-6">
              <div class="card-header" style="background-color: #fff !important;">
                <div class="row show-grid">
                  <div class="col-md-12 mt-2">
                    <a class="text-primary card-title" href="?item=<?php echo $_GET['item']; ?>&surveys_results&id=<?php echo $id_sondage; ?>&code_prof=<?php echo $code_prof; ?>"><?php echo ucwords($nom_prof); ?> <span class="badge badge-success" style="float: right;"><?php echo $nb_cours; if ($nb_cours == 1) {echo "  Course";}else{echo "  Courses";} ?> <i class="entypo-plus-circled"></i></span>
  									</a>
  									<p class="btn btn-success btn-xs" style="display: none;"><?php echo ucwords($nom_prof); ?> <span class="badge badge-success" style="float: right;"><?php echo $nb_cours; if ($nb_cours == 1) {echo "  Course";}else{echo "  Courses";} ?> </span></p>
                  </div>
                </div>
              </div>
              <div class="card ">
