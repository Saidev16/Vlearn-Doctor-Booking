...
<?php
	...
	/* $sql = "SELECT distinct e.code_inscription, concat(e.nom, ' ' ,e.prenom) as name,
			 ...
			 FROM $tbl_etudiant_marbella as e, $tbl_filiere as f, $tbl_groupe as g
...
$sql = "SELECT distinct e.code_inscription, concat(e.nom, ' ' ,e.prenom) as name,
			 ...
			 FROM tbl_etudiant_marbella as e
			 where  e.archive != 10"
	  ...
	  <table border="0" align="right" width="100%" cellpadding="10" cellspacing="4" id="link" >
	    <tr>
		 ...
		 <td valign="top" align="center">
		   <a href="gestion_des_etudiants_marbella.php?new=oui">
		   ...
		   <a href="#"
		     onclick="javascript:if(document.adminMenu.boxchecked.value==0)
...

				   {
					 ...
					 chemin='transcript.php?code_inscription='+chemin+'&prefixe=MARB';
		 ...
		 <?php } ?>
		  <td valign="top" align="center" >
		  <a href="gestion_des_etudiants_marbella.php?laureat" title="laureat">
		   ...
		   <a href="#"
		     onclick="javascript:if(document.adminMenu.boxchecked.value==0)
...

				   {
					 ...
					 chemin='gestion_des_etudiants_marbella.php?supprimer='+chemin;
  ...
  jQuery(".valider").click(function(){
      ...
      if (ancien_value != value) {
          jQuery.ajax({
              ...
              evalscripts:true,
              type: "POST",
              url: 'gestion_des_etudiants_marbella.php?ajaxmod',
