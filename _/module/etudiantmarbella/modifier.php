...
$archive = $_POST['archive'];
					...
					// update table etudiant
                         ...
                         $sql="UPDATE tbl_etudiant_marbella SET `code_inscription`='$ci',
 						`nom` = '$nom',
						`prenom` = '$prenom',
			...
			//-->
              ...
              <?php
					  ...
					  $sql="UPDATE tbl_etudiant_marbella SET  
 						`nom` = '$nom',
						`prenom` = '$prenom',
						`date_naissance` = '$date_naissance',
						`nationalite` = '$nationalite',
         ...
         @mysql_query($sql)or die ("erreur lors de la mise à jour de cet étudiant2");
          ...
          $sql2="UPDATE tbl_etudiant_all SET  
						...
						`parentemail` = '$parentemail'
						 ...
						 WHERE `code_inscription` ='$code_inscription' and prefixe='MARB' limit 1 "; 
//die($sql);
         @mysql_query($sql2)or die ("erreur lors de la mise à jour de cet étudiant3");
			...
			//-->
			  ...
			  $sql2="select * from tbl_etudiant_marbella  
			  where code_inscription='$code_inscription' limit 1 ";
...
<table border="0" width="100%" cellpadding="0" cellspacing="0" align="center" class="haut_table">
 ...
 <form method="post" action="gestion_des_etudiants_marbella.php?modifier=Yes" name="f_ajout" >
...
<option value="marbella Faso" <?php echo $ville=='marbella Faso'?$selected : ''?>>marbella Faso</option>
