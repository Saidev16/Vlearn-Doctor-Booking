<?php
	...
	$sql="SELECT type_cours_id FROM tbl_inscription_cours_all
		...
		$academic_year=$row['academic_year'];
		  ...
		  $sql="DELETE FROM tbl_inscription_cours_all  
...
?>
        ...
        <!--
        	window.location.replace('gestion_inscription_all.php?code_cours=<?=$code_cours?>&idSesion=<?=$idSession?>&type=<?=$type?>&code=<?=$code_cours?>&code_inscription=<?=$code_inscription?>');
        //-->
        </script>