  ...
  <tr>
	...
	<td width="22%">
	  <table border="0" align="right" width="15%" cellpadding="10" cellspacing="2" id="link" >
	    <tr>
		<!--<td valign="top" align="center"><a href="gestion_inscription_all.php?new=oui">
		  ...
		  <a href="#" 
		     ...
		     onclick="javascript:if(document.adminMenu.boxchecked.value==0)
...

				   {
					 ...
					 chemin='gestion_inscription_all.php?modifier='+chemin;
		  ...
		  <a href="#" 
		     ...
		     onclick="javascript:if(document.adminMenu.boxchecked.value==0)
...

				   {
					 ...
					 chemin='gestion_inscription_all.php?supprimer='+chemin;
		 ...
		 <td valign="top" align="center"><a href="gestion_inscription_all.php">
...
<input type="hidden" name="boxchecked" value="0" />
  ...
  <?php
   ...
   $sql="select e.code_inscription, concat(e.nom,' ', e.prenom) as name, 
	      ...
	      from tbl_inscription_cours_all as i, tbl_etudiant_all as e, $tbl_cours as c
		   where  
...
<tr>
	 ...
	 <td align="left"><a href="gestion_inscription_all.php?code_inscription=<?=$cn?>">&nbsp;<?=ucfirst($row["name"])?></a></td>
