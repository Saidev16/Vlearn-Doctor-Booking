...
$sql = "SELECT e.code_inscription,e.nom,e.prenom,count(n.`code_cours`) as nb FROM `tbl_note_morocco` as n , tbl_etudiant_morocco as e WHERE
      ...
      <tbody>
        ...
        ?>
          <tr>
            ...
            <td class="text-center" style="color: #000;">
              <a href="/module/inscriptionsmorocco/transfer_sheet.php?transfer_sheet=<?php echo $row['code_inscription'] ?>" target="_blank" class="btn btn-sm btn-success">transfer sheet</a>
            </td>
          </tr>
        <?php
            $i++;
