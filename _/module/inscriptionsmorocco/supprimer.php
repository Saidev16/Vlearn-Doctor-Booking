<?php
	...
	$sql="SELECT type_cours_id FROM tbl_inscription_cours_morocco
		...
		$academic_year=$row['academic_year'];
		  ...
		  $sql="DELETE FROM tbl_inscription_cours_morocco  
		  ...
		  $sql="DELETE FROM tbl_note_morocco  
		  		  WHERE code_cours='$code_cours' 
				  AND code_inscription='$code_inscription'
				  ";
...
?>
        ...
        <!--
        	window.location.replace('gestion_inscription_morocco.php?code_cours=<?=$code_cours?>&idSesion=<?=$idSession?>&type=<?=$type?>&code=<?=$code_cours?>&prix=<?=$prix?>&code_inscription=<?=$code_inscription?>');
        //-->
        </script>