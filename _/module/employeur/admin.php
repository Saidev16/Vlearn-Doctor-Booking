					 ...
					 $_SESSION['type_emp'] = $type_emp;
  	                $where = $where." and type_emp='". $type_emp."'";
		                 ...
		                 $sql="SELECT * FROM $tbl_employeur 
						       where archive = 0 ".$where."  ORDER BY nom ";
...
<table border="0" width="100%" cellpadding="0" cellspacing="0" align="center" class="haut_table">
  <tr>
    ...
    <td width="78%" class="titre">&nbsp;GESTION DES EMPLOYEURS </td>
	<td width="22%">
	  <table border="0" align="right" width="100%" cellpadding="5" cellspacing="4" id="link" >
	    <tr>
		 <td valign="top" align="center">
		   <a href="gestion_employeur.php?new=oui"><div class="ajouter"></div>Nouveau</a>
		  </td>
		  <td valign="top" align="center" >
		  ...
		  <a href="#" onclick="javascript:if(document.adminMenu.boxchecked.value==0)
...

				   {
					 ...
					 chemin='gestion_employeur.php?modifier='+chemin;
 		   ...
 		   <a href="#" 
 		     onclick="javascript:if(document.adminMenu.boxchecked.value==0)
...

				   {
					 ...
					 chemin='gestion_employeur.php?archiver='+chemin;
 		 ...
 		 <td valign="top" align="center">
 		   <a href="gestion_employeur.php?archive=oui"><div class="archive"></div>Archive</a>
 		  </td>
 		   <td valign="top" align="center" >
 		  <a href="#" onclick="window.print()"  id="lien_msj" title="Imprimer"><div class="imprimer"></div>Imprimer</a>
 		  </td>
 		</tr>
 	  </table>
