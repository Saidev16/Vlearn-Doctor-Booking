 ...
 <?php
	 ...
	 $sql="SELECT e.*
	 FROM tbl_etudiant_algeria AS e WHERE code_inscription= '$code_inscription'";
	...
	<td width="90">
	  <table border="0" align="right" width="100%" cellpadding="10" cellspacing="4" id="link" >
		...
		<td valign="top" align="center" >
		  <a href="http://his.americanhigh.us/module/etudiantalgeria/printb.php?printb=<?=$code_inscription?>" target="_blank"  title="Imprimer">
...
<table width="1000" cellspacing="0" border="1" align="center" class="buletin_data">
	...
	?>
			...
			<?php
             ...
             FROM tbl_note_algeria AS n, tbl_cours AS c
