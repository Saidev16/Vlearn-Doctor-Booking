...
$sql = "SELECT distinct e.code_inscription, concat(e.nom, ' ' ,e.prenom) as name,
			 ...
			 FROM tbl_etudiant_algeria as e
			 where  e.archive = 0"
...
<table border="0" width="100%" cellpadding="0" cellspacing="0" align="center" class="haut_table">
	  ...
	  <table border="0" align="right" width="100%" cellpadding="10" cellspacing="4" id="link" >
	    <tr>
		 <td valign="top" align="center">
		   <a href="gestion_des_etudiants_algeria.php?new=oui">
		     ...
		     onclick="javascript:if(document.adminMenu.boxchecked.value==0)
...

				   {
				     ...
				     chemin=document.adminMenu.boxchecked.value;
						 ...
						 chemin='gestion_des_etudiants_algeria.php?buletinBachelor='+chemin;
		     ...
		     onclick="javascript:if(document.adminMenu.boxchecked.value==0)
...

				   {
				     ...
				     chemin=document.adminMenu.boxchecked.value;
					   ...
					   chemin='transcript.php?code_inscription='+chemin+'&prefixe=AG';
 ...
 <td valign="top" align="center" >
		  <a href="gestion_des_etudiants_algeria.php?laureat" title="laureat">
		   ...
		   <a href="#"
		     onclick="javascript:if(document.adminMenu.boxchecked.value==0)
...

				   {
					 ...
					 chemin='gestion_des_etudiants_algeria.php?supprimer='+chemin;
		   ...
		   <a href="#"
		     onclick="javascript:if(document.adminMenu.boxchecked.value==0)
				   ...
				   else
				   {
					 ...
					 chemin='gestion_des_etudiants_algeria.php?archiver='+chemin;
          	  ...
          	  <td valign="top" align="center">
		   <a href="gestion_des_etudiants_algeria.php?archive=oui"><div class="archive"></div>Archive</a>
		  </td>-->
 		  <td valign="top" align="center" >
...
-->
	 ...
	 <td align="center">&nbsp;<?=$i?>
       ...
       <input type="radio" id="<?=$ci?>" name="id" value="<?=$ci?>"
		     onClick="document.adminMenu.boxchecked.value='<?php echo $ci.'&prefixe='.$prefixe;?>'" prefixe="<?=$prefixe?>" />
    </td>
  ...
  jQuery(".valider").click(function(){
      ...
      if (ancien_value != value) {
          jQuery.ajax({
              ...
              evalscripts:true,
              type: "POST",
              url: 'gestion_des_etudiants_algeria.php?ajaxmod',
