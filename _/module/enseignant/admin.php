<?php
		  ...
		  $sql="select code_prof, nom_prenom, contact, mail, diplome, niveau,ville 
	   			from $tbl_professeur 
...
<table border="0" width="100%" cellpadding="0" cellspacing="0" align="center" class="haut_table">
  <tr>
    ...
    <td width="78%" class="titre">&nbsp;Teachers</td>
	<td width="22%">
	  <table border="0" align="right" width="100%" cellspacing="10"  id="link" >
	    ...
	    <tr>
		 ...
		 <td valign="top" align="center">
			<a href="gestion_enseignants.php?new=oui"><div class="ajouter"></div>Add</a>
		  </td>
		  ...
		  <td valign="top" align="center">
		   <a href="#" 
		     onclick="javascript:if(document.adminMenu.boxchecked.value==0)
				   ...
				   {
				     chemin=document.adminMenu.boxchecked.value;
					 chemin='gestion_enseignants.php?supprimer='+chemin;
				     window.location.replace(chemin);}">
