         ...
         <td valign="top" width="100%">
		  ...
		  <td>
			  <select name="semestre" id="semestre" style="width:200px" class="input">
				  ...
				  <option value="2 FR" <?=$semestre=='2 FR' ? $selected : ''; ?>>Deuxième semestre FR</option>
				  <option value="3 FR" <?=$semestre=='3 FR' ? $selected : ''; ?>>Troisième semestre FR</option>
				  <option value="4 FR" <?=$semestre=='4 FR' ? $selected : ''; ?>>Quatrième semestre FR</option>
				  <option value="5 FR" <?=$semestre=='5 FR' ? $selected : ''; ?>>Cinquième semestre FR</option>
				  <option value="6 FR" <?=$semestre=='6 FR' ? $selected : ''; ?>>Sixième semestre FR</option>
				  <option value="7 FR" <?=$semestre=='7 FR' ? $selected : ''; ?>>Septième semestre FR</option>
				  <option value="8 FR" <?=$semestre=='8 FR' ? $selected : ''; ?>>Huitième semestre FR</option>
				  <option value="9 FR" <?=$semestre=='9 FR' ? $selected : ''; ?>>Neivième semestre FR</option>
				  <option value="10 FR" <?=$semestre=='10 FR' ? $selected : ''; ?>>dixième semestre FR</option>
                  <option value="1 ANG" <?=$semestre=='1 ANG' ? $selected : ''; ?>>Premier semestre ANG</option>
				  <option value="2 ANG" <?=$semestre=='2 ANG' ? $selected : ''; ?>>Deuxième semestre ANG</option>
				  <option value="3 ANG" <?=$semestre=='3 ANG' ? $selected : ''; ?>>Troisième semestre ANG</option>
				  <option value="4 ANG" <?=$semestre=='4 ANG' ? $selected : ''; ?>>Quatrième semestre ANG</option>
				  <option value="5 ANG" <?=$semestre=='5 ANG' ? $selected : ''; ?>>Cinquième semestre ANG</option>
				  <option value="6 ANG" <?=$semestre=='6 ANG' ? $selected : ''; ?>>Sixième semestre ANG</option>
				  <option value="7 ANG" <?=$semestre=='7 ANG' ? $selected : ''; ?>>Septième semestre ANG</option>
				  <option value="8 ANG" <?=$semestre=='8 ANG' ? $selected : ''; ?>>Huitième semestre ANG</option>
				  <option value="9 ANG" <?=$semestre=='9 ANG' ? $selected : ''; ?>>Neivième semestre ANG</option>
				  <option value="10 ANG" <?=$semestre=='10 ANG' ? $selected : ''; ?>>dixième semestre ANG</option>
 			  </select>
		  </td>
          ...
          <tr>
            ...
            <td colspan="3"><textarea cols="" rows="" name="attestation_fr" id="attestation_fr" style="width:900px; height:100px;"><?php if ($attestation_fr!=''){ echo $attestation_fr; } else {?>Est étudiant<?=$sexe=='masculin' ? '' : 'e'?> au programme du <?php echo $niveau?> « <?=$niveau=='BBA' ? $bba : $mba ?> » au sein de  l’Institut Supérieur
 « Private International Institute Of Management and Technology » P.I.I.M.T pour l’année universitaire <?php echo date('Y')-1?>-<?php echo date('Y')?>.<?php }?></textarea></td>
          </tr>
          <tr>
