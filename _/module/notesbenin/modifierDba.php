...
$some_coef=0;
 ...
 if(isset($_POST['incomplete']) and$_POST['incomplete']=='incomplete'){
  ...
  // fin du calcule de la note finale	
			...
			<!--	
				window.location.replace("gestion_des_etudiants.php?gradesdba=<?=$code_inscription?>");
			//-->
			</script>
              <?php
			  }
...
<table border="0" width="100%" cellpadding="0" cellspacing="0" align="center" class="haut_table">
	...
	<td width="22%">
	  <table border="0" align="right" width="0%" cellpadding="10" cellspacing="4" id="link" >
	    <tr>
 		  ...
 		  <td valign="top" align="center">
		   <a href="gestion_des_etudiants.php?gradesdba=<?=$code_inscription?>">
 ...
 <form method="post"  action="gestion_notes.php?modifierDba=oui" name="f_ajout">
