...
<?php
		...
		$sql = "SELECT COUNT(*) AS nbr FROM tbl_inscription_cours_cameroun WHERE code_inscription='$code_inscription' 
		...
		if ($nbr==0){
			...
			$sql = "INSERT INTO tbl_inscription_cours_cameroun (`code_cours`, `code_inscription`, code_cours_testing, `date_inscription`, `idSession`)
			VALUES ('$code_cours', '$code_inscription','$code_cours_testing', '$date', '$idSession');";
 	         ...
 	         @mysql_query($sql)or die ('Erreur :: inscription11');
				...
				$sql = "insert into tbl_note_cameroun (code_inscription, `code_cours`, code_cours_testing, idSession, archive, section,letter_grade) 
			...
			<!--	
 			window.location.replace('gestion_inscription_cameroun.php?code_inscription=<?=$code_inscription?>&idSession=<?=$idSession?>');
			//-->
			</script>
			  <?php
 			  }
...
<table border="0" width="100%" cellpadding="0" cellspacing="0" align="center" class="haut_table">
	...
	<td width="22%">
	  <table border="0" align="right" width="0%" cellpadding="10" cellspacing="4" id="link" >
	    <tr>
		  ...
		  <td valign="top" align="center">
		   <a href="gestion_inscription_cameroun.php" ><div class="cancel"></div>Cancel</a>
		  </td>
		</tr>
	  </table>
	</td> 
 ...
 <form method="post" action="gestion_inscription_cameroun.php?full_addc=oui" name="f_ajout">
	 ...
	 <tr><td colspan="4" height="3px"></td></tr>
		  ...
		  <select name="code_inscription" id="code_inscription" class="input">
				<option value="">Sélectionner</option>
		  <?php 
		   $sql6="select code_inscription, nom, prenom from tbl_etudiant_cameroun where archive = 0 AND groupe not in (5,7) order by prenom, nom";
