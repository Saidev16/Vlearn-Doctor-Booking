...
FROM tbl_finance_paiement_casa as p, tbl_finance_casa as f, tbl_etudiant_casa as e, $tbl_admin as a
WHERE p.id='$id' 
...
$sql="SELECT * FROM tbl_finance_casa WHERE code_inscription='$code_inscription' AND annee = '$annee'";
$req=mysql_query($sql);
