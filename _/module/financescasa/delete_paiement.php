<?php
  ...
  $sql = "SELECT code_inscription, annee, somme  FROM tbl_finance_paiement_cassa WHERE id='$id' LIMIT 1";  
  ...
  $row = @mysql_fetch_assoc($req);
    ...
    $sql="DELETE FROM tbl_finance_paiement_cassa WHERE id='$id'";
	@mysql_query($sql) or die('Error :: Delete fiche');	
	   
?>
<script type="text/javascript" language="JavaScript1.2">
			<!--	
					window.location.replace('gestion_finance_cassa.php?detail=<?=$code_inscription;?>');
			//-->
			</script>
