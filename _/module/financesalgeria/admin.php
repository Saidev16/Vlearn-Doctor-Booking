		   ...
		   <a href="#" 
		     ...
		     onclick="javascript:if(document.adminMenu.boxchecked.value==0)
...

				   {
					 ...
					 chemin='gestion_finance_algeria.php?modifier='+chemin;
...
<table width="100%" align="center" cellspacing="1"  class="adminlist" style="margin-top:2px">
  ...
  <th width="20">&nbsp;</th>
    ...
    <?php
	 ...
	 $sum="select sum(somme) as somme from  tbl_finance_paiement_algeria where code_inscription='$ci' ";                                   
 ...
 <td><input type="radio" name="id" value="<?=$ci?>" onclick="document.adminMenu.boxchecked.value='<?=$ci?>'" /></td>
      <td align="left">&nbsp;<a href="gestion_finance_algeria.php?detail=<?=$ci;?>" >
        <?=$name?>
      </a></td>
