...
$query = "SELECT MAX(recu) as statut FROM tbl_finance_paiement_algeria  ";
...
$row = mysql_fetch_assoc($result);
 $valeurmax = $row["statut"]+1;
	...
	//insert in tbl_finance_paiement
	 $sql = "INSERT INTO tbl_finance_paiement_algeria(`code_inscription` ,`prefixe` ,`designation` ,`annee` ,`type_paiement` ,`date_paiement` ,
	...
	@mysql_query($sql) or die (mysql_error());*/
			...
			//-->
              ...
              <?php
				  ...
				  $sql = "SELECT nom, prenom,prefixe FROM tbl_etudiant_algeria WHERE code_inscription = '$code_inscription' ";
...
<table border="0" width="100%" cellpadding="0" cellspacing="0" align="center" class="haut_table">
	...
	<td width="22%">
	  <table border="0" align="right" width="0%" cellpadding="10" cellspacing="4" id="link" >
	    <tr>
		  ...
		  <td valign="top" align="center">
		   <a href="gestion_finance_algeria.php?detail=<?php echo $code_inscription ?>&prefixe=<?=$prefixe?>" ><div class="cancel"></div>Cancel</a>
		  </td>
		</tr>
	  </table>
	</td> 
 ...
 <form method="post" action="gestion_finance_algeria.php?new_paiement=oui" name="f_ajout" >
