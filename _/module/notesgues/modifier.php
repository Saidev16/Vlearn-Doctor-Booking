...
$some_coef=0;
 ...
 if(isset($_POST['transfer']) and $_POST['transfer']=='transfer'){
  ...
  // fin du calcule de la note finale	
			...
			<!--	
				window.location.replace("gestion_notes_gues.php?code_inscription=<?=$code_inscription?>");
			//-->
			</script>
              <?php
			  }
			  ...
			  from tbl_note_GUES as n, $tbl_cours as c, $tbl_session as s 
...
<table border="0" width="100%" cellpadding="0" cellspacing="0" align="center" class="haut_table">
	...
	<td width="22%">
	  <table border="0" align="right" width="0%" cellpadding="10" cellspacing="4" id="link" >
	    <tr>
 		  ...
 		  <td valign="top" align="center">
		   <a href="gestion_notes_gues.php?code_inscription=<?=$code_inscription?>">
 ...
 <form method="post"  action="gestion_notes_gues.php?modifier=oui" name="f_ajout">
