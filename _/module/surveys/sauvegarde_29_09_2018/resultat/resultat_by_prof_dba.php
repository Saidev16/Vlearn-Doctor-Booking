...
<div class="row">
  <?php if (isset($_GET['resultat_by_prof_dba']) && isset($_GET['id'])): ?>
    ...
    <?php if (isset($_GET['annee']) && isset($_GET['periode'])) { ?>
      ...
      <div class="row">
        <a href="http://sis.aulm.us/administrator/Surveys.php?resultat_excel_dba&annee=<?php echo $annee; ?>&periode=<?php echo $periode; ?>&id=2&name=<?php echo "Overall_Satisfaction_of_Students_for_session_".$periode."_".$annee; ?>" class="btn btn-success" >Export Overall Satisfaction of Students</a>
