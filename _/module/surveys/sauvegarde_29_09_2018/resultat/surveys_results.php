			...
			<div class=" col-sm-offset-2 col-md-8">
				...
				<div style="text-align:left;" class="panel-group" id="accordion-test">
					<div class="panel panel-default">
						...
						<?php
							//Q9
							$sql_new = "SELECT count(distinct(r.code_etudiant)) as nb ,`id_question`,r.code_etudiant, r.`id_affectation` , r.`id_reponse` , rep.`porcentage` as porcentage FROM `tbl_sondage_affectation` as a , `tbl_resultat_sondage` as r , `tbl_reponse` as rep , `tbl_etudiant_deac` as e WHERE  a.`id` = r.`id_affectation` and r.`id_reponse` = rep.`id` and a.`id` = $id_affectation and r.`id_sondage` = $id_sondage  and a.`campus`= 'e-learning' and r.`code_etudiant` = e.`code_inscription`  and id_question = 9 group by rep.`porcentage`,`code_etudiant`,`id_question`";
							...
							// Q1-->Q8
							$sql_new = "SELECT count(distinct(r.code_etudiant)) as nb ,`id_question`,r.code_etudiant, r.`id_affectation` , r.`id_reponse` , rep.`porcentage` as porcentage FROM `tbl_sondage_affectation` as a , `tbl_resultat_sondage` as r , `tbl_reponse` as rep , `tbl_etudiant_deac` as e WHERE  a.`id` = r.`id_affectation` and r.`id_reponse` = rep.`id` and a.`id` = $id_affectation and r.`id_sondage` = $id_sondage  and a.`campus`= 'e-learning' and r.`code_etudiant` = e.`code_inscription`  and id_question in (1,2,3,4,5,6,7,8) group by rep.`porcentage`,`code_etudiant`,`id_question`";
							$req_new = @mysql_query($sql_new);
							$porcentage2 = 0;
							$satisfaction = 0;
							$nbQ = 0;
							...
							//Q10
							$sql_new = "SELECT count(distinct(r.code_etudiant)) as nb ,`id_question`,r.code_etudiant, r.`id_affectation` , r.`id_reponse` , rep.`porcentage` as porcentage FROM `tbl_sondage_affectation` as a , `tbl_resultat_sondage` as r , `tbl_reponse` as rep , `tbl_etudiant_deac` as e WHERE  a.`id` = r.`id_affectation` and r.`id_reponse` = rep.`id` and a.`id` = $id_affectation and r.`id_sondage` = $id_sondage  and a.`campus`= 'e-learning' and r.`code_etudiant` = e.`code_inscription`  and id_question = 10 group by rep.`porcentage`,`code_etudiant`,`id_question`";
							$req_new = @mysql_query($sql_new);
							$porcentage3 = 0;
							$satisfaction = 0;
							$nbQ = 0;
							...
							//Q12
							$sql_new = "SELECT count(distinct(r.code_etudiant)) as nb ,`id_question`,r.code_etudiant, r.`id_affectation` , r.`id_reponse` , rep.`porcentage` as porcentage FROM `tbl_sondage_affectation` as a , `tbl_resultat_sondage` as r , `tbl_reponse` as rep , `tbl_etudiant_deac` as e WHERE  a.`id` = r.`id_affectation` and r.`id_reponse` = rep.`id` and a.`id` = $id_affectation and r.`id_sondage` = $id_sondage  and a.`campus`= 'e-learning' and r.`code_etudiant` = e.`code_inscription`  and id_question = 12 group by rep.`porcentage`,`code_etudiant`,`id_question`";
							$req_new = @mysql_query($sql_new);
							$porcentage4 = 0;
							$satisfaction = 0;
							$nbQ = 0;
							...
							//Q11
							$sql_new = "SELECT count(distinct(r.code_etudiant)) as nb ,`id_question`,r.code_etudiant, r.`id_affectation` , r.`id_reponse` , rep.`porcentage` as porcentage FROM `tbl_sondage_affectation` as a , `tbl_resultat_sondage` as r , `tbl_reponse` as rep , `tbl_etudiant_deac` as e WHERE  a.`id` = r.`id_affectation` and r.`id_reponse` = rep.`id` and a.`id` = $id_affectation and r.`id_sondage` = $id_sondage  and a.`campus`= 'e-learning' and r.`code_etudiant` = e.`code_inscription`  and id_question = 11 group by rep.`porcentage`,`code_etudiant`,`id_question`";
							$req_new = @mysql_query($sql_new);
							$porcentage5 = 0;
							$satisfaction = 0;
							$nbQ = 0;
			...
			<div class=" col-sm-offset-2 col-md-8">
	        	...
	        	while ($row_prof_affectation = mysql_fetch_array($req_prof_affectation)){
	        		...
	        		while ($row_cour_affectation = mysql_fetch_array($req_cour_affectation)){
						...
						$porcentage3 = $porcentage3 + ($satisfaction/$nbQ);
						//Q12
						$sql_new = "SELECT count(distinct(r.code_etudiant)) as nb ,`id_question`,r.code_etudiant, r.`id_affectation` , r.`id_reponse` , rep.`porcentage` as porcentage FROM `tbl_sondage_affectation` as a , `tbl_resultat_sondage` as r , `tbl_etudiant_deac` as e, `tbl_reponse` as rep WHERE  a.`id` = r.`id_affectation` and r.`id_reponse` = rep.`id` and a.`id` = $id_affectation and r.`code_etudiant` = e.`code_inscription` and id_question = 12 group by rep.`porcentage`,`code_etudiant`,`id_question`";
						$req_new = @mysql_query($sql_new);
						$satisfaction = 0;
						$nbQ = 0;
						while ($row_new = mysql_fetch_array($req_new)) {
						...
						<div class="panel panel-default">
							<div class="panel-heading">
								<h4 class="panel-title text-info">
									...
									<p class="p" style="display: none;"><?php echo $nom_prof ?> <span class="badge badge-success" style="float: right;"><?php echo $nb_cours; if ($nb_cours == 1) {echo "  Course";}else{echo "  Courses";} ?> </span></p>
								</h4>
							</div>
						</div>
					</div>
						...
						<div class="panel-body with-table">
									<table class="table table-bordered table-responsive">
										...
										<tbody>
											...
											<tr>
												<?php $ttl_ovrall = ($ttl_pr1+$ttl_pr2+$ttl_pr3+$ttl_pr4+$ttl_pr5)/5; ?>
												<td style="text-align: left;"> Overall </td>
												<td>
