<table border="0" width="100%" cellpadding="0" cellspacing="0" align="center" class="haut_table" height="81" >
  <tr>
    ...
    <td width="78%" class="titre">&nbsp; DBA SURVEYS
...
<div class="row">
  <?php if (isset($_GET['surveys_results_dba']) && isset($_GET['id'])): ?>
    ...
    <?php if (isset($_GET['code_prof']) && isset($_GET['annee']) && isset($_GET['periode'])){ ?>
      ...
      $sql_cour_affectation= "SELECT a.* FROM `tbl_sondage_affectation` as a , `tbl_aff_etudiant` as e , `tbl_etudiant_deac` as et  WHERE a.`groupe` = 3 and a.`niveau` = \"dba\" and a.`code_prof` = $code_prof  and a.`annee` = \"$annee_per\" and a.`periode` = \"$periode\" AND a.`archive` = 0 and a.`id` = e.`id_affectation` and a.`type` = 1 and e.`code_inscription` = et.`code_inscription`";
      ...
      $sql_nb_etudiant_r = "SELECT count(distinct r.`code_etudiant`) FROM `tbl_sondage_affectation` as a ,`tbl_resultat_sondage` as r , `tbl_aff_etudiant` as e , `tbl_etudiant_deac` as et  WHERE a.`annee` = \"$annee_per\" and a.`periode` = \"$periode\" and a.`id` = r.`id_affectation` and a.`id` = e.`id_affectation` and a.`type` = 1 and e.`code_inscription` = et.`code_inscription`";
      ...
      <div class="row">
        <div class=" col-sm-offset-2 col-md-8">
          ...
          while ($row_cour_affectation = mysql_fetch_array($req_cour_affectation)){
            ...
            $sql_nb_etudiant = "SELECT  COUNT( Distinct `code_etudiant`) FROM `tbl_resultat_sondage` as r , `tbl_aff_etudiant` as e , `tbl_etudiant_deac` as et  WHERE   r.`id_affectation` = \"$id_affectation\" AND r.`id_sondage` = \"$id_sondage\" and e.`code_inscription` = et.`code_inscription`";
              ...
              <div class="panel panel-default">
                <div class="panel-heading">
                  <h4 class="panel-title text-info">
                    <a style="font-size: 12px;" class="collapsed" href="?surveys_results_dba&id=<?php echo $id_sondage; ?>&affectation=<?php echo $id_affectation; ?>">
                      <?php echo $code_cour." : "; ?>
                    ...
                    $nb_q_ver = 0;
                    $sql_resultat = "SELECT Distinct `code_etudiant` FROM `tbl_resultat_sondage` as r , `tbl_aff_etudiant` as e , `tbl_etudiant_deac` as et  WHERE   r.`id_affectation` = \"$id_affectation\" AND r.`id_sondage` = \"$id_sondage\" and e.`code_inscription` = et.`code_inscription`";
                    ...
                    $satisfaction = 0;
                    $porcentage1 = 0;
                    $sql_new = "SELECT count(distinct(r.code_etudiant)) as nb ,`id_question`,r.code_etudiant, r.`id_affectation` , r.`id_reponse` , rep.`porcentage` as porcentage FROM `tbl_sondage_affectation` as a , `tbl_resultat_sondage` as r , `tbl_reponse` as rep , `tbl_aff_etudiant` as e , `tbl_etudiant_deac` as et  WHERE  a.`id` = r.`id_affectation` and r.`id_reponse` = rep.`id` and a.`id` = $id_affectation and e.`code_inscription` = et.`code_inscription` and r.id_question = 9 group by rep.`porcentage`,`code_etudiant`,`id_question`";
                    //var_dump($sql_new);
                    $req_new = @mysql_query($sql_new);
                    while ($row_new = mysql_fetch_array($req_new)) {
                    ...
                    // calcule
                    // $sql_new = "SELECT count(distinct(r.code_etudiant)) as nb ,r.code_etudiant,r.`id_question`, r.`id_affectation` , r.`id_reponse` , rep.`porcentage` as porcentage FROM `tbl_sondage_affectation` as a , `tbl_resultat_sondage` as r , `tbl_reponse` as rep , `tbl_aff_etudiant` as e , `tbl_etudiant_deac` as et  WHERE  a.`id` = r.`id_affectation` and r.`id_reponse` = rep.`id` and a.`id` = $id_affectation and e.`code_inscription` = et.`code_inscription` and r.id_question in (1,2,3,4,5,6,7,8) group by rep.`porcentage` , r.`id_question`, r.`code_etudiant` order by `id_question`
                    // 	";
                    //var_dump($sql_new);
                    $req_new = @mysql_query($sql_new);
                    $satisfaction = 0;
                    ...
                    <div class="col-md-2" style="width:89px; float: left;text-align: right;"><?php echo round($pr_unsatisfied)." %"; ?></div>
                    <div class="col-md-10" style="width:300px; float:left;">
                    <div class="progress progress-striped active"	style="width: 270px;position: absolute;">	<img src="../../../css/stu-prof/<?php
                  ...
                  <?php }elseif (isset($_GET['affectation'])){ ?>
                    ...
                    $sql_etudiant_inscrit = "SELECT count(distinct code_etudiant) FROM `tbl_resultat_sondage` as r , `tbl_aff_etudiant` as e , `tbl_etudiant_deac` as et   WHERE r.`id_affectation` = $id_affectation and r.`id_affectation` = e.`id_affectation` and e.`code_inscription` = et.`code_inscription`";
                    ...
                    while ($row_question = mysql_fetch_array($req_question)) {
                      ...
                      $sql_question_existe= "SELECT count(*) FROM `tbl_resultat_sondage` as r , `tbl_aff_etudiant` as e , `tbl_etudiant_deac` as et  WHERE r.`id_affectation` = $id_affectation AND `id_sondage` = $id_sondage AND
                      ...
                      if ($nb_question != 0) { ?>
                        ...
                        <?php if ($groupe == 2): ?>
                        <?php echo $row_question['question_fr']; ?>
                        <?php endif ?>
                        <?php if ($groupe == 3): ?>
                        ...
                        while ($row_reponse = mysql_fetch_array($req_reponse)) {  ?>
                          ...
                          <td>
                          <?php if ($groupe == 2): ?>
                          <?php echo $row_reponse['reponse_fr']; ?>
                          <?php endif ?>
                          <?php if ($groupe == 3): ?>
                          ...
                          $sql_nb_etudiants = "SELECT count(distinct r.`code_etudiant`) FROM `tbl_resultat_sondage` as r , `tbl_aff_etudiant` as e , `tbl_etudiant_deac` as et WHERE r.`id_affectation` = $id_affectation AND `id_sondage` = $id_sondage AND `id_question` = $id_question AND `id_reponse` = $id_reponse and r.`id_affectation` = e.`id_affectation` and e.`code_inscription` = et.`code_inscription`";
                    ...
                    <?php }elseif (isset($_GET['annee']) && isset($_GET['periode'])) { ?>
                      ...
                      $periode = $_GET['periode'];
                      $annee = $_GET['annee'];
                      $sql_prof_affectation= "SELECT DISTINCT a.`code_prof` FROM `tbl_sondage_affectation` as a ,`tbl_professeur` as p , `tbl_aff_etudiant` as e , `tbl_etudiant_deac` as et   WHERE a.`groupe` = 3 and a.`niveau` = \"dba\" and a.`annee` = $annee and `periode` = \"$periode\" AND a.`archive` = 0 and a.code_prof = p.code_prof and p.archive = 0 and a.`id` = e.`id_affectation` and a.`type` = 1 and e.`code_inscription` = et.`code_inscription` ";
                      ...
                      $req_nb_etudiant_r = @mysql_query($sql_nb_etudiant_r);
                      $row_nb_etudiant_r = mysql_fetch_array($req_nb_etudiant_r);
                      $sql_nb_etudiant_tt = "SELECT count(*) FROM `tbl_sondage_affectation` as a , `tbl_aff_etudiant` as e ,`tbl_professeur` as p , `tbl_etudiant_deac` as et  WHERE a.`niveau` = \"dba\" and a.`annee` = $annee and a.`periode` = \"$periode\"  and a.`id` = e.`id_affectation` and a.`groupe` = 3 and a.code_prof = p.code_prof and p.archive = 0 and a.`id` = e.`id_affectation` and a.`type` = 1 and e.`code_inscription` = et.`code_inscription`";
                      ...
                      while ($row_prof_affectation = mysql_fetch_array($req_prof_affectation)){
                        ...
                        $row_prof = mysql_fetch_assoc($req_prof);
                        $nom_prof = $row_prof['nom_prenom'];
                        $sql_nb_cour = "SELECT COUNT(*) FROM `tbl_sondage_affectation` as a , `tbl_aff_etudiant` as e , `tbl_etudiant_deac` as et WHERE a.`groupe` = 3 and  a.`niveau` = \"dba\" and a.`annee` = $annee and a.`periode` = \"$periode\" AND a.`archive` = 0 AND a.`code_prof` = \"$code_prof\"and a.`id` = e.`id_affectation` and a.`type` = 1 and e.`code_inscription` = et.`code_inscription`";
                        ...
                        <div class="panel-heading">
                        <h4 class="panel-title text-info">
                        <a class="collapsed" href="?surveys_results_dba&id=<?php echo $id_sondage; ?>&
                        code_prof=<?php echo $code_prof; ?>&periode=<?php echo $periode; ?>&annee=<?php echo $annee; ?>">
                        <?php echo $nom_prof ?> <span class="badge badge-success" style="float: right;"><?php echo $nb_cours; if ($nb_cours == 1) {echo "  course";}else{echo "  courses";} ?> <i class="entypo-plus-circled"></i></span>
                        </a>
                        <p class="p" style="display: none;"><?php echo $nom_prof ?> <span class="badge badge-success" style="float: right;"><?php echo $nb_cours; if ($nb_cours == 1) {echo "  course";}else{echo "  courses";} ?> </p>
                      ...
                      <?php }else{ ?>
                        ...
                        $sql_periode= "SELECT  `annee` , `periode` FROM  `tbl_sondage_affectation` WHERE `groupe` = 3 and `niveau` =  \"dba\" and `archive` = 0 and `type` = 1 GROUP BY  `annee` ,  `periode` order by `annee` DESC, `periode` ASC";
                        ...
                        while ($row_periode = mysql_fetch_array($req_periode)) {
                          ...
                          if ($overall != 0) {
                            ...
                            <a href="Surveys.php?surveys_results_dba&annee=<?php echo $annee; ?>&periode=<?php echo $periode; ?>&id=<?php echo $id_sondage; ?>" class="btn btn-success" style="float: right;">
                            Surveys by Faculty <i class="entypo-check"></i>
                            </a>
                            <a href="Surveys.php?resultat_by_prof_dba&annee=<?php echo $annee; ?>&periode=<?php echo $periode; ?>&id=<?php echo $id_sondage; ?>"  style="color: #fff;" class="btn btn-success btn-xs">Export to excel</a>
                            </th>
                            </tr>
