...
$archive = $_POST['archive'];
					...
					// update table etudiant
                         ...
                         $sql="UPDATE tbl_etudiant_burkina SET `code_inscription`='$ci',
 						`nom` = '$nom',
						`prenom` = '$prenom',
             ...
             @mysql_query($sql) or die ("erreur lors de la mise à jour dans la table etudiant1");
			...
			<!--
				window.location.replace('gestion_des_etudiants_burkina.php');
			//-->
			</script>
              ...
              <?php
					  ...
					  $sql="UPDATE tbl_etudiant_burkina SET  
 						`nom` = '$nom',
						`prenom` = '$prenom',
						`date_naissance` = '$date_naissance',
						`nationalite` = '$nationalite',
...
//die($sql);
         @mysql_query($sql)or die ("erreur lors de la mise à jour de cet étudiant2");
          ...
          $sql2="UPDATE tbl_etudiant_all SET  
						...
						`parentemail` = '$parentemail'
						 ...
						 WHERE `code_inscription` ='$code_inscription' and prefixe='BF' limit 1 "; 
//die($sql);
         @mysql_query($sql2)or die ("erreur lors de la mise à jour de cet étudiant3");
...
<?php  if ($type !='Prospect') { ?>
		...
		-->
 <script type="text/javascript" language="JavaScript1.2">
          window.location.replace('/module/api_testing/edit_user.php?code_inscription=<?php echo $code_inscription; ?>&prefixe=BF');
 			</script>
			  ...
			  $sql2="select * from tbl_etudiant_burkina  
			  where code_inscription='$code_inscription' limit 1 ";
...
<table border="0" width="100%" cellpadding="0" cellspacing="0" align="center" class="haut_table">
 ...
 <form method="post" action="gestion_des_etudiants_burkina.php?modifier=Yes" name="f_ajout" >
