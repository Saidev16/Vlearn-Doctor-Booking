<?php
	...
	/* $sql = "SELECT distinct e.code_inscription, concat(e.nom, ' ' ,e.prenom) as name, 
			 ...
			 FROM $tbl_etudiant_bennouna as e, $tbl_filiere as f, $tbl_groupe as g 
...
$sql = "SELECT distinct e.code_inscription, concat(e.nom, ' ' ,e.prenom) as name, 
			 ...
			 FROM tbl_etudiant_bennouna as e
			 where  e.archive = 1" 
...
<table border="0" width="100%" cellpadding="0" cellspacing="0" align="center" class="haut_table">
  <tr>
	...
	<td width="150">
	  <td align="right">
		 <a href="gestion_des_etudiants_bennouna.php"><div class="retour"></div>Back</a>
		 </td>
	 <!-- <table border="0" align="right" width="100%" cellpadding="10" cellspacing="4" id="link" >
	    <tr>
		 <td valign="top" align="center">
		   <a href="gestion_des_etudiants_bennouna.php?new=oui">
		  ...
		  <a href="#"
		     ...
		     onclick="javascript:if(document.adminMenu.boxchecked.value==0)
...

				   {
					 ...
					 chemin='gestion_des_etudiants_bennouna.php?modifier='+chemin;
		   ...
		   <a href="#"
		     ...
		     onclick="javascript:if(document.adminMenu.boxchecked.value==0)
...

				   {
					 ...
					 chemin='gestion_des_etudiants_bennouna.php?detail='+chemin;
     ...
     <!--   <td valign="top" align="center">
		     ...
		     onclick="javascript:if(document.adminMenu.boxchecked.value==0)
...

				   {
				     ...
				     chemin=document.adminMenu.boxchecked.value;
						 ...
						 chemin='gestion_des_etudiants_bennouna.php?buletinBachelor='+chemin;
		   ...
		   <a href="#"
		     onclick="javascript:if(document.adminMenu.boxchecked.value==0)
...

				   {
					 ...
					 chemin='gestion_des_etudiants_bennouna.php?buletinMaster='+chemin;
		  ...
		  <td valign="top" align="center" >
		  <a href="gestion_des_etudiants_bennouna.php?laureat" title="laureat">
		   ...
		   <a href="#"
		     onclick="javascript:if(document.adminMenu.boxchecked.value==0)
...

				   {
					 ...
					 chemin='gestion_des_etudiants_bennouna.php?supprimer='+chemin;
		   ...
		   <a href="#"
		     onclick="javascript:if(document.adminMenu.boxchecked.value==0)
				   ...
				   else
				   {
					 ...
					 chemin='gestion_des_etudiants_bennouna.php?archiver='+chemin;
          	  ...
          	  <td valign="top" align="center">
		   <a href="gestion_des_etudiants_bennouna.php?archive=oui"><div class="archive"></div>Archive</a>
		  </td>
 		  <td valign="top" align="center" >
  ...
  <tr align="center">
	...
	<!--	 <td>&nbsp;<?=html_entity_decode($ligne["title"])?></td>
		 ...
		 <td>&nbsp;<?=$ligne["date_inscription"]?></td>
		  <td>&nbsp;<?=$ligne["ville"]?></td>
		 <td align="center"> <a href="gestion_des_etudiants_bennouna.php?acces=<?=$ligne["acces"]==0 ? 1 : 0 ?>&user_id=<?=$ligne["code_inscription"]?>"><?=$ligne["acces"]=='0' ? $non : $oui ?></a></td>-->
	</tr>
		 <?php
		  }
		 ?>
