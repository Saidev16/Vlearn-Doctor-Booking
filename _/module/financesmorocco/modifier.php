...
<?php
	...
	if (isset($_POST['code_inscription'])){
		...
		$Registration=$_POST['Registration'];
	 	 ...
	 	 $sql="UPDATE tbl_finance_morocco SET	
		...
		@mysql_query($sql);
			...
			<!--	
					window.location.replace('gestion_finance_morocco.php');
			//-->
			</script>
              <?php
						}
				 ...
				 // $annee=$_SESSION['paiement_annee'];
				  ...
				  $code_inscription = $row['code_inscription'];		 $frais_etude = $row['frais_etude'];
...
<table border="0" width="100%" cellpadding="0" cellspacing="0" align="center" class="haut_table">
	...
	<td width="22%">
	  <table border="0" align="right" width="0%" cellpadding="10" cellspacing="4" id="link" >
	    <tr>
		  ...
		  <td valign="top" align="center">
		   <a href="gestion_finance_morocco.php" ><div class="cancel"></div>Cancel</a>
		  </td>
		</tr>
	  </table>
	</td> 
 ...
 <form method="post" action="gestion_finance_morocco.php?modifier=oui" name="f_ajout"  >
 <input  type="hidden" name="code_inscription" id="code_inscription" value="<?=$code_inscription?>" />
	 <table border="0" width="100%" cellpadding="0" cellspacing="0" align="center" >
       ...
       <tr>
         <td valign="top" width="100%">
           ...
           <tr>
		    ...
		    <tr>
             ...
             <tr>
			   <td class="gras"><label for="Registration">Registration Fee:</label> </td>
			   <td><input type="text" name="Registration" id="Registration" value="<?=$row['Registration']?>" class="input"/></td>
		  </tr>
		    <tr>
               <td colspan="2" height="2"></td>
            </tr>
		 ...
		 <tr>
			   <td class="gras"><label for="challenge"> Challenge Fees:</label> </td>
			   <td><input type="text" name="challenge" id="challenge" value="<?=$row['challenge']?>" class="input"/></td>
		  </tr>
