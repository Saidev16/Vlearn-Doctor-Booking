...
FROM tbl_finance_paiement_morocco as p, tbl_finance_morocco as f, tbl_etudiant_morocco as e, $tbl_admin as a
WHERE p.id='$id' 
...
$sql="SELECT * FROM $tbl_finance_deac WHERE code_inscription='$code_inscription' AND annee = '$annee'";
$req=mysql_query($sql);
	...
	<tr>
		...
		<br />
		  ...
		  <p align="right" style="font-size:8px;">
		  	*The dollar rate used is $1 = 10 MAD
		  </p>
		</td>
	</tr>
	<tr height="10">
