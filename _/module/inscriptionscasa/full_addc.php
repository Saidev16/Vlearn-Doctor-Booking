...
<?php
		...
		$sql = "SELECT COUNT(*) AS nbr FROM tbl_inscription_cours_burkina WHERE code_inscription='$code_inscription' 
...
<table border="0" width="100%" cellpadding="0" cellspacing="0" align="center" class="haut_table">
	...
	<td width="22%">
	  <table border="0" align="right" width="0%" cellpadding="10" cellspacing="4" id="link" >
	    <tr>
		  ...
		  <td valign="top" align="center">
		   <a href="gestion_inscription_burkina.php" ><div class="cancel"></div>Cancel</a>
		  </td>
		</tr>
	  </table>
	</td> 
 ...
 <form method="post" action="gestion_inscription_burkina.php?full_addc=oui" name="f_ajout">
