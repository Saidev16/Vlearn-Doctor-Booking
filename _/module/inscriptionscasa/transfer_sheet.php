    ...
    //if (isset($_GET['code_inscription']) && isset($_GET['prefixe']) && isset($_GET['u']) && $_GET['code_inscription'] != "" && $_GET['prefixe'] != "" && $_GET['u'] != "") {
        ...
        // if ($exist != "") {
          ...
          ">
            ...
            ';
              $sql5 = "SELECT c.code_cours, c.titre ,c.nbr_credit,c.grade,n.letter_grade FROM `tbl_note_burkina` as n , tbl_etudiant_burkina as e, tbl_cours as c WHERE
              ...
              ";
              $sql4 = "SELECT c.code_cours, c.titre ,c.nbr_credit,c.grade,n.letter_grade FROM `tbl_note_burkina` as n , tbl_etudiant_burkina as e, tbl_cours as c WHERE
