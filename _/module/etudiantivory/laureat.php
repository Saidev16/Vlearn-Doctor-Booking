<?php
	...
	/* $sql = "SELECT distinct e.code_inscription, concat(e.nom, ' ' ,e.prenom) as name, 
			 ...
			 FROM $tbl_etudiant_ivory as e, $tbl_filiere as f, $tbl_groupe as g 
  ...
  <tr>
	...
	<td width="150">
	 ...
	 <!-- <table border="0" align="right" width="100%" cellpadding="10" cellspacing="4" id="link" >
	    <tr>
		 <td valign="top" align="center">
		   <a href="gestion_des_etudiants_ivory.php?new=oui">
		  ...
		  <a href="#"
		     ...
		     onclick="javascript:if(document.adminMenu.boxchecked.value==0)
...

				   {
					 ...
					 chemin='gestion_des_etudiants_ivory.php?modifier='+chemin;
		   ...
		   <a href="#"
		     ...
		     onclick="javascript:if(document.adminMenu.boxchecked.value==0)
...

				   {
					 ...
					 chemin='gestion_des_etudiants_ivory.php?detail='+chemin;
     ...
     <!--   <td valign="top" align="center">
		     ...
		     onclick="javascript:if(document.adminMenu.boxchecked.value==0)
...

				   {
				     ...
				     chemin=document.adminMenu.boxchecked.value;
						 ...
						 chemin='gestion_des_etudiants_ivory.php?buletinBachelor='+chemin;
		   ...
		   <a href="#"
		     onclick="javascript:if(document.adminMenu.boxchecked.value==0)
...

				   {
					 ...
					 chemin='gestion_des_etudiants_ivory.php?buletinMaster='+chemin;
		  ...
		  <td valign="top" align="center" >
		  <a href="gestion_des_etudiants_ivory.php?laureat" title="laureat">
		   ...
		   <a href="#"
		     onclick="javascript:if(document.adminMenu.boxchecked.value==0)
...

				   {
					 ...
					 chemin='gestion_des_etudiants_ivory.php?supprimer='+chemin;
		   ...
		   <a href="#"
		     onclick="javascript:if(document.adminMenu.boxchecked.value==0)
				   ...
				   else
				   {
					 ...
					 chemin='gestion_des_etudiants_ivory.php?archiver='+chemin;
          	  ...
          	  <td valign="top" align="center">
		   <a href="gestion_des_etudiants_ivory.php?archive=oui"><div class="archive"></div>Archive</a>
		  </td>
 		  <td valign="top" align="center" >
  ...
  <tr align="center">
	...
	<!--	 <td>&nbsp;<?=html_entity_decode($ligne["title"])?></td>
		 ...
		 <td>&nbsp;<?=$ligne["date_inscription"]?></td>
		  <td>&nbsp;<?=$ligne["ville"]?></td>
		 <td align="center"> <a href="gestion_des_etudiants_ivory.php?acces=<?=$ligne["acces"]==0 ? 1 : 0 ?>&user_id=<?=$ligne["code_inscription"]?>"><?=$ligne["acces"]=='0' ? $non : $oui ?></a></td>-->
	</tr>
		 <?php
		  }
		 ?>
