...
$acceptance_date=$_POST['year_aa'].'-'.$_POST['month_aa'].'-'.$_POST['day_aa'];
$evaluation_date=$_POST['year_e'].'-'.$_POST['month_e'].'-'.$_POST['day_e'];
$projected_graduation_date=$_POST['year_p'].'-'.$_POST['month_p'].'-'.$_POST['day_p'];
...
$attestation_eng = addslashes($_POST['attestation_eng']);
					...
					// update table etudiant
                        ...
                        $sql="UPDATE tbl_etudiant_ivory SET `code_inscription`='$ci',
 						`nom` = '$nom',
						`prenom` = '$prenom',
						...
						projected_graduation_date= '$projected_graduation_date',
						evaluator = '$evaluator'
			...
			//-->
              ...
              <?php
					 ...
					 $sql="UPDATE tbl_etudiant_ivory SET  
 						`nom` = '$nom',
						`prenom` = '$prenom',
						`date_naissance` = '$date_naissance',
						`nationalite` = '$nationalite',
         ...
         @mysql_query($sql)or die ("erreur lors de la mise à jour de cet étudiant");
          ...
          $sql2="UPDATE tbl_etudiant_all SET  
						...
						evaluator = '$evaluator'
						 ...
						 WHERE `code_inscription` ='$code_inscription' and `prefixe` ='IC' limit 1 "; 
//die($sql);
         @mysql_query($sql2)or die ("erreur lors de la mise à jour de cet étudiant");
			...
			//-->
			  ...
			  $sql2="select * from tbl_etudiant_ivory  
			  where code_inscription='$code_inscription' limit 1 ";
			  ...
			  $row=mysql_fetch_assoc($req2);
			   ...
			   $date_inscription = htmlentities($row['date_inscription']);
			    $acceptance_date = htmlentities($row['acceptance_date']);
			   ...
			   $yaa = substr($acceptance_date, 0,4);
		       $maa = substr($acceptance_date, 5,2);
		       $daa = substr($acceptance_date, 8,2);
			   ...
			   $ye = substr($row['evaluation_date'], 0,4);
		       $me = substr($row['evaluation_date'], 5,2);
		       $de = substr($row['evaluation_date'], 8,2);
			   
			   $yp = substr($row['projected_graduation_date'], 0,4);
		       $mp = substr($row['projected_graduation_date'], 5,2);
		       $dp = substr($row['projected_graduation_date'], 8,2);
			   
			   $evaluator = htmlentities($row['evaluator']);
...
<table border="0" width="100%" cellpadding="0" cellspacing="0" align="center" class="haut_table">
 ...
 <form method="post" action="gestion_des_etudiants_ivory.php?modifier=Yes" name="f_ajout" >
       ...
       <tr>
         <td valign="top" width="100%">
		  ...
		  <tr>
			   ...
			   <td><input type="text" name="prenom" id="prenom" class="input" value="<?=$prenom?>" /></td>
			   <td></td>
		 ...
		 <tr><td colspan="4" height="3px"></td></tr>
          ...
          <tr>
			  <td><label for="aul">Regular Registration : </label></td>
			  <td>
				   <select name="aul" id="aul" class="combobox">
				        <option value="1" <?=($aul==1) ?  $selected : '' ?>>Yes</option>
			   	        <option value="0" <?=($aul==0) ?  $selected : '' ?>>No</option>
				   </select>
			   </td>
			   <td>
			   </td>
			     <td><label for="piimt">Transfer Registration :</label> </td>
		      <td>
				  <select name="piimt" id="copie_cin" class="combobox">
					   <option value="1" <?=($piimt==1) ? $selected : '' ?>>Yes</option>
					   <option value="0" <?=($piimt==0) ? $selected : '' ?>>No</option>
				  </select>
		     </td>
          ...
          <tr>
			  ...
			  <td>
				   <select name="english_bac" id="english_bac" class="combobox">
				        <option value="1" <?php echo $english_bac==1 ?  $selected : '' ?>>Yes</option>
			   	      <option value="0" <?php echo $english_bac==0 ?  $selected : '' ?>>No</option>
				   </select>
			   </td>
			    <td>
			   </td>
...
<option value="Ivory Coast" <?php echo $ville=='Ivory Coast'?$selected : ''?>>Ivory Coast</option>
...
<option value="Zimbabwe" <?php echo $ville=='Zimbabwe'?$selected : ''?>>Zimbabwe</option>
		 ...
		 <td><label for="trois_enveloppe">3 years High school transcripts: </label></td>
          ...
          <tr>
		  <td><label for="archive">Status :</label> </td>
			  <td>
					 <select name="archive" id="archive" class="input" style="width:200px">
					 <option value="0" <?=$archive=='0' ? $selected : ''?>>Actual</option>
						<option value="1" <?=$archive=='1' ? $selected : ''?>>Alumni</option>
						<!--<option value="2" <?=$archive=='2' ? $selected : ''?>>Withdrawal</option>
						<option value="3" <?=$archive=='3' ? $selected : ''?>>archive</option>-->

					</select>
			  </td>
			   <td></td>
			  <td><label for="year_aa">Acceptance Date :</label></td>
		   <td>
		   <select name="month_aa" class="input">
		   	  <option value="00" <?=($maa==0) ? $selected : '' ?>>MM</option>
					  <option value="01" <?=($maa==1) ? $selected : '' ?>>01</option>
					  <option value="02" <?=($maa==2) ? $selected : '' ?>>02</option>
					  <option value="03" <?=($maa==3) ? $selected : '' ?>>03</option>
					  <option value="04" <?=($maa==4) ? $selected : '' ?>>04</option>
					  <option value="05" <?=($maa==5) ? $selected : '' ?>>05</option>
					  <option value="06" <?=($maa==6) ? $selected : '' ?>>06</option>
					  <option value="07" <?=($maa==7) ? $selected : '' ?>>07</option>
					  <option value="08" <?=($maa==8) ? $selected : '' ?>>08</option>
					  <option value="09" <?=($maa==9) ? $selected : '' ?>>09</option>
					  <option value="10" <?=($maa==10) ? $selected : '' ?>>10</option>
					  <option value="11" <?=($maa==11) ? $selected : '' ?>>11</option>
					  <option value="12" <?=($maa==12) ? $selected : '' ?>>12</option>
				  </select>
			  &nbsp;
				  <select name="day_aa" class="input">
				  	  <option value="00" <?=($daa==0) ? $selected : '' ?>>DD</option>
					  <option value="01" <?=($daa==1) ? $selected : '' ?>>01</option>
					  <option value="02" <?=($daa==2) ? $selected : '' ?>>02</option>
					  <option value="03" <?=($daa==3) ? $selected : '' ?>>03</option>
					  <option value="04" <?=($daa==4) ? $selected : '' ?>>04</option>
					  <option value="05" <?=($daa==5) ? $selected : '' ?>>05</option>
					  <option value="06" <?=($daa==6) ? $selected : '' ?>>06</option>
					  <option value="07" <?=($daa==7) ? $selected : '' ?>>07</option>
					  <option value="08" <?=($daa==8) ? $selected : '' ?>>08</option>
					  <option value="09" <?=($daa==9) ? $selected : '' ?>>09</option>
					  <option value="10" <?=($daa==10) ? $selected : '' ?>>10</option>
					  <option value="11" <?=($daa==11) ? $selected : '' ?>>11</option>
					  <option value="12" <?=($daa==12) ? $selected : '' ?>>12</option>
					  <option value="13" <?=($daa==13) ? $selected : '' ?>>13</option>
					  <option value="14" <?=($daa==14) ? $selected : '' ?>>14</option>
					  <option value="15" <?=($daa==15) ? $selected : '' ?>>15</option>
					  <option value="16" <?=($daa==16) ? $selected : '' ?>>16</option>
					  <option value="17" <?=($daa==17) ? $selected : '' ?>>17</option>
					  <option value="18" <?=($daa==18) ? $selected : '' ?>>18</option>
					  <option value="19" <?=($daa==19) ? $selected : '' ?>>19</option>
					  <option value="20" <?=($daa==20) ? $selected : '' ?>>20</option>
					  <option value="21" <?=($daa==21) ? $selected : '' ?>>21</option>
					  <option value="22" <?=($daa==22) ? $selected : '' ?>>22</option>
					  <option value="23" <?=($daa==23) ? $selected : '' ?>>23</option>
					  <option value="24" <?=($daa==24) ? $selected : '' ?>>24</option>
					  <option value="25" <?=($daa==25) ? $selected : '' ?>>25</option>
					  <option value="26" <?=($daa==26) ? $selected : '' ?>>26</option>
					  <option value="27" <?=($daa==27) ? $selected : '' ?>>27</option>
					  <option value="28" <?=($daa==28) ? $selected : '' ?>>28</option>
					  <option value="29" <?=($daa==29) ? $selected : '' ?>>29</option>
					  <option value="30" <?=($daa==30) ? $selected : '' ?>>30</option>
					  <option value="31" <?=($daa==31) ? $selected : '' ?> >31</option>
				</select>
					  &nbsp;
		   <select name="year_aa" id="year_aa" class="input">
		   	 <option value="0000">YY</option>
		  <?php for ($aa=date('Y'); $aa>2005; $aa--){?>
		  <option value="<?=$aa?>" <?=($yaa==$aa) ? $selected : '' ?>><?=$aa?></option>
		  <?php
		  }
		  ?>
		  </select>
	 ...
	 &nbsp;
		<!-- <select name="day_g" class="input">
		  ...
		  &nbsp;</select>
			 ...
			 <td></td>
			  <td><label for="year_e">Evaluation Date :</label></td>
		   <td>
		   <select name="month_e" class="input">
		   	  <option value="00" <?=($me==0) ? $selected : '' ?>>MM</option>
					  <option value="01" <?=($me==1) ? $selected : '' ?>>01</option>
					  <option value="02" <?=($me==2) ? $selected : '' ?>>02</option>
					  <option value="03" <?=($me==3) ? $selected : '' ?>>03</option>
					  <option value="04" <?=($me==4) ? $selected : '' ?>>04</option>
					  <option value="05" <?=($me==5) ? $selected : '' ?>>05</option>
					  <option value="06" <?=($me==6) ? $selected : '' ?>>06</option>
					  <option value="07" <?=($me==7) ? $selected : '' ?>>07</option>
					  <option value="08" <?=($me==8) ? $selected : '' ?>>08</option>
					  <option value="09" <?=($me==9) ? $selected : '' ?>>09</option>
					  <option value="10" <?=($me==10) ? $selected : '' ?>>10</option>
					  <option value="11" <?=($me==11) ? $selected : '' ?>>11</option>
					  <option value="12" <?=($me==12) ? $selected : '' ?>>12</option>
				  </select>
			  &nbsp;
				 <select name="day_e" class="input">
				 	 <option value="00" <?=($de==0) ? $selected : '' ?>>DD</option>
					  <option value="01" <?=($de==1) ? $selected : '' ?>>01</option>
					  <option value="02" <?=($de==2) ? $selected : '' ?>>02</option>
					  <option value="03" <?=($de==3) ? $selected : '' ?>>03</option>
					  <option value="04" <?=($de==4) ? $selected : '' ?>>04</option>
					  <option value="05" <?=($de==5) ? $selected : '' ?>>05</option>
					  <option value="06" <?=($de==6) ? $selected : '' ?>>06</option>
					  <option value="07" <?=($de==7) ? $selected : '' ?>>07</option>
					  <option value="08" <?=($de==8) ? $selected : '' ?>>08</option>
					  <option value="09" <?=($de==9) ? $selected : '' ?>>09</option>
					  <option value="10" <?=($de==10) ? $selected : '' ?>>10</option>
					  <option value="11" <?=($de==11) ? $selected : '' ?>>11</option>
					  <option value="12" <?=($de==12) ? $selected : '' ?>>12</option>
					  <option value="13" <?=($de==13) ? $selected : '' ?>>13</option>
					  <option value="14" <?=($de==14) ? $selected : '' ?>>14</option>
					  <option value="15" <?=($de==15) ? $selected : '' ?>>15</option>
					  <option value="16" <?=($de==16) ? $selected : '' ?>>16</option>
					  <option value="17" <?=($de==17) ? $selected : '' ?>>17</option>
					  <option value="18" <?=($de==18) ? $selected : '' ?>>18</option>
					  <option value="19" <?=($de==19) ? $selected : '' ?>>19</option>
					  <option value="20" <?=($de==20) ? $selected : '' ?>>20</option>
					  <option value="21" <?=($de==21) ? $selected : '' ?>>21</option>
					  <option value="22" <?=($de==22) ? $selected : '' ?>>22</option>
					  <option value="23" <?=($de==23) ? $selected : '' ?>>23</option>
					  <option value="24" <?=($de==24) ? $selected : '' ?>>24</option>
					  <option value="25" <?=($de==25) ? $selected : '' ?>>25</option>
					  <option value="26" <?=($de==26) ? $selected : '' ?>>26</option>
					  <option value="27" <?=($de==27) ? $selected : '' ?>>27</option>
					  <option value="28" <?=($de==28) ? $selected : '' ?>>28</option>
					  <option value="29" <?=($de==29) ? $selected : '' ?>>29</option>
					  <option value="30" <?=($de==30) ? $selected : '' ?>>30</option>
					  <option value="31" <?=($de==31) ? $selected : '' ?> >31</option>
				</select>
					  &nbsp;
		   <select name="year_e" id="year_e" class="input">
		   	 <option value="0000">YY</option>
		  <?php for ($e=date('Y'); $e>2005; $e--){?>
		  <option value="<?=$e?>" <?=($ye==$e) ? $selected : '' ?>><?=$e?></option>
		  <?php
		  }
		  ?>
		  </select>
		  ...
		  <tr>
		   ...
		   <td><input type="text" name="evaluator" id="evaluator" class="input"  value="<?=$evaluator?>"  onchange="onAddVerifyCin()" onkeyup="onAddVerifyCin()"/></td>
		   <td>
			   </td>
			   <td><label for="year_p">Projected Graduation Date :</label></td>
		   <td>
		   <select name="month_p" class="input">
		   	 <option value="00" <?=($mp==0) ? $selected : '' ?>>MM</option>
					  <option value="01" <?=($mp==1) ? $selected : '' ?>>01</option>
					  <option value="02" <?=($mp==2) ? $selected : '' ?>>02</option>
					  <option value="03" <?=($mp==3) ? $selected : '' ?>>03</option>
					  <option value="04" <?=($mp==4) ? $selected : '' ?>>04</option>
					  <option value="05" <?=($mp==5) ? $selected : '' ?>>05</option>
					  <option value="06" <?=($mp==6) ? $selected : '' ?>>06</option>
					  <option value="07" <?=($mp==7) ? $selected : '' ?>>07</option>
					  <option value="08" <?=($mp==8) ? $selected : '' ?>>08</option>
					  <option value="09" <?=($mp==9) ? $selected : '' ?>>09</option>
					  <option value="10" <?=($mp==10) ? $selected : '' ?>>10</option>
					  <option value="11" <?=($mp==11) ? $selected : '' ?>>11</option>
					  <option value="12" <?=($mp==12) ? $selected : '' ?>>12</option>
				  </select>
			  &nbsp;
				  <select name="day_p" class="input">
				  	  <option value="00" <?=($dp==0) ? $selected : '' ?>>DD</option>
					  <option value="01" <?=($dp==1) ? $selected : '' ?>>01</option>
					  <option value="02" <?=($dp==2) ? $selected : '' ?>>02</option>
					  <option value="03" <?=($dp==3) ? $selected : '' ?>>03</option>
					  <option value="04" <?=($dp==4) ? $selected : '' ?>>04</option>
					  <option value="05" <?=($dp==5) ? $selected : '' ?>>05</option>
					  <option value="06" <?=($dp==6) ? $selected : '' ?>>06</option>
					  <option value="07" <?=($dp==7) ? $selected : '' ?>>07</option>
					  <option value="08" <?=($dp==8) ? $selected : '' ?>>08</option>
					  <option value="09" <?=($dp==9) ? $selected : '' ?>>09</option>
					  <option value="10" <?=($dp==10) ? $selected : '' ?>>10</option>
					  <option value="11" <?=($dp==11) ? $selected : '' ?>>11</option>
					  <option value="12" <?=($dp==12) ? $selected : '' ?>>12</option>
					  <option value="13" <?=($dp==13) ? $selected : '' ?>>13</option>
					  <option value="14" <?=($dp==14) ? $selected : '' ?>>14</option>
					  <option value="15" <?=($dp==15) ? $selected : '' ?>>15</option>
					  <option value="16" <?=($dp==16) ? $selected : '' ?>>16</option>
					  <option value="17" <?=($dp==17) ? $selected : '' ?>>17</option>
					  <option value="18" <?=($dp==18) ? $selected : '' ?>>18</option>
					  <option value="19" <?=($dp==19) ? $selected : '' ?>>19</option>
					  <option value="20" <?=($dp==20) ? $selected : '' ?>>20</option>
					  <option value="21" <?=($dp==21) ? $selected : '' ?>>21</option>
					  <option value="22" <?=($dp==22) ? $selected : '' ?>>22</option>
					  <option value="23" <?=($dp==23) ? $selected : '' ?>>23</option>
					  <option value="24" <?=($dp==24) ? $selected : '' ?>>24</option>
					  <option value="25" <?=($dp==25) ? $selected : '' ?>>25</option>
					  <option value="26" <?=($dp==26) ? $selected : '' ?>>26</option>
					  <option value="27" <?=($dp==27) ? $selected : '' ?>>27</option>
					  <option value="28" <?=($dp==28) ? $selected : '' ?>>28</option>
					  <option value="29" <?=($dp==29) ? $selected : '' ?>>29</option>
					  <option value="30" <?=($dp==30) ? $selected : '' ?>>30</option>
					  <option value="31" <?=($dp==31) ? $selected : '' ?> >31</option>
				</select>
					  &nbsp;
		   <select name="year_p" id="year_p" class="input">
		   	 <option value="0000">YY</option>
		  <?php for ($p=date('Y'); $p>2005; $p--){?>
		  <option value="<?=$p?>" <?=($yp==$p) ? $selected : '' ?>><?=$p?></option>
		  <?php
		  }
		  ?>
		  </select>
