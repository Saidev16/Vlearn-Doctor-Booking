	...
	<td width="90">
	  <table border="0" align="right" width="100%" cellpadding="10" cellspacing="4" id="link" >
		...
		<!--<td valign="top" align="center" >
		  <a href="http://his.americanhigh.us/module/etudiantburkina/printb.php?printb=<?=$code_inscription?>" target="_blank"  title="Imprimer"> 
		  <div class="imprimer"></div>Print</a>
		  </td>-->
		  <td valign="top" align="center" >
		  <a href="http://his.americanhigh.us/module/etudiantburkina/printO.php?printO=<?=$code_inscription?>" target="_blank"  title="Imprimer"> 
...
<table width="1000"  cellpadding="0" cellspacing="0" border="0" style="border:1px solid black;" align="center" class="buletin_data" >
     ...
     <td colspan="20" align="left" valign="middle" height="30" class="gras" style="border: 1px  solid;">
       <b> &nbsp;First Name:</b><br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo ucfirst(strtolower($nom));
       //$prenom;?>  </td>
	    <td colspan="20" align="left" valign="middle" height="30" class="gras" style="border: 1px solid;">
...
?> </td>
      ...
      <td height="50" width=50 colspan="15" align="left" valign="middle" style="border: 1px solid;">
       ...
       <tr>
      <td colspan="40" align="left" valign="middle" height="30" style="border: 1px solid;">&nbsp;<b>Last Name:</b><br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo ucfirst(strtolower($prenom));//$nom;?> 
