...
$some_coef=0;
 ...
 if (round($final_grade) <= 59 && $final_grade>= 0){
 $letter_grade= 'F';
 $GPA=0;
 }
...
<table border="0" width="100%" cellpadding="0" cellspacing="0" align="center" class="haut_table">
 ...
 <form method="post"  action="gestion_notes.php?modifier1=oui" name="f_ajout">
    ...
    <input type="hidden" name="idSession" value="<?=$row['idSession']?>" />
		...
		<tr>
		  ...
		  <tr>
		  <td width="25%" class="gras"><label for="mid_term">Assignment(s):</label></td>
		  <td width="25%">
		  ...
		  <tr><td colspan="4" height="3px"></td></tr>
		   <tr>
		  <td class="gras"><label for="project">Project(s) :</label> </td>
