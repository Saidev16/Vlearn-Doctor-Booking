	...
	<td width="90">
	  <table border="0" align="right" width="100%" cellpadding="10" cellspacing="4" id="link" >
	    <tr>
		  ...
		  <a href="gestion_des_etudiants_all.php?modifier=<?=$code_inscription?>">
...
<tr>
  ...
  <tr>
    <td height="22"><span class="gras"> Pictures</span> :&nbsp;<?=($row['cinq_photo']==1) ? 'Yes' : 'No'?></td>
    <td><span class="gras">Previous High School Transcripts</span> :&nbsp;<?=($row['trois_enveloppe']==1) ? 'Yes' : 'No'?></td>
  </tr>
  <tr>
        <td colspan="2"height="2px"></td>
   </tr>
...
<tr>
 ...
 <tr>
    ...
    <td><span class="gras">Cohort</span> :&nbsp;<?php 
  if($row['cohort']=='Cohort1 August-December 2012') echo'Cohort1 August-December 2012';
  else if($row['cohort']=='Cohort2 January-June 2012') echo 'Cohort2 January-June 2012';
  else if($row['cohort']=='Cohort1 August-December 2013') echo 'Cohort1 August-December 2013';
  else if($row['cohort']=='Cohort2 January-June 2013') echo 'Cohort2 January-June 2013';
  else if($row['cohort']=='Cohort1 August-December 2014') echo 'Cohort1 August-December 2014';
  else if($row['cohort']=='Cohort2 January-June 2014') echo 'Cohort1 January-June 2014';
    else if($row['cohort']=='Cohort1 August-December 2015') echo 'Cohort1 August-December 2015';
     else if($row['cohort']=='Cohort2 January-June 2015') echo 'Cohort2 January-June 2015';
      else if($row['cohort']=='Cohort1 August-December 2016') echo 'Cohort1 August-December 2016';
     else if($row['cohort']=='Cohort2 January-June 2016') echo 'Cohort2 January-June 2016';
      else if($row['cohort']=='Cohort1 August-December 2017') echo 'Cohort1 August-December 2017';
     else if($row['cohort']=='Cohort2 January-June 2017') echo 'Cohort2 January-June 2017';?>
   ...
   <tr>
	...
	<input type="hidden" name="login_etudiant" id="login_etudiant" value="<?=$row['login']?>" />
	 <input type="hidden" name="prefixe" id="prefixe" value="<?=$row['prefixe']?>" />
	...
	<input type="submit" value="Access Student Space" name="acces" 
