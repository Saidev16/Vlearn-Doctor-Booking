...
$lish_bac = $_POST['english_bac'];
$piimt = $_POST['piimt'];
$aul = $_POST['aul'];
$umt = $_POST['umt'];
$idSession = $_POST['idSession'];
$cohort = $_POST['cohort'];
$sqlzin="SELECT max(`code_inscription`) as max FROM tbl_etudiant_all";
...
`acces` , `groupe` , `activite` , `annee_inscription`, `niveau` , `ville` , `elearning`, `piimt`, `aul`, `umt`, `cohort`)
VALUES ('ASL','$code_inscription','$nom', '$prenom', '$date_naissance', '$nationalite', '$adresse', '$sexe', '$code_bac', '$serie_bac', '$date_insc', '$tel', '$mail', '$annee', '$semestre', '$filiere', '$lieu_naissance', '$cin', '$cinq_photo', '$original_bac', '$copie_bac', '$english_bac', '$trois_lettre', '$trois_enveloppe', '$buletin_note',  '$reglement', '$copie_cin', '$extrait', '$note_etudesoc', '$note_fr', '$note_sciences', '$note_math', '$aquise', '$nom', '$pass', 1, '$groupe', '$activite', '$annee_inscription', '$niveau', '$ville', '$elearning', '$piimt', '$aul', '$umt', '$cohort');"; 
	  @mysql_query($sql_insert)or die ("Error save studentPSI");
	  
	$sql14 = "SELECT code_inscription FROM tbl_etudiant_all
		      	WHERE `nom`='$nom'  and `prenom`='$prenom';";
		
		      	$req14 = @mysql_query($sql14) or die ('Erreur de verification inscription ');
		      	$row14 = mysql_fetch_assoc($req14);
		     	$code_inscription = $row14['code_inscription'];
...
<table border="0" width="100%" cellpadding="0" cellspacing="0" align="center" class="haut_table">
  ...
  <form method="post" action="gestion_des_etudiants_all.php?new=oui" name="f_ajout" >
	  <table border="0" width="100%" cellpadding="0" cellspacing="0" align="center">
       ...
       <tr>
         <td valign="top" width="100%"><table border="0" cellpadding="0" cellspacing="2" width="100%" class="cellule_table">
           ...
           <tr>
             <td><label for="cin">ID, Passport or Driver's License Number :</label>             </td>
		  ...
		  ?>
           ...
           <tr>
             <td><label for="lieu_naissance">Previous School: </label></td>
             <td><input type="text" name="lieu_naissance" id="lieu_naissance" class="input"/>             </td>
             <td></td>
             <td><label for="code_bac">Previous School Address  :</label>             </td>
...
<option value="Zimbabwe">Zimbabwe</option>
           ...
           <tr>
             ...
             <td></td>
             <td><label for="copie_cin">Notarized Copy of ID, Passport or Driver's License :</label>             </td>
           ...
           <tr>
             <td><label for="cinq_photo">Pictures :</label>             </td>
             <td><select name="cinq_photo" id="cinq_photo" class="combobox">
                 <option value="0" selected="selected">No</option>
                 <option value="1">Yes</option>
               </select>             </td>
             <td></td>
             <td><label for="trois_enveloppe">Previous High School Transcripts: </label></td>
...
<td></td>
             ...
             <td>
             <select name="cohort" id="cohort" class="input" style="width:200px">
              <option value="">Select Cohort</option>
               <option value="Cohort1 August-December 2012">Cohort1 August-December 2012</option>
                 <option value="Cohort2 January-June 2012">Cohort2 January-June 2012</option>
                  <option value="Cohort1 August-December 2013">Cohort1 August-December 2013</option>
                 <option value="Cohort2 January-June 2013">Cohort2 January-June 2013</option>
                  <option value="Cohort1 August-December 2014">Cohort1 August-December 2014</option>
                 <option value="Cohort2 January-June 2014">Cohort2 January-June 2014</option>
                 <option value="Cohort1 August-December 2015">Cohort1 August-December 2015</option>
                 <option value="Cohort2 January-June 2015">Cohort2 January-June 2015</option>
                  <option value="Cohort1 August-December 2016">Cohort1 August-December 2016</option>
                 <option value="Cohort2 January-June 2016">Cohort2 January-June 2016</option>
                  <option value="Cohort1 August-December 2017">Cohort1 August-December 2017</option>
                 <option value="Cohort2 January-June 2017">Cohort2 January-June 2017</option>
               </select>             </td>
