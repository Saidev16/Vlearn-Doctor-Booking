 ...
 <?php
 	 $CGPA=$count=$credit=0;
	 if (isset($_GET['ild'])){
	 $code_inscription= addslashes($_GET['ild']);
  ...
  $sql_v = "SELECT count(*) as nb FROM $table_note_sql WHERE
  ...
  <tr>
    ...
    <td width="78%" class="titre">&nbsp;Individual Learning Plan </span></td>
	<td width="90">
	  <table border="0" align="right" width="100%" cellpadding="10" cellspacing="4" id="link" >
	    <tr>
		<td valign="top" align="center" >
		  <a href="http://his.americanhigh.us/module/etudiantall/printilp.php?printilp=<?=$code_inscription?>" target="_blank"  title="Imprimer">
    ...
    <tr>
      <td>
        <?php
          ...
          $pr = round((($total/24)*100),2);
        ?>
        <p>Student progress : <?php echo $pr."%"; ?></p>

        <div class="progress">
          <div class="progress-bar progress-bar-striped" role="progressbar" style="width: <?php echo $pr ?>%" aria-valuenow="<?php echo $pr ?>" aria-valuemin="0" aria-valuemax="100"></div>
        </div>
      </td>
    </tr>
  </table>
