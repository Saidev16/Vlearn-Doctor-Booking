...
$nom=$_POST['nom'];
											...
											$sql="INSERT INTO tbl_jours( `id` , `title`  ) 
VALUES (
NULL , '$nom');";
...
<table border="0" width="1000" cellpadding="0" cellspacing="0" align="center" class="haut_table">
  <tr>
    ...
    <td width="78%" class="titre">Ajout  d' un groupe</td>
	<td width="22%">
 ...
 <form method="post"  action="gestion_groupe.php?new=oui" name="f_ajout" onsubmit="return valid_form();" >
