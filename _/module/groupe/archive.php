<table border="0" width="100%" cellpadding="0" cellspacing="0" align="center" class="haut_table">
  <tr>
    ...
    <td width="78%" class="titre">&nbsp;GESTION DES GROUPES <span class="task">[archive]</span></td>
	<td width="22%">
		  ...
		  <td valign="top" align="center">
		   <a href="#" 
		     onclick="javascript:if(document.adminMenu.boxchecked.value==0)
			       {
				    alert('Veuillez sélectionnez un jours??');
				   }
				   else
				   {
				     chemin=document.adminMenu.boxchecked.value;
					 chemin='gestion_groupe.php?desarchiver='+chemin;
...
<table width="100%" align="center" cellspacing="1"  class="adminlist">
  ...
  <?php
 $sql="select * from tbl_groupe where archive=1";
 $i=0;
$req=@mysql_query($sql) or die ("erreur lors de la selection des groupes");
...
<tr>
	 ...
	 <td align="center"><?=$ligne["id"];?></td>
	 <td align="center"><?=$ligne["title"];?></td>
	 <td>&nbsp;</td>
  </tr>
<?php
      } 
