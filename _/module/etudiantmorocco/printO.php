...
?> </td>
      ...
      <td height="21" colspan="15" align="left" valign="center" class="gras" style="border: 1px solid;">
       ...
       &nbsp;<?php echo $row['lieu_naissance'];  ?> </td>
		<!--  <td width="19%" colspan="35" rowspan="10" align="center" valign="middle" style="border: 1px solid;"><span style="color:#E0EBEB">OFFICIAL</span></td>-->
	...
	<tr>
      ...
      <td height="30" colspan="40" align="left" valign="middle" style="border: 1px solid;" >&nbsp;<b>Student Address: </b> <br />&nbsp;<?php echo ucfirst($adresse);?></td>
