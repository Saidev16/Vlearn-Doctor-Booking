...
$sqlfinance="insert into tbl_finance_morocco (`prefixe` ,code_inscription) values('MOR','$code_inscription')";
...
<option value="Zimbabwe">Zimbabwe</option>
		...
		<option value="">Select Academic Year</option>
 		  <?php 
		  $sql7="select idSession, session, annee_academique, 	academic_year from $tbl_session where academic_year!='' ";
