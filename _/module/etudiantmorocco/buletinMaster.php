	...
	<td width="90">
	  <table border="0" align="right" width="100%" cellpadding="10" cellspacing="4" id="link" >
		...
		<!--<td valign="top" align="center" >
		  <a href="http://his.americanhigh.us/module/etudiantmorocco/printb.php?printb=<?=$code_inscription?>" target="_blank"  title="Imprimer"> 
		  <div class="imprimer"></div>Print</a>
		  </td>-->
		  <td valign="top" align="center" >
		  <a href="http://his.americanhigh.us/module/etudiantmorocco/printO.php?printO=<?=$code_inscription?>" target="_blank"  title="Imprimer"> 
...
<table width="1000" cellspacing="0" border="1" align="center" class="buletin_data">
	...
	?>
			...
			<tr>
                ...
                <td width="89" align="left"  class="code"><?php echo stripslashes($row['code_cours_duplicata']);?></td>
