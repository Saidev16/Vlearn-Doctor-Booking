...
$type = $_POST['type'];
					...
					// update table etudiant
                        ...
                        $sql="UPDATE tbl_etudiant_morocco SET `code_inscription`='$ci',
 						`nom` = '$nom',
						`prenom` = '$prenom',
			...
			//-->
              ...
              <?php
					 ...
					 $sql="UPDATE tbl_etudiant_morocco SET
 						`nom` = '$nom',
						`prenom` = '$prenom',
						`date_naissance` = '$date_naissance',
						`nationalite` = '$nationalite',
						...
						`parentemail` = '$parentemail'
						 ...
						 WHERE `code_inscription` ='$code_inscription' limit 1 ";
          //   die($sql);
         @mysql_query($sql)or die ("erreur lors de la mise � jour de cet �tudiant2");
        ...
        //  die('3');
         ...
         @mysql_query($sql2)or die ("erreur lors de la mise jour de cet étudiant3");
			...
			if ($type !='Prospect' && $type !='0') { ?>
      <script type="text/javascript" language="JavaScript1.2">
          window.location.replace('/module/api_testing/edit_user.php?code_inscription=<?php echo $code_inscription; ?>&prefixe=MOR');
 			</script>
			  ...
			  $sql2="select * from tbl_etudiant_morocco
			  where code_inscription='$code_inscription' limit 1 ";
...
<table border="0" width="100%" cellpadding="0" cellspacing="0" align="center" class="haut_table">
 ...
 <form method="post" action="gestion_des_etudiants_morocco.php?modifier=Yes" name="f_ajout" >
