...
connecter($serveur,$login,$mdp,$bd);
	 ...
	 $sql="SELECT e.*
	 FROM tbl_etudiant_morocco as e WHERE code_inscription= '$code_inscription'";
 ...
 <br /> <br /> <br /> <br /> <br /><br />  <br /> <br /> <br /><br />
   ...
   <table width="1000"  cellpadding="0" cellspacing="0" border="0" style="border:1px solid black;" align="center" class="buletin_data" >
     ...
     <td colspan="20" align="left" valign="middle" height="30" class="gras" style="border: 1px  solid;">
       <b> &nbsp;First Name:</b><br /> &nbsp;<?php echo ucfirst($prenom);?> 
       <!--<b> &nbsp;First Name:</b><br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo ucfirst($prenom);?> -->
        </td>
	    <td colspan="20" align="left" valign="middle" height="30" class="gras" style="border: 1px solid;">
...
?> </td>
      ...
      <td height="21" colspan="15" align="left" valign="center" class="gras" style="border: 1px solid;">
       ...
       &nbsp;<?php echo $row['lieu_naissance'];  ?> </td>
		  <td width="19%" colspan="35" rowspan="10" align="center" valign="middle" style="border: 1px solid;"><span style="color:#E0EBEB">OFFICE USE ONLY</span></td>
	...
	<tr>
      ...
      <td height="30" colspan="40" align="left" valign="middle" style="border: 1px solid;" >&nbsp;<b>Student Address: </b> <br />&nbsp;<?php echo $adresse;?></td>
 ...
 <table width="1000" cellspacing="0" border="1" align="center" class="buletin_data">
	...
	?>
			...
			<?php
			 ...
			 $GPA = $j = 0; 
			 $k=0; //indice          
             $sql="SELECT c.code_cours, c.titre, c.nbr_credit , n.letter_grade, n.gpa, c.type, n.IdSession, c.code_cours_duplicata
             FROM tbl_note_morocco AS n, tbl_cours AS c 
			...
			<tr>
                ...
                <td width="118" align="left"  valign="middle" ><?php echo stripslashes($row['code_cours_duplicata']);?></td>
		...
		echo $tab[1].' '.$tab[2].' '.$tab[0]; //echo 'January 2015' ; ?>
            </td>
