...
<?php
	...
	/* $sql = "SELECT distinct e.code_inscription, concat(e.nom, ' ' ,e.prenom) as name,
			 ...
			 FROM $tbl_etudiant_morocco as e, $tbl_filiere as f, $tbl_groupe as g
  ...
  $sql = "SELECT distinct e.code_inscription, concat(e.nom, ' ' ,e.prenom) as name,
	 		 e.tel,  e.date_inscription, e.annee,e.acces,e.ville,e.groupe,e.prefixe,e.files,e.onsite,e.matriculated,archive
	  ...
	  <table border="0" align="right" width="100%" cellpadding="10" cellspacing="4" id="link" >
	    <tr>
		 ...
		 <td valign="top" align="center">
		   <a href="gestion_des_etudiants_morocco.php?new=oui">
		   ...
		   <a href="#"
		     onclick="javascript:if(document.adminMenu.boxchecked.value==0)
...

				   {
					 ...
					 chemin='transcript.php?code_inscription='+chemin+'&prefixe=MOR';
		  ...
		  <td valign="top" align="center" >
		  <a href="gestion_des_etudiants_morocco.php?laureat" title="laureat">
		   ...
		   <a href="#"
		     onclick="javascript:if(document.adminMenu.boxchecked.value==0)
...

				   {
					 ...
					 chemin='gestion_des_etudiants_morocco.php?supprimer='+chemin;
		   ...
		   <a href="#"
		     onclick="javascript:if(document.adminMenu.boxchecked.value==0)
				   ...
				   else
				   {
					 ...
					 chemin='gestion_des_etudiants_morocco.php?archiver='+chemin;
          	  ...
          	  <td valign="top" align="center">
		   <a href="gestion_des_etudiants_morocco.php?archive=oui"><div class="archive"></div>Archive</a>
		  </td>-->
 		  <td valign="top" align="center" >
  ...
  <tr align="center">
		...
		<!-- <th width="272"><?php echo 'Section'; ?></th>-->
		  <th width="272"><?php echo 'Registration Date'; ?></th>
		   <th width="125"><?php echo 'Accreditation Students'; ?></th>
		    <th width="125"><?php echo 'Complete File'; ?></th>
		  <th width="125"><?php echo 'Onsite File'; ?></th>
		   <th width="125"><?php echo 'Matriculated'; ?></th>
	  ...
	  <?php
		 ...
		 $prefixe=$ligne["prefixe"];
		  $matriculated=$ligne["matriculated"];
		   ?>
...
<?php
/*if($matriculated == '0'){?>
		  <td class="gras">&nbsp;<?php echo 'No matriculated'; ?></td>
		<?php }else {*/?>
          ...
          { ?>
            ...
            <?php } else if ($ligne["onsite"] == 1) { ?>
              ...
              <button class="valider" type="button" value="onsite" >Confirm</button>
               ...
               <td class="td_edit" style="text-align: center;" id="" value="matriculated">
          <?php
          if ($ligne["matriculated"] == 0)
          { ?>
            <img src="../images/non.ico" border="0" width="18" height="18">
            <?php } else if ($ligne["matriculated"] == 1) { ?>

              <img src="../images/yes.png" border="0" width="18" height="18">

              <?php }  ?>
              </td>
              <td class="matriculated_input_<?php echo $ci; ?>" style="display:none;">
              <input type="radio" name="matriculated"  value="1" <?php if ($ligne["matriculated"]  == 1) {echo "checked";} ?>></input> Yes <br>
              <input type="radio" name="matriculated"  value="0" <?php if ($ligne["matriculated"]  == 0) {echo "checked";} ?>></input> No <br>
              <button class="valider" type="button" value="matriculated" >Confirm</button>
              </td>
  ...
  jQuery(".valider").click(function(){
      ...
      if (ancien_value != value) {
          jQuery.ajax({
              ...
              evalscripts:true,
              type: "POST",
              url: 'gestion_des_etudiants_morocco.php?ajaxmod',
