		 ...
		 <td valign="top" align="center">
		  ...
		  <a href="#" 
		     onclick="javascript:if(document.adminMenu.boxchecked.value==0)
			       {
				    alert('Veuillez sélectionner un jour dans la liste');
				   }
				   else
				   {
				     chemin=document.adminMenu.boxchecked.value;
					 chemin='gestion_jours.php?modifier='+chemin;
		  ...
		  <td valign="top" align="center">
		   <a href="#" 
		     onclick="javascript:if(document.adminMenu.boxchecked.value==0)
				   ...
				   {
				     chemin=document.adminMenu.boxchecked.value;
					 chemin='gestion_jours.php?archiver='+chemin;
				     window.location.replace(chemin);
				   }
...
<input type="hidden" name="boxchecked" value="0" />
  ...
  <?php
		 $sql="select * from tbl_jours where archive= 0";
		 $i=0;
...
<tr>
	 ...
	 onClick="document.adminMenu.boxchecked.value=<?=$cj?>" /></td>
 	 <td align="left">&nbsp;<?=htmlentities(stripslashes($row["nom_jours"]))?></td>
	 <td>&nbsp;</td>
  </tr>
<?php
      }   
