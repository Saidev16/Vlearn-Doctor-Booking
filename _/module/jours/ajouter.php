...
$nom=addslashes($_POST['nom']);
				...
				$sql="INSERT INTO $tbl_jours( `nom_jours`  ) VALUES ('$nom');";
...
<table border="0" width="100%" cellpadding="0" cellspacing="0" align="center" class="haut_table">
  <tr>
    ...
    <td width="78%" class="titre">Ajout  d' un jour</td>
	<td width="22%">
	  <table border="0" align="right" width="0%" cellpadding="10" cellspacing="4" id="link" >
	    <tr>
		  ...
		  <td valign="top" align="center">
		   <a href="gestion_jours.php">  <div class="cancel"></div>Annuler</a>
		  </td>
		</tr>
	  </table>
	</td> 
 ...
 <form method="post"  action="gestion_jours.php?new=oui" name="f_ajout" onsubmit="return valid_form();" >
