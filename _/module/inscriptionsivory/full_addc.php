...
<?php
		...
		$sql = "SELECT COUNT(*) AS nbr FROM tbl_inscription_cours_ivory WHERE code_inscription='$code_inscription' 
...
<table border="0" width="100%" cellpadding="0" cellspacing="0" align="center" class="haut_table">
 ...
 <form method="post" action="gestion_inscription_ivory.php?full_addc=oui" name="f_ajout">
