  ...
  <tr>
	...
	<td width="22%">
	  <table border="0" align="right" width="15%" cellpadding="10" cellspacing="2" id="link" >
	    <tr>
		<!--<td valign="top" align="center"><a href="gestion_inscription_ivory.php?new=oui">
		  ...
		  <a href="#" 
		     ...
		     onclick="javascript:if(document.adminMenu.boxchecked.value==0)
...

				   {
					 ...
					 chemin='gestion_inscription_ivory.php?modifier='+chemin;
		  ...
		  <a href="#" 
		     ...
		     onclick="javascript:if(document.adminMenu.boxchecked.value==0)
...

				   {
					 ...
					 chemin='gestion_inscription_ivory.php?supprimer='+chemin;
		 ...
		 <td valign="top" align="center"><a href="gestion_inscription_ivory.php">
...
<input type="hidden" name="boxchecked" value="0" />
  ...
  <?php
   ...
   $sql="select e.code_inscription, concat(e.nom,' ', e.prenom) as name, 
	      ...
	      from tbl_inscription_cours_ivory as i, tbl_etudiant_ivory as e, $tbl_cours as c
		   where  
...
<tr>
	 ...
	 <td align="left"><a href="gestion_inscription_ivory.php?code_inscription=<?=$cn?>">&nbsp;<?=ucfirst($row["name"])?></a></td>
