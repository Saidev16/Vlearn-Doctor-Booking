...
$wherewithdrawal= " and `withdrawal_date` BETWEEN '$date1' AND '$date2'";
 $niveau=$_GET['niveau'];
  ...
  $sql="SELECT code_inscription,prefixe,concat(e.nom, ' ' ,e.prenom)as name,withdrawal_date,e.onsite FROM `tbl_etudiant_all` as e WHERE e.archive=2  ".$wherewithdrawal;
...
<table border="0" width="100%" cellpadding="0" cellspacing="0" align="center" class="haut_table">
 ...
 <form action="#" method="post" name="adminMenu" >
	  ...
	  <?php
		 ...
		 $url = $_SERVER['PHP_SELF']."?details=".$year."&limit=";
