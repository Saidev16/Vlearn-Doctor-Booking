<?php
  ...
  $sql="UPDATE $tbl_absence SET archive = 0 WHERE code_inscription = '$id'";
  @mysql_query($sql)or die ("unable to unarchive absences");
  
  $sql="UPDATE $tbl_demande SET archive = 0 WHERE code_inscription = '$id'";
  @mysql_query($sql)or die ("unable to unarchive requests");
  
  $sql="UPDATE $tbl_inscription_cours SET archive = 0 WHERE code_inscription = '$id'";
  @mysql_query($sql)or die ("unable to unarchive registrations");
  
  $sql="UPDATE $tbl_note SET archive = 0 WHERE code_inscription = '$id'";
