...
$user_id = $_SESSION['admin_id_user'];
	...
	/* $sql = "SELECT distinct e.code_inscription, concat(e.nom, ' ' ,e.prenom) as name,
			 ...
			 FROM $tbl_etudiant_benin as e, $tbl_filiere as f, $tbl_groupe as g
...
$sql = "SELECT distinct e.code_inscription, concat(e.nom, ' ' ,e.prenom) as name,
			 ...
			 FROM tbl_etudiant_benin as e
			 where  e.archive = 0" . $where. $groupeFilter. " GROUP BY e.code_inscription ORDER BY name ";
			 */

			 $sql = "SELECT distinct e.code_inscription, concat(e.nom, ' ' ,e.prenom) as name,
	 		 e.tel,  e.date_inscription, e.annee,e.acces,e.ville,e.groupe,e.prefixe,e.files,e.onsite
			 FROM tbl_etudiant_benin as e
			 where  e.archive = 0 GROUP BY e.code_inscription ORDER BY e.code_inscription ";
	  ...
	  <table border="0" align="right" width="100%" cellpadding="10" cellspacing="4" id="link" >
	    <tr>
		 ...
		 <td valign="top" align="center">
		   <a href="gestion_des_etudiants_benin.php?new=oui">
		   ...
		   <a href="#"
		     onclick="javascript:if(document.adminMenu.boxchecked.value==0)
...

				   {
					 ...
					 chemin='gestion_des_etudiants_benin.php?supprimer='+chemin;

				     window.location.replace(chemin);

				   }

				   "><div class="delete"></div> Delete
		   </a>
		  </td>
     <?php } ?>
		   ...
		   <a href="#"
		     onclick="javascript:if(document.adminMenu.boxchecked.value==0)
...

				   {
					 ...
					 chemin='transcript.php?code_inscription='+chemin+'&prefixe=BN';
...
<td valign="top" align="center" >
		  <a href="gestion_des_etudiants_benin.php?laureat" title="laureat">
  ...
  jQuery(".valider").click(function(){
      ...
      if (ancien_value != value) {
          jQuery.ajax({
              ...
              evalscripts:true,
              type: "POST",
              url: 'gestion_des_etudiants_benin.php?ajaxmod',
