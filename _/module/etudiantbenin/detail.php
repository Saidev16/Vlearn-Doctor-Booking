	...
	<td width="90">
	  <table border="0" align="right" width="100%" cellpadding="10" cellspacing="4" id="link" >
	    <tr>
		  ...
		  <a href="gestion_des_etudiants_benin.php?modifier=<?=$code_inscription?>">
		  <div class="modifier"></div>Edit</a>
		  </td>
		  <!-- <td valign="top" align="center" >
		  <a href="gestion_des_etudiants_benin.php?journal=<?=$code_inscription?>">
		 ...
		 <td valign="top" align="center" >
		  ...
		  <div class="imprimer"></div>Print</a>
		   ...
		   <td align="right">
		 <a href="gestion_des_etudiants_benin.php"><div class="retour"></div>Back</a>
		 </td>
		</tr>
	  </table>
	</td> 
