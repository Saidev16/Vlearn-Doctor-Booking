...
$attestation_eng = addslashes($_POST['attestation_eng']);
					...
					// update table etudiant
                        ...
                        $sql="UPDATE tbl_etudiant_benin SET `code_inscription`='$ci',
 						`nom` = '$nom',
						`prenom` = '$prenom',
			...
			//-->
              ...
              <?php
					 ...
					 $sql="UPDATE tbl_etudiant_benin SET  
 						`nom` = '$nom',
						`prenom` = '$prenom',
						`date_naissance` = '$date_naissance',
						`nationalite` = '$nationalite',
...
//die($sql);
         ...
         $sql2="UPDATE tbl_etudiant_all SET  
						...
						`graduation_date` = '$graduation_date'
						 ...
						 WHERE `code_inscription` ='$code_inscription' and  `prefixe` ='BN' limit 1 "; 
//die($sql);
         @mysql_query($sql2)or die ("erreur lors de la mise à jour de cet étudiant");
			...
			//-->
			  ...
			  $sql2="select * from tbl_etudiant_benin 
			  where code_inscription='$code_inscription' limit 1 ";
...
<table border="0" width="100%" cellpadding="0" cellspacing="0" align="center" class="haut_table">
 ...
 <form method="post" action="gestion_des_etudiants_benin.php?modifier=Yes" name="f_ajout" >
