	...
	<td width="90">
	  <table border="0" align="right" width="100%" cellpadding="10" cellspacing="4" id="link" >
		...
		<td valign="top" align="center" >
		  <a href="http://his.americanhigh.us/module/etudiant/printb.php?printb=<?=$code_inscription?>" target="_blank"  title="Imprimer"> 
  ...
  <tbody>
    <tr>
      ...
      <td colspan="20" align="left" valign="middle" height="30" class="gras">&nbsp; 
        FIRST NAME:<?php echo $prenom;?> </td>
      <td colspan="20" align="center" valign="middle" height="30" class="gras" >&nbsp;
        LAST NAME:<?php echo $nom;?> </td>
      <td colspan="20" align="left" valign="middle" height="30" class="gras">&nbsp;
        DOCUMENT NO:<?php echo $code_inscription;?> </td>
      <td width="127" colspan="15" rowspan="3" align="center" valign="middle" class="gras">&nbsp;</td>
    </tr>
    ...
    <tr>
      ...
      <td colspan="20" align="center" valign="middle" rowspan="2"><img src="images/icone/usdla.png" width="80" height="40" border="0"/></td>
	  <td colspan="20" align="left" valign="middle" class="gras">&nbsp;
	  PREVIOUS SCHOOL NAME: <?php ?>
	  </td>
    </tr>
