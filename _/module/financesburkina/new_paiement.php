...
$query = "SELECT MAX(recu) as statut FROM tbl_finance_paiement_burkina  ";
...
$row = mysql_fetch_assoc($result);
 $valeurmax = $row["statut"]+1;
	...
	//insert in tbl_finance_paiement
	 $sql = "INSERT INTO tbl_finance_paiement_burkina(`code_inscription` ,`prefixe` ,`designation` ,`annee` ,`type_paiement` ,`date_paiement` ,
...
/* 	$sql="UPDATE tbl_finance_morocco SET payee = payee + $somme WHERE code_inscription='$code_inscription' LIMIT 1";
	@mysql_query($sql) or die (mysql_error());*/
			...
			<!--	
					window.location.replace('gestion_finance_burkina.php?detail=<?=$code_inscription;?>');
			...
			//-->
              ...
              <?php
				  ...
				  $sql = "SELECT nom, prenom,prefixe FROM tbl_etudiant_burkina WHERE code_inscription = '$code_inscription' ";
...
<table border="0" width="100%" cellpadding="0" cellspacing="0" align="center" class="haut_table">
	...
	<td width="22%">
	  <table border="0" align="right" width="0%" cellpadding="10" cellspacing="4" id="link" >
	    <tr>
		  ...
		  <td valign="top" align="center">
		   <a href="gestion_finance_burkina.php?detail=<?php echo $code_inscription ?>&prefixe=<?=$prefixe?>" ><div class="cancel"></div>Cancel</a>
		  </td>
		</tr>
	  </table>
	</td> 
 ...
 <form method="post" action="gestion_finance_burkina.php?new_paiement=oui" name="f_ajout" >
       ...
       <tr>
         <td valign="top" width="100%">
		  ...
		  <tr>
			   ...
			   <td><select name="month_i" class="input">
