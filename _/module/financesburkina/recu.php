...
FROM tbl_finance_paiement_burkina as p, tbl_finance_burkina as f, tbl_etudiant_burkina as e, $tbl_admin as a
WHERE p.id='$id' 
...
$sql="SELECT * FROM tbl_finance_burkina WHERE code_inscription='$code_inscription' AND annee = '$annee'";
$req=mysql_query($sql);
...
<table width="800" align="left" border="0">
	...
	<br>
	<tr>
		<td ><span class="bold">Receipt Number : </span><?php echo $recu; ?></td>
    ...
    <tr>
		...
		$date=$date_paiement;
		$tab=split('[/.-]',$date);
		echo $tab[1].'-'.$tab[2].'-'.$tab[0];//echo $row['date_paiement']; ?></td>
		...
		<br /><br /><br />
        	<table width="100%" style="font-size:10px; color:#36C">
              <tr> 
                    ...
                    <td  width="50%" align="center">American School of Leadership,7380 W Sand Lake Rd, Suite 500 Orlando, FL 32819<br />
                                    PH: 407-745-1700    /  
                                    E-MAIL : CONTACT@AMERICANHIGH.US<br />
                                    WEBSITE : WWW.AMERICANHIGH.US
                    </td>
