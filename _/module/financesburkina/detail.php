 ...
 $prefixe=$_GET['prefixe'];
	  ...
	  $sql= "SELECT concat(nom,' ', prenom) as name,aul,piimt,niveau FROM tbl_etudiant_burkina WHERE code_inscription='$code_inscription'LIMIT 1";
	 $req = @mysql_query($sql);
	  ...
	  <table border="0" align="right" width="100%" cellpadding="10" cellspacing="4" id="link" >
	    <tr>
          ...
          <td valign="top" align="center">
		   <a href="gestion_finance_burkina.php?new_paiement=oui"><div class="ajouter"></div>Add Payment</a>
		   ...
		   <a href="#" 
		     ...
		     onclick="javascript:if(document.adminMenu.boxchecked.value==0)
...

				   {
					 ...
					 chemin='gestion_finance_burkina.php?modif_paiement='+chemin+'&prefixe='+xyz;
		   ...
		   <a href="#" 
		     ...
		     onclick="javascript:if(document.adminMenu.boxchecked.value==0)
				   ...
				   xyz=document.adminMenu.prefixe.value;
					 ...
					 chemin='gestion_finance_burkina.php?delete_paiement='+chemin;
		  ...
		  <a href="#" onclick="window.print();" title="Imprimer"><div class="imprimer"></div>Print</a>
		   ...
		   <td align="right">
		 <a href="gestion_finance_burkina.php"><div class="retour"></div>Back</a>
		 </td>
		</tr>
	  </table>
	</td> 
...
<?php
    ...
    $id=$_GET['detail'];
 	 ...
 	 $sql="SELECT * FROM tbl_finance_paiement_burkina
...
?>
	...
	/*	$rec=$row['receveur'];
		...
		<td><?php echo $row['recu']; ?></td>
		 <td><a href="javascript:popup('../module/financesburkina/recu.php?recu=<?php echo $row['id']?>', '', 'resizable=no, location=no, width=200, height=100, menubar=no, status=no, scrollbars=no, menubar=no')">Receipt</a></td>
