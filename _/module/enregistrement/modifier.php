	...
	$processus=$_POST['processus'];
     ...
     switch($error){
		  ...
		  break;
				...
				@mysql_query($sql1)or die ("erreur lors de l'archivage de l'enregistrement ");
...
<table border="0" width="100%" cellpadding="0" cellspacing="0" align="center" class="haut_table">
  ...
  <tr>
    ...
    <td width="78%" class="titre">&nbsp;GESTION DES ENREGISTREMENTS <span class="task">[modifier]</span> </td>
 ...
 <form method="post" ENCTYPE="multipart/form-data" action="gestion_enregistrement.php?modifier=oui" name="f_ajout">
 ...
 <input type="hidden" name="id" value="<?=$id?>" />
		  ...
		  <td width="25%">
		  <input type="text" name="titre" class="input" style="height:16px" size="100" value="<?=$ex_titre?>" /></td>
		 ...
		 <a href="http://<?=$_SERVER['HTTP_HOST']?>/ilcs/module/document/docs/<?=$ex_file?>">
