...
$query = "SELECT MAX(recu) as statut FROM tbl_finance_paiement  ";
...
$valeurmax = $row["statut"];
	...
	$sql = "INSERT INTO tbl_finance_paiement(`code_inscription` ,`prefixe` ,`designation` ,`annee` ,`type_paiement` ,`date_paiement` ,
			`somme` ,`receveur`,`recu`) VALUES ('$code_inscription','$prefixe','$designation', '$annee', 
			'$type_paiement', '$date_paiement', $somme, '$receveur', '$valeurmax'+1);";

	@mysql_query($sql) or die('Erreur insertion de paiement1');

	//insert in tbl_finance_paiement_bakzin
	/*$sql = "INSERT INTO tbl_finance_paiement_bakzin(`code_inscription` ,`designation` ,`annee` ,`type_paiement` ,`date_paiement` ,
			`somme` ,`receveur`,`recu`) VALUES ('$code_inscription', '$designation', '$annee', 
			'$type_paiement', '$date_paiement', $somme, '$receveur', '$recu');";
	@mysql_query($sql) or die('Erreur insertion de paiement2');*/
	
	// update tbl_finance
	$sql="UPDATE tbl_finance SET payee = payee + $somme WHERE code_inscription='$code_inscription' LIMIT 1";
...
<table border="0" width="100%" cellpadding="0" cellspacing="0" align="center" class="haut_table">
 ...
 <form method="post" action="gestion_finance.php?new_paiement=oui" name="f_ajout" >
