...
<table width="800" align="center" border="0">
	<tr>
        ...
        <!--<td colspan="2" align="right" valign="top"><img src="../../administrator/images/piimt.jpg" alt="" /></td>-->
    </tr>
     <tr>
    	<td colspan="4" height="10">&nbsp;</td>
    </tr>
	<tr>
		<!--<td colspan="4" align="right"><b>Private International Institute of Management & Technology<br />  </b></td>-->
	</tr>
	<tr>
	...
	<tr>
		<td colspan="4"><span class="bold"></span>
		<?php //echo ((int)$row['frais_inscription']+(int)$row['frais_etude']+(int)$row['reliquat'])-((int)$row['bourse']+(int)$row['payee']);
		?></td>
	</tr>
    <tr>
    	<td colspan="4" height="10">&nbsp;</td>
    	...
    	<td colspan="4">
        	<table width="100%" style="font-size:10px; color:#36C">
                <tr>
                    ...
                    CNSS N° 7304900       ¦   PATENTE N° 25982176        ¦   IF N° 3316840       ¦   RC N° 64281
                    </td>
					 <td align="left">
                    MOROCCO : 45, AVENUE OULED SAID, BIR KACEM – SOUISSI – RABAT
                    TEL : 0537 75 67 11/0537 75 98 59    FAX : 0537 75 67 88
