...
FROM tbl_finance_paiement as p, tbl_finance as f, tbl_etudiant_all as e, $tbl_admin as a
WHERE p.id='$id' 
		...
		<br />
			<table style="border-collapse:collapse; padding:1px" border="1" cellspacing="1" width="100%">
				...
				<tr align="center">
					...
					<td><?php  echo 'High School Diploma';//$annee_academique;?> <?php //echo is_numeric($annee_academique) ? 'année' : ''?></td>
