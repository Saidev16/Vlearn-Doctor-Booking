<?php
   ...
   $url = array(
     ...
     'MARB' => 'gestion_des_etudiants_marbella.php',
     'BEN' => 'gestion_des_etudiants_bennouna.php',
     'gen' => '/administrator/gestion_des_etudiants_gen.php',
     'CB' => 'gestion_des_etudiants_casa.php'
   ...
   if ($gen == 0) {
     ...
     $link = "gestion_des_etudiants_all.php";
   }else{
     $link = $url['gen'];
   }
	...
	<td width="90">
	  <table border="0" align="right" width="100%" cellpadding="10" cellspacing="4" id="link" >
		...
		<td valign="top" align="center" >
		  <a href="http://his.americanhigh.us/module/transcripts/print.php?code_inscription=<?=$code_inscription?>&prefixe=<?=$prefixe?>&gen=<?php echo $gen; ?>" target="_blank"  title="Imprimer">
		  <div class="imprimer"></div>Print</a>
		  </td>
   <!--   <td valign="top" align="center" >
  		  <a href="?update=<?=$code_inscription?>&prefixe=<?=$prefixe?>&gen=<?php echo $gen; ?>" target="_blank"  title="Imprimer">
  		  <div class="imprimer"></div>Update Grades Tr</a>
  		  </td>
		   <td valign="top" align="center" >
