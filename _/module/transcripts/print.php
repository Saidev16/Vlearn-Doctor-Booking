...
connecter($serveur,$login,$mdp,$bd);
	 ...
	 if (isset($_GET['code_inscription'])){
		   ...
		   $table_inscription = array(
		     ...
		     'BEN' => 'tbl_inscription_cours_bennouna',
...
<tr>
		...
		<td colspan="20" align="left" valign="middle" height="30" class="gras" style="border: 1px  solid;width: 165px;">
		<b> &nbsp;First Name : </b><?php echo strtoupper($nom);?>  </td>
		<td colspan="20" align="center" valign="middle" height="30" class="gras" style="border: 1px solid;width: 175px;">
		<b> &nbsp;Date of Birth : </b>&nbsp;<?php
		$date=$row['date_naissance'];
		$tab=split('[/.-]',$date);
		echo $tab[1].'-'.$tab[2].'-'.$tab[0]; /*echo $row['date_naissance'];*/?> </td>
...
<tr>
	<td colspan="40" align="left" valign="middle" height="30" style="border: 1px solid;">
	&nbsp;<b>Last Name : </b><?php echo strtoupper($prenom);?>
	</td>
	<td colspan="15" align="left" valign="middle" height="30" style="border-right: 1px solid;">
	<b> &nbsp;&nbsp;<br />&nbsp;Previous School Address:</b><br />&nbsp;<?php echo $row['code_bac'];?>
	</td>
</tr>

<tr>
	<td height="30" colspan="40" align="left" valign="middle" style="border: 1px solid;" ><b>&nbsp;Student Address: </b>  &nbsp;<?php echo $adresse;?></td>
...
<?php if ($prefixe != "ORL1"){ ?>
	...
	<table width="1000" cellspacing="0" border="1" align="center" class="buletin_data">
		<tr>
			<th width="50%">
					<table width="100%" cellspacing="0" class="gras" style='font-size:14px;'>
							<tr>
								<td style="width: 17%;">Course Code</td>
								<td style="width: 62%;">Course Title</td>
	 ...
	 */
	 ...
	 ?>
			 ...
			 <?php
						 ...
						 AND ((c.grade = $grade and n.stage = $grade) or (c.grade = $grade and n.stage is null) or n.stage = $grade )
						 AND n.archive = 0
						 order by n.code_note
						 ";
						 // var_dump($sql);
				...
				$transfer+=1 ;
						 ...
						 ?>
							<tr>
								 <td style="width: 17%;"  class="code"><?php echo stripslashes(strtoupper($row['code_cours']));?></td>
								 <td style="width: 63%;"><?php echo trim(stripslashes(strtoupper($row["titre"])));/*echo stripslashes($row['titre']);*/?> </td>
								 <td style="width: 10%;text-align:center;"><?php echo $row['nbr_credit']; //echo "/ ".$row['gpa'];?></td>
									<td style="width: 10%;text-align:center;"><?php echo $row['letter_grade']; ?></td>
						 </tr>
	 ...
	 ?>
		 ...
		 <table width="1000" cellspacing="0" align="center" style="border: 1px solid #000; font-size:11px; font-weight:bold; margin-top:10px">
			<tr>
						...
						//  if($j>0 )
					 // { $zineb= round($GPA/$j, 2) ;
						//  echo  number_format($zineb, 2, '.', ' ');
					 // }
						//  else { echo '' ; }
						// var_dump($GPA." ".$j);
						echo $j>0 ? round($GPA/$j, 1) : '' ;
						 ?>
							</td>
