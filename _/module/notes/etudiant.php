<?php
    ...
    $code_inscription=$_SESSION['code_inscription']=trim($_GET['code_inscription']);
   	...
   	$sql1="select concat(e.nom, ' ', e.prenom) as name, f.nom_filiere ,niveau
...
<!-- <td valign="top" align="center" >
		  ...
		  <a href="#" 
		     ...
		     onclick="javascript:if(document.adminMenu.boxchecked.value==0)
...

				   {
					 ...
					 chemin='gestion_notes.php?modifierbbael='+chemin+'&foupasf='+xyz;
		  ...
		  <a href="#" 
		     ...
		     onclick="javascript:if(document.adminMenu.boxchecked.value==0)
...

				   {
				     ...
				     chemin=document.adminMenu.boxchecked.value;
				     xyz=document.adminMenu.notefoupasf.value;
					 chemin='gestion_notes.php?modifiermbael='+chemin+'&foupasf='+xyz;
		  ...
		  <a href="#" 
		     ...
		     onclick="javascript:if(document.adminMenu.boxchecked.value==0)
			     ...
			     chemin=document.adminMenu.boxchecked.value;
				     xyz=document.adminMenu.notefoupasf.value;
					 chemin='gestion_notes.php?modifier='+chemin+'&foupasf='+xyz;
		  ...
		  <td valign="top" align="center" width="90">
		   ...
		   <a href="gestion_notes.php"><div class="retour"></div>Back</a>
...
$fStart="_";
   ...
   <tr>
	 ...
	 <td align="left"><a href="gestion_notes.php?code_cours=<?=$cc?>"><?=$cr?></a></td>
