...
<?php
		...
		$transcript[7] = $_POST['code_cours8'];
		$transcript[8] = $_POST['code_cours9'];
		$transcript[9] = $_POST['code_cours10'];
		...
		//selection de l'annee
			...
			VALUES ('$code_cours', '$code_inscription', '$date', '$idSession' );";
 	         ...
 	         @mysql_query($sql)or die ('Erreur :: inscription ');
				...
				value('$code_inscription', '$code_cours', '$idSession', 0, '$section','T')"; 
...
<table border="0" width="100%" cellpadding="0" cellspacing="0" align="center" class="haut_table">
	...
	<td width="22%">
	  <table border="0" align="right" width="0%" cellpadding="10" cellspacing="4" id="link" >
	    <tr>
		  ...
		  <td valign="top" align="center">
		   <a href="gestion_inscription_benin.php" ><div class="cancel"></div>Cancel</a>
		  </td>
		</tr>
	  </table>
	</td> 
 ...
 <form method="post" action="gestion_inscription_benin.php?full_addT=oui" name="f_ajout">
		  ...
		  ?>
           ...
           <tr><td><label for="code_cours8">Titre du cours 8:</label> </td>
 		  <td colspan="3">
 		 <select name="code_cours8" id="code_cours8" class="input">
		 	<option value="">Sélectionner</option>
		  <?php 
			$sql5="SELECT  code_cours,  titre FROM $tbl_cours  GROUP BY  code_cours";
			$req=@mysql_query($sql5);
		  ...
		  ?>
           ...
           <tr><td><label for="code_cours9">Titre du cours 9:</label> </td>
 		  <td colspan="3">
 		 <select name="code_cours9" id="code_cours9" class="input">
		 	<option value="">Sélectionner</option>
		  <?php 
			$sql5="SELECT  code_cours,  titre FROM $tbl_cours  GROUP BY  code_cours";
			$req=@mysql_query($sql5);
		  ...
		  ?>
 		  ...
 		  <tr><td colspan="4" height="3px"></td></tr>
		   <tr><td colspan="4" height="3px"></td></tr>
           <tr><td><label for="code_cours10">Titre du cours 10:</label> </td>
 		  <td colspan="3">
 		 <select name="code_cours10" id="code_cours10" class="input">
		 	<option value="">Sélectionner</option>
		  <?php 
			$sql5="SELECT  code_cours,  titre FROM $tbl_cours  GROUP BY  code_cours";
			$req=@mysql_query($sql5);
