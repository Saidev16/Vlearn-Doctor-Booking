...
<?php
		...
		$idSession = $_POST['idSession'];
		 ...
		 $a ="select code_cours,code_cours_testing from tbl_cours where diff =1";
			...
			$sql = "INSERT INTO tbl_inscription_cours_benin (`code_cours`, `code_inscription`, `date_inscription`, `idSession`,code_cours_testing
					)
...
<table border="0" width="100%" cellpadding="0" cellspacing="0" align="center" class="haut_table">
 ...
 <form method="post" action="gestion_inscription_benin.php?full_add=oui" name="f_ajout">
