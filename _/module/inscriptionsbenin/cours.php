<?php
		...
		$annee = $row['annee_academique'];
					...
					$sql2="select titre from $tbl_cours  where code_cours='$code_cours' limit 1";
 					...
 					$req=@mysql_query($sql2) or die ("erreur lors de la sélection du titre du cours1");
					$row=mysql_fetch_assoc($req);
  ...
  <tr>
	...
	<td width="22%">
	  <table border="0" align="right" width="15%" cellpadding="10" cellspacing="2" id="link" >
	    <tr>
		<!--<td valign="top" align="center"><a href="gestion_inscription_benin.php?new=oui">
		  ...
		  <a href="#" 
		     ...
		     onclick="javascript:if(document.adminMenu.boxchecked.value==0)
...

				   {
					 ...
					 chemin='gestion_inscription_benin.php?modifier='+chemin;
		  ...
		  <a href="#" 
		     ...
		     onclick="javascript:if(document.adminMenu.boxchecked.value==0)
...

				   {
					 ...
					 chemin='gestion_inscription_benin.php?supprimer='+chemin;
		 ...
		 <td valign="top" align="center"><a href="gestion_inscription_benin.php">
...
<input type="hidden" name="boxchecked" value="0" />
  ...
  <?php
   ...
   $sql="select e.code_inscription, concat(e.nom,' ', e.prenom) as name, 
	      ...
	      from tbl_inscription_cours_benin as i, tbl_etudiant_benin as e, $tbl_cours as c
		   where  
...
<tr>
	 ...
	 <td align="left"><a href="gestion_inscription_benin.php?code_inscription=<?=$cn?>">&nbsp;<?=ucfirst($row["name"])?></a></td>
