	  ...
	  <table border="0" align="right" width="100%" cellpadding="10" cellspacing="4" id="link" >
	    <tr>
		 ...
		 <td valign="top" align="center">
		   <a href="gestion_des_etudiants_gues.php?new=oui">
		   ...
		   <a href="#"
		     onclick="javascript:if(document.adminMenu.boxchecked.value==0)
...

				   {
					 ...
					 chemin='gestion_des_etudiants_gues.php?buletinMaster='+chemin;
		 ...
		 <?php } ?>
		  <td valign="top" align="center" >
		  <a href="gestion_des_etudiants_gues.php?laureat" title="laureat">
		   ...
		   <a href="#"
		     onclick="javascript:if(document.adminMenu.boxchecked.value==0)
...

				   {
					 ...
					 chemin='gestion_des_etudiants_gues.php?supprimer='+chemin;
  ...
  jQuery(".valider").click(function(){
      ...
      if (ancien_value != value) {
          jQuery.ajax({
              ...
              evalscripts:true,
              type: "POST",
              url: 'gestion_des_etudiants_gues.php?ajaxmod',
