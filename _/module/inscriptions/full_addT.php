...
<?php
		...
		if ($nbr==0){
			...
			$sql = "INSERT INTO $tbl_inscription_cours (`code_cours`, `code_inscription`, `date_inscription`, `idSession`)
			VALUES ('$code_cours', '$code_inscription', '$date', '$idSession' );";
			  ...
			  if($i==$j){
			  $sql11= "SELECT aul FROM $tbl_etudiant WHERE code_inscription= '$code_inscription' ";
...
<table border="0" width="100%" cellpadding="0" cellspacing="0" align="center" class="haut_table">
 ...
 <form method="post" action="gestion_inscription.php?full_addT=oui" name="f_ajout">
		  ...
		  <select name="code_inscription" id="code_inscription" class="input">
				<option value="">Sélectionner</option>
		  <?php 
		   $sql6="select code_inscription, nom, prenom from $tbl_etudiant where archive = 0 AND groupe not in (5,7) order by prenom, nom";
