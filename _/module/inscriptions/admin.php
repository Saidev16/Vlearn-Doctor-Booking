<?php
	   ...
	   <!--
	   		window.location.replace('gestion_inscription.php?code_inscription=<?=$pci?>');
	   -->
	   </script>
	   	<?php																   }
 	  ...
 	  $sql="SELECT c.titre, i.code_cours, count(i.code_inscription) as inscription from 
 		tbl_cours as c, tbl_inscription_cours as i, tbl_etudiant as e
  ...
  <tr>
	...
	<td width="22%">
	 <table border="0" align="right" width="20%" cellpadding="10" cellspacing="4" id="link" >
	    <tr>
		<!-- <td valign="top" align="center"><a href="gestion_inscription.php?full_add=oui"><div class="ajouter"></div>Ajouter Semestre</a></td>-->
		 <td valign="top" align="center"><a href="gestion_inscription.php?full_addc=oui"><div class="ajouter"></div>Add Course</a></td
		>
		 <td valign="top" align="center"><a href="gestion_inscription.php?full_addT=oui"><div class="ajouter"></div>Add Transfer Course</a></td
		></tr>
	</table>
    </td> 
</table>
...
<!-- <select name="type" class="search" >
 <?php 
  ...
  <tr height="16px">
	 ...
	 <td align="left"><a href="gestion_inscription.php?code_cours=<?=$cc?>" title="Cliquez pour voir les &eacute;tudiants inscrits dans ce cours">&nbsp;<?=$cc?></a></td>
 	 <td align="left">&nbsp;<?=stripslashes(trim($row["titre"]))?></td>
	 <?php
	/* $inscri="select count(*) as nbre from $tbl_inscription_cours where code_cours='$cc' and idSession='$idSession'";*/
	$inscri="select count(*) as nbre  from $tbl_inscription_cours as c, $tbl_note as n 
