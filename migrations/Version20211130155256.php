 ...
 */
final class Version20211130155256 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD user_id INT DEFAULT NULL, ADD adress VARCHAR(300) NOT NULL, ADD phone_number VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user DROP user_id, DROP adress, DROP phone_number');
    }
}
